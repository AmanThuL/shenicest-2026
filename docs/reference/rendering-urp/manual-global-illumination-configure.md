---
title: "Unity 6.3 Manual: Configure lightmapping with a Lighting Settings Asset"
page_title: "Unity - Manual: Configure lightmapping with a Lighting Settings Asset"
source_url: "https://docs.unity3d.com/6000.3/Documentation/Manual/global-illumination-configure.html"
final_url: "https://docs.unity3d.com/6000.3/Documentation/Manual/global-illumination-configure.html"
topic: "rendering-urp"
...
A Lighting Settings Asset represents a saved instance of the [LightingSettings](https://docs.unity3d.com/6000.3/Documentation/ScriptReference/LightingSettings.html) class, which stores data for the Baked Global Illumination and the Enlighten Realtime Global Illumination systems. The Unity Editor uses this data when it precomputes lighting data for a Scene that uses one or both of these systems.
...
2.  If you have more than one Scene open, ensure that the Scene that you want to assign the Lighting Settings Asset to is the [active Scene](https://docs.unity3d.com/6000.3/Documentation/Manual/MultiSceneEditing.html).
...
You can also assign a Lighting Settings Asset to the active Scene from a script. To do this, load the Lighting Settings Asset to obtain an instance of the `LightingSettings` class, then use the `Lightmapping.lightingSettings` API to assign that `LightingSettings` instance to the active Scene. For more information and code examples, see the [LightingSettings API documentation](https://docs.unity3d.com/6000.3/Documentation/ScriptReference/LightingSettings.html).
...
You can also read from or write to the properties of a Lighting Settings Asset from a script. To do this, load the Lighting Settings Asset to obtain an instance of the`LightingSettings` class, and access its properties. For more information and code examples, see the [LightingSettings API documentation](https://docs.unity3d.com/6000.3/Documentation/ScriptReference/LightingSettings.html).

<span id="DefaultLightingSettings"></span>
...
To make changes to the `LightingSettings` data for a Scene, you must use the Unity Editor to create and assign a Lighting Settings Asset, or use a script to create, configure, and assign a `LightingSettings` object. For more information and code examples, see the [LightingSettings API documentation](https://docs.unity3d.com/6000.3/Documentation/ScriptReference/LightingSettings.html).
