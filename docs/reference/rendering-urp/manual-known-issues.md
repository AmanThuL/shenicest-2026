---
title: "Known issues in URP"
page_title: "Unity - Manual: Known issues in URP"
source_url: "https://docs.unity3d.com/6000.3/Documentation/Manual/urp/known-issues.html"
final_url: "https://docs.unity3d.com/6000.3/Documentation/Manual/urp/known-issues.html"
topic: "rendering-urp"
...
-   [Reduce build time in Forward+ Rendering Path](https://docs.unity3d.com/6000.3/Documentation/Manual/urp/rendering/forward-plus-rendering-path-limitations.html)

## When importing the URP package samples, Unity does not set the necessary URP asset in Quality \> Render Pipeline Asset<span id="urp-samples-known-issue-1"></span>
...
![In Project Settings \> Quality \> Render Pipeline Asset, select SamplesPipelineAsset](https://docs.unity3d.com/6000.3/Documentation/uploads/urp/known-issues/urp-12-package-samples.png)
...
-   The Renderer has a Renderer Feature called `NewRenderObjects` assigned.
    ...
    ![UniversalRenderer with Renderer Feature assigned to it.](https://docs.unity3d.com/6000.3/Documentation/uploads/urp/known-issues/urp-10-renaming-renderer.png)
