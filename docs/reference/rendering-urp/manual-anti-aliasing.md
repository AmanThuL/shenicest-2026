---
title: "Add anti-aliasing in the Universal Render Pipeline"
page_title: "Unity - Manual: Add anti-aliasing in the Universal Render Pipeline"
source_url: "https://docs.unity3d.com/6000.3/Documentation/Manual/urp/anti-aliasing.html"
final_url: "https://docs.unity3d.com/6000.3/Documentation/Manual/urp/anti-aliasing.html"
topic: "rendering-urp"
...
![An example of the rasterization process creating some aliasing.](https://docs.unity3d.com/6000.3/Documentation/uploads/urp/aliasing-example.png)  
...
-   [Fast Approximate Anti-aliasing (FXAA)](https://docs.unity3d.com/6000.3/Documentation/Manual/urp/anti-aliasing.html#fxaa)
-   [Subpixel Morphological Anti-aliasing (SMAA)](https://docs.unity3d.com/6000.3/Documentation/Manual/urp/anti-aliasing.html#smaa)
-   [Temporal Anti-aliasing (TAA)](https://docs.unity3d.com/6000.3/Documentation/Manual/urp/anti-aliasing.html#taa)
-   [Multisample Anti-aliasing (MSAA)](https://docs.unity3d.com/6000.3/Documentation/Manual/urp/anti-aliasing.html#msaa)

## Fast Approximate Anti-aliasing (FXAA)<span id="fxaa"></span>
...
## Subpixel Morphological Anti-aliasing (SMAA)<span id="smaa"></span>
...
## Multisample Anti-aliasing (MSAA)<span id="msaa"></span>
...
1.  Open a [URP asset](https://docs.unity3d.com/6000.3/Documentation/Manual/urp/universalrp-asset.html) in the Inspector.
2.  Navigate to **Quality** > **Anti Aliasing (MSAA)** and select the level of MSAA you want.

For more information on the available settings, refer to the [MSAA setings in the URP asset](https://docs.unity3d.com/6000.3/Documentation/Manual/urp/universalrp-asset.html#quality).
