...
page_title: "Unity - Manual: Scriptable Render Pipeline Batcher in URP"
source_url: "https://docs.unity3d.com/6000.3/Documentation/Manual/SRPBatcher.html"
final_url: "https://docs.unity3d.com/6000.3/Documentation/Manual/SRPBatcher.html"
topic: "rendering-urp"
...
The Scriptable Render Pipeline (SRP) Batcher is a [draw call optimization](https://docs.unity3d.com/6000.3/Documentation/Manual/optimizing-draw-calls.html) that significantly improves performance for applications that use an SRP. The SRP Batcher reduces the CPU time Unity requires to prepare and dispatch draw calls for materials that use the same shader variant.

![The Scriptable Render Pipeline (SRP) Batcher reduces the CPU time Unity requires to render scenes with many materials that use the same shader variant.](https://docs.unity3d.com/6000.3/Documentation/uploads/Main/SRPBatcher.png)
...
![The batching of bind and draw commands reduces the GPU setup between draw calls.](https://docs.unity3d.com/6000.3/Documentation/uploads/Main/SROShaderPass.png)
...
![The SRP Batcher rendering workflow. The SRP Batcher uses a dedicated code path to update the Unity Engine properties in a large GPU buffer.](https://docs.unity3d.com/6000.3/Documentation/uploads/Main/SRP_Batcher_loop.png)
