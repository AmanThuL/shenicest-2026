---
title: "Optimize for fixed update"
page_title: "Optimize for fixed-timestep or physics-based scenarios | Input System | 1.20.0"
source_url: "https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/timing-optimize-fixed-update.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/timing-optimize-fixed-update.html"
topic: "packages"
...
If you are working with the physics system or using `FixedUpdate` to control your game in a scenario where a small amount of input latency is acceptable (for example, a few frames), the simplest approach is to set the [input system update mode](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/timing-select-mode.html) to **Process Events in Fixed Update**. This means your input code in `FixedUpdate` will operate as expected.
...
![image alt text](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/images/TimingFastFPS.png)
...
![image alt text](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/images/TimingSlowFPS.png)
...
![image alt text](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/images/TimingUnprocessedTime.png)
...
However, the **Process Events in Dynamic Update** mode might introduce the problem of missed or duplicate discrete events, such as attempting to read whether a button was pressed in a given frame. If you use this strategy, you must understand how to [avoid missed or duplicate events](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/timing-missed-duplicate-events.html) in mixed timing scenarios requiring fixed and dynamic input.

### Event-driven input with fixed update code

For event-driven input, where the [Player Input component](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/player-input-component.html) calls events in your code, you should store the input values in variables which you can then read in your `FixedUpdate` call. For example:
