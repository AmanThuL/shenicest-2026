---
title: "Third Person Follow"
page_title: "Third Person Follow | Cinemachine | 3.1.7"
source_url: "https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/CinemachineThirdPersonFollow.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/CinemachineThirdPersonFollow.html"
topic: "packages"
...
![The corresponding rig in the Scene view: the origin on the followed target (A), the shoulder offset to the right (B), the hand offset up (C), and the camera behind (D).](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/images/CinemachineRigSceneView.png)

Which results in this Game view:

![The result from the camera's point of view in the Game view.](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/images/CinemachineRigGameViewExample.png)
...
-   **B rotates horizontally around A**. Using A as the origin, B's position is calculated from the Shoulder Offset's X, Y, and Z values.  
    ![A representation of the shoulder offset values in the Scene view: X, Y, and Z.](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/images/CMShoulderOffsetexample.png)
...
-   **C rotates vertically around B**. C's position is calculated from the Vertical Arm Length from B. Positive values result with C above B, and negative values result with C below B.  
    ![A representation of the hand offset in the Scene view: up or down from the shoulder.](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/images/CMVerticalDistanceexample.png)
...
When combined with the [CinemachineThirdPersonAim](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/CinemachineThirdPersonAim.html) extension, the result is a powerful rig that can maintain steady aim for a shooter-type game, even when the camera movement is shaky or noisy. CinemachineThirdPersonAim re-adjusts the camera orientation to maintain a fixed point at the center of the screen, correcting for variations due to camera noise.

## Sample Scene

To experiment with a Third Person Follow set up that includes camera control, shaky movement, and aim mode, open and run the `ThirdPersonWithAimMode` sample Scene from the [3D samples available with the Cinemachine package](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/samples-tutorials.html).
