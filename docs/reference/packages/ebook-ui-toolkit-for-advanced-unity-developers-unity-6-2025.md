---
title: "UI Toolkit for advanced Unity developers (Unity 6 edition) e-book PDF"
source_url: "https://cdn.bfldr.com/S5BC9Y64/at/57hqmfc4hfk6tgjkxt8g35/UI_Toolkit_for_advanced_Unity_developers_Unity_6_2025.pdf"
final_url: "https://cdn.bfldr.com/S5BC9Y64/at/57hqmfc4hfk6tgjkxt8g35/UI_Toolkit_for_advanced_Unity_developers_Unity_6_2025.pdf"
topic: "packages"
publisher: "Unity Technologies"
fetched: "2026-08-23"
kind: "pdf-text"
pages: "148"
pdf_file: "../_ebooks-pdf/ebook-ui-toolkit-for-advanced-unity-developers-unity-6-2025.pdf"
---

# UI Toolkit for advanced Unity developers (Unity 6 edition) e-book PDF
...
© 2025 Unity Technologies 7 of 147 | unity.com
Introduction
...
© 2025 Unity Technologies 8 of 147 | unity.com
Introduction | Install UI Toolkit and sample projects | Introduction to UI Toolkit |
...
© 2025 Unity Technologies 9 of 147 | unity.com
...
© 2025 Unity Technologies 10 of 147 | unity.com
Introduction | Install UI Toolkit and sample projects | Introduction to UI Toolkit |
...
© 2025 Unity Technologies 11 of 147 | unity.com
Introduction | Install UI Toolkit and sample projects | Introduction to UI Toolkit |
QuizU
...
© 2025 Unity Technologies 12 of 147 | unity.com
Introduction to 
UI Toolkit
...
© 2025 Unity Technologies 13 of 147 | unity.com
| Install UI Toolkit and sample projects | Introduction to UI Toolkit | Graphic and font assets preparation | 
...
© 2025 Unity Technologies 14 of 147 | unity.com
| Install UI Toolkit and sample projects | Introduction to UI Toolkit | Graphic and font assets preparation | 
UI Builder
...
© 2025 Unity Technologies 15 of 147 | unity.com
Graphic and font 
assets preparation
...
© 2025 Unity Technologies 16 of 147 | unity.com
| Introduction to UI Toolkit | Graphic and font assets preparation | UI Builder | 
Sprites
...
handles or slicing with the green handles. These tools allow you to make the graphic tileable or 
...
© 2025 Unity Technologies 17 of 147 | unity.com
| Introduction to UI Toolkit | Graphic and font assets preparation | UI Builder | 
...
© 2025 Unity Technologies 18 of 147 | unity.com
| Introduction to UI Toolkit | Graphic and font assets preparation | UI Builder | 
2D PSD Importer
...
© 2025 Unity Technologies 19 of 147 | unity.com
| Introduction to UI Toolkit | Graphic and font assets preparation | UI Builder | 
...
© 2025 Unity Technologies 20 of 147 | unity.com
| Introduction to UI Toolkit | Graphic and font assets preparation | UI Builder | 
Vector images
...
© 2025 Unity Technologies 21 of 147 | unity.com
| Introduction to UI Toolkit | Graphic and font assets preparation | UI Builder | 
Fonts
...
© 2025 Unity Technologies 22 of 147 | unity.com
| Introduction to UI Toolkit | Graphic and font assets preparation | UI Builder | 
Dynamic atlas
...
© 2025 Unity Technologies 23 of 147 | unity.com
| Introduction to UI Toolkit | Graphic and font assets preparation | UI Builder | 
...
© 2025 Unity Technologies 24 of 147 | unity.com
UI Builder 
UI Builder is accessible from the Window/UI Toolkit/UI Builder menu.

<!-- page 25 -->

© 2025 Unity Technologies 25 of 147 | unity.com
| Graphic and font assets preparation | UI Builder | Layouts |
...
1 . StyleSheets: This is where you can manage layout and styling formatting rules (also 
known as USS selectors) to share styles across UXML Documents and UI elements.
2 . Hierarchy: Similar to the Scene view, it displays the hierarchy of visual elements in your 
UXML document.
3 . Library: This contains predefined or custom controls ready to be added to your hierarchy, 
like buttons, labels, and sliders. From here you can also add other UXML (templates) into 
your current UXML.
4 . Viewport: This shows how your interface looks; you can edit elements directly in the 
Canvas using gizmos.
5 . Code Previews: This shows the code that the UI Builder is creating behind the scenes 
for both the UI Document (UXML) and the StyleSheets (USS). You may have to resize the 
window in order to see it properly.
6 . Inspector: Use it to change the attributes and style properties of the selected element or 
USS selector.
...
© 2025 Unity Technologies 26 of 147 | unity.com
| Graphic and font assets preparation | UI Builder | Layouts |
...
© 2025 Unity Technologies 27 of 147 | unity.com
Layouts
The UI Builder gives you all the tools you need to design a responsive layout.

<!-- page 28 -->

© 2025 Unity Technologies 28 of 147 | unity.com
| UI Builder | Layouts | Styling | 
...
© 2025 Unity Technologies 29 of 147 | unity.com
| UI Builder | Layouts | Styling | 
...
UI Toolkit positions visual elements based on Yoga, an HTML/CSS layout engine that 
...
© 2025 Unity Technologies 30 of 147 | unity.com
| UI Builder | Layouts | Styling | 
...
© 2025 Unity Technologies 31 of 147 | unity.com
| UI Builder | Layouts | Styling | 
Visual elements
...
© 2025 Unity Technologies 32 of 147 | unity.com
| UI Builder | Layouts | Styling | 
...
© 2025 Unity Technologies 33 of 147 | unity.com
| UI Builder | Layouts | Styling | 
...
© 2025 Unity Technologies 34 of 147 | unity.com
| UI Builder | Layouts | Styling | 
Size settings for a visual element
The Width and Height fields define the size of the element. The Max Width and Max Height 
...
© 2025 Unity Technologies 35 of 147 | unity.com
| UI Builder | Layouts | Styling | 
...
3 . With a yellow element added, the elements overflow the space. The green element 
...
5 . Here, both elements have a Shrink value of 1. They shrink equally to fit in the available 
space.
As you can see, elements that have a fixed size expressed in pixels (the blue box in 3–5) don’t 
react to the Basis, Grow, or Shrink settings.
...
1 . The layout system computes the element size based on the Width and Height 
properties.
2 . The layout engine checks if there is additional space available in the parent 
container, or if its children are already overflowing the available space.
3 . If there is additional space available, the layout system looks for elements that 
...
4 . If the child elements overflow the available space, elements that have non-zero Flex/
Shrink values will reduce in size accordingly.
5 . Any other properties that affect the resulting size of an element (Min-Width, Flex-
Basis, etc.) are then taken into consideration.
6. The layout engine applies the final, resolved size.

<!-- page 36 -->

© 2025 Unity Technologies 36 of 147 | unity.com
| UI Builder | Layouts | Styling | 
...
Align settings
The Align settings determine how child elements line up to their parent element. Set the Align 
...
© 2025 Unity Technologies 37 of 147 | unity.com
| UI Builder | Layouts | Styling | 
...
the flex layout
Margin and Padding 
Use the Margin and Padding settings to define empty spaces around your visual elements and 
...
© 2025 Unity Technologies 38 of 147 | unity.com
| UI Builder | Layouts | Styling | 
 ...
 — The Border defines a boundary between the Padding and the Margin. This can be 
colored and rounded. If given a thickness, the Border expands inward.
 — Margin is similar to Padding but defines an area outside the Border. For elements 
...
© 2025 Unity Technologies 39 of 147 | unity.com
| UI Builder | Layouts | Styling | 
...
© 2025 Unity Technologies 40 of 147 | unity.com
| UI Builder | Layouts | Styling | 
...
© 2025 Unity Technologies 41 of 147 | unity.com
| UI Builder | Layouts | Styling | 
UXML as templates
...
© 2025 Unity Technologies 42 of 147 | unity.com
Styling
Changing style properties directly in UI Builder

<!-- page 43 -->

© 2025 Unity Technologies 43 of 147 | unity.com
| Layouts | Styling | Naming conventions |
...
© 2025 Unity Technologies 44 of 147 | unity.com
| Layouts | Styling | Naming conventions |
...
© 2025 Unity Technologies 45 of 147 | unity.com
| Layouts | Styling | Naming conventions |
...
© 2025 Unity Technologies 46 of 147 | unity.com
| Layouts | Styling | Naming conventions |
...
1 . Inline Styles: Styles applied directly to an element (e.g., in UXML or through code) take 
the highest precedence and override all USS selectors.
2 . ID selectors (#id): These are the most specific USS selectors and apply to elements with 
a unique name property.
3 . Class selectors (.className): These apply to elements with the corresponding class 
...
© 2025 Unity Technologies 47 of 147 | unity.com
| Layouts | Styling | Naming conventions |
...
© 2025 Unity Technologies 48 of 147 | unity.com
| Layouts | Styling | Naming conventions |
Editing selectors
...
© 2025 Unity Technologies 49 of 147 | unity.com
| Layouts | Styling | Naming conventions |
...
Image to use its own icon). These Overrides are the Inline style properties. 
...
© 2025 Unity Technologies 50 of 147 | unity.com
| Layouts | Styling | Naming conventions |
USS variables
...
© 2025 Unity Technologies 51 of 147 | unity.com
| Layouts | Styling | Naming conventions |
...
select a specific property in the drop-down list. In the above example, :hover state is 
...
© 2025 Unity Technologies 52 of 147 | unity.com
| Layouts | Styling | Naming conventions |
...
© 2025 Unity Technologies 53 of 147 | unity.com
| Layouts | Styling | Naming conventions |
...
© 2025 Unity Technologies 54 of 147 | unity.com
| Layouts | Styling | Naming conventions |
...
© 2025 Unity Technologies 55 of 147 | unity.com
| Layouts | Styling | Naming conventions |
...
© 2025 Unity Technologies 56 of 147 | unity.com
| Layouts | Styling | Naming conventions |
A workflow to create new themes based on existing ones could be:
1 . Create a new TSS, and add the theme to inherit from and the new USS file to be used by 
this new TSS.
2 . In UI Builder > StyleSheets, click Add Existing USS and select the one that the new 
theme will use.
3 . Copy the selector that the new theme will override.
4 . Paste it in the USS that the new theme uses, then right-click and choose Set as Active 
USS .
...
© 2025 Unity Technologies 57 of 147 | unity.com
Naming conventions
...
© 2025 Unity Technologies 58 of 147 | unity.com
| Styling | Naming conventions | Text | 
...
© 2025 Unity Technologies 59 of 147 | unity.com
| Styling | Naming conventions | Text | 
...
© 2025 Unity Technologies 60 of 147 | unity.com
Text
...
© 2025 Unity Technologies 61 of 147 | unity.com
| Naming conventions | Text | Data binding | 
...
© 2025 Unity Technologies 62 of 147 | unity.com
| Naming conventions | Text | Data binding | 
...
© 2025 Unity Technologies 63 of 147 | unity.com
| Naming conventions | Text | Data binding | 
...
© 2025 Unity Technologies 64 of 147 | unity.com
| Naming conventions | Text | Data binding | 
Gradients
...
color> . 
4 . The color tag restores the font color to white so the gradient looks as intended, while the 
...
© 2025 Unity Technologies 65 of 147 | unity.com
| Naming conventions | Text | Data binding | 
...
2 . Slice the image into multiple sprites; if you use a PSD file as described in the Graphic and 
...
3 . You can adjust the Face Info and customize the appearance/names of each "glyph" in this 
new Sprite asset. Any changes here will replace the default Face Settings from the Font 
asset.
Note: In this context, Update Sprite Asset syncs the Sprite asset to the latest Sprite Editor 
changes.

<!-- page 66 -->

© 2025 Unity Technologies 66 of 147 | unity.com
| Naming conventions | Text | Data binding | 
...
3 . Link to the Sprite asset using the file browser in the Text Settings file. Save and enter 
Play mode for the updated settings to take effect.
4 . Use the rich text tag (<sprite index=0> or <sprite name="name">) to add the sprite. 
...
© 2025 Unity Technologies 67 of 147 | unity.com
| Naming conventions | Text | Data binding | 
...
© 2025 Unity Technologies 68 of 147 | unity.com
| Naming conventions | Text | Data binding | 
These are the steps to use OS emojis in your project:
1 . Create a Font asset from the font that your target system uses. On iOS the font is 
...
3 . Enable Parse Escape Sequences on UI Builder and enter the desired emojis using 
...
© 2025 Unity Technologies 69 of 147 | unity.com
| Naming conventions | Text | Data binding | 
...
© 2025 Unity Technologies 70 of 147 | unity.com
Data binding
...
© 2025 Unity Technologies 71 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 72 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 73 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 74 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 75 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 76 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 77 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 78 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 79 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 80 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 81 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 82 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 83 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 84 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 85 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 86 of 147 | unity.com
| Text | Data binding | Localization | 
Type converters
...
© 2025 Unity Technologies 87 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 88 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 89 of 147 | unity.com
| Text | Data binding | Localization | 
Note the following:
...
1 . Open your UXML file and select the progress bar element. In the QuizU project, you can 
open the RuntimeDataBinding .uxml file to see how it’s set up.
2 . Set the Data Source to your PlayerDataSO ScriptableObject.
3 . Bind the progress bar’s backgroundColor style property to the HealthPercentage data 
path.
4 . Use the HealthColor ConverterGroup to transform the health percentage value into a 
color background for the progress bar.
Set up the data binding for the health bar.
5 . Dragging the CurrentHealth value of the PlayerDataSO ScriptableObject now updates 
the health bar color. The gradient smoothly lerps from green (full health) to yellow 
(medium), orange (low), and red (critical).

<!-- page 90 -->

© 2025 Unity Technologies 90 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 91 of 147 | unity.com
| Text | Data binding | Localization | 
...
3 . Add the ListView to the main user interface: In another UXML file, add a ListView 
...
© 2025 Unity Technologies 93 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 94 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 95 of 147 | unity.com
| Text | Data binding | Localization | 
...
© 2025 Unity Technologies 96 of 147 | unity.com
Localization
...
© 2025 Unity Technologies 97 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 98 of 147 | unity.com
| Data binding | Localization | Custom controls | 
Localization setup
...
1 . Set Up Localization Settings: Install the Localization package from the Package Manager, 
...
© 2025 Unity Technologies 99 of 147 | unity.com
| Data binding | Localization | Custom controls | 
Add a Locale.
3 . Create String and Asset Tables: Use String Tables to store text entries for each Locale. 
Add entries for UI text elements like labels, buttons, and dropdown options.
Create String Tables and Asset Tables.
2 . Create Locales: Define the 
...
© 2025 Unity Technologies 100 of 147 | unity.com
| Data binding | Localization | Custom controls | 
4 . In the Localization Tables window (Window > Asset Management > Localization Tables), 
...
Locale.
5 . Store region-specific assets like images or GameObjects in Asset Tables. For instance, 
...
6 . Define a UXML interface: Use UI Builder to create a UXML file with elements such 
...
© 2025 Unity Technologies 101 of 147 | unity.com
| Data binding | Localization | Custom controls | 
Add data bindings in the UI Builder to localized strings and assets.
7 . Bind data to UI Elements in UI Builder: This is where the power of UI Toolkit’s runtime 
...
© 2025 Unity Technologies 102 of 147 | unity.com
| Data binding | Localization | Custom controls | 
8 . To test, use the Game View Locale drop-down to preview the UI in different languages, 
...
© 2025 Unity Technologies 103 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 104 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 105 of 147 | unity.com
| Data binding | Localization | Custom controls | 
Here’s an example:
using UnityEngine;
using UnityEngine.Localization;
...
© 2025 Unity Technologies 106 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 107 of 147 | unity.com
| Data binding | Localization | Custom controls | 
The Google Sheets Service has two authorization options: OAuth or API Key. Use OAuth if 
...
© 2025 Unity Technologies 108 of 147 | unity.com
| Data binding | Localization | Custom controls | 
Using Smart Strings
...
© 2025 Unity Technologies 109 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 110 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
Formatters convert the retrieved data into the final string format. Formatters allow you to 
...
own options and format rules. The sample project includes a couple formatters:
 —  Choose Formatter: 
{0:choose(1|2|3):morning|afternoon|evening|anytime} selects "morning," 
...
© 2025 Unity Technologies 111 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 112 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 113 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 114 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 115 of 147 | unity.com
| Data binding | Localization | Custom controls | 
Localizing assets
...
© 2025 Unity Technologies 116 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 117 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 118 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 119 of 147 | unity.com
| Data binding | Localization | Custom controls | 
...
© 2025 Unity Technologies 120 of 147 | unity.com
Custom controls
...
© 2025 Unity Technologies 121 of 147 | unity.com
| Localization | Custom controls | Optimizing performance |
...
© 2025 Unity Technologies 122 of 147 | unity.com
| Localization | Custom controls | Optimizing performance |
...
© 2025 Unity Technologies 123 of 147 | unity.com
| Localization | Custom controls | Optimizing performance |
...
© 2025 Unity Technologies 124 of 147 | unity.com
| Localization | Custom controls | Optimizing performance |
...
© 2025 Unity Technologies 125 of 147 | unity.com
| Localization | Custom controls | Optimizing performance |
   [UxmlAttribute]
...
© 2025 Unity Technologies 126 of 147 | unity.com
| Localization | Custom controls | Optimizing performance |
  // …
...
© 2025 Unity Technologies 127 of 147 | unity.com
| Localization | Custom controls | Optimizing performance |
...
© 2025 Unity Technologies 128 of 147 | unity.com
| Localization | Custom controls | Optimizing performance |
       if (slideToggle != null)
       {
...
© 2025 Unity Technologies 129 of 147 | unity.com
| Localization | Custom controls | Optimizing performance |
...
© 2025 Unity Technologies 130 of 147 | unity.com
Optimizing 
performance
...
© 2025 Unity Technologies 131 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
Update mechanisms
...
Style resolution Determines the final 
...
changes.
Layout recalculation Adjusts the size and 
...
© 2025 Unity Technologies 132 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
Batching elements
...
© 2025 Unity Technologies 133 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 134 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 135 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 136 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 137 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 138 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
Masking
...
© 2025 Unity Technologies 139 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 140 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 141 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 142 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 143 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 144 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 145 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 146 of 147 | unity.com
| Custom controls | Optimizing performance | Resources for advanced developers and artists
...
© 2025 Unity Technologies 147 of 147 | unity.com
Resources for 
advanced developers 
and artists
