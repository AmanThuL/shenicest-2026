...
page_title: "Cinemachine essential elements | Cinemachine | 3.1.7"
source_url: "https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/concept-essential-elements.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/concept-essential-elements.html"
topic: "packages"
...
-   A single [**Unity Camera**](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/concept-essential-elements.html#unity-camera) which captures the images across the Scene,
-   A [**Cinemachine Brain**](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/concept-essential-elements.html#cinemachine-brain) which enables the Cinemachine functionality in the Unity Camera, and
-   One or multiple [**Cinemachine Cameras**](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/concept-essential-elements.html#cinemachine-cameras) which take turns controlling the Unity Camera according to their status.

![Cinemachine setup example: the Unity Camera with its Cinemachine Brain component and three Cinemachine Cameras.](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/images/concept-base.png)
...
To work with Cinemachine, the Unity Camera GameObject must include a [**Cinemachine Brain component**](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/CinemachineBrain.html). This component is mainly responsible to:
...
The Cinemachine Cameras (formerly named *Virtual Cameras*) are GameObjects that act as camera placeholders ready to [take control](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/concept-camera-control-transitions.html) of the Unity Camera according to their status.
...
-   They must include a [Cinemachine Camera component](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/CinemachineCamera.html).
-   They can include additional Cinemachine components to manage [procedural motion](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/concept-procedural-motion.html) and add extended functionality.

![Hierarchy example: a Scene containing a Unity Camera with Cinemachine Brain and multiple Cinemachine Cameras.](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/images/CinemachineSceneHierarchy.png)
...
-   [Set up a basic Cinemachine environment](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/setup-cinemachine-environment.html)
