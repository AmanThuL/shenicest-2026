---
title: "Control and customize blends"
page_title: "Control and customize blends | Cinemachine | 3.1.7"
source_url: "https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/ControllingAndCustomizingBlends.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/ControllingAndCustomizingBlends.html"
topic: "packages"
...
The most basic strategy is to set up a **Default Blend** in the [Cinemachine Brain](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/CinemachineBrain.html). Cinemachine uses this blend setting for all blends that are not covered by more specific settings and rules.

**Default Blend** is available in the Cinemachine Brain, and in Cinemachine Manager Cameras which themselves control and blend between a set of child cameras, such as [Clear Shot Camera](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/CinemachineClearShot.html) and [State-Driven Camera](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/CinemachineStateDrivenCamera.html).

## Custom blends with Blender Settings asset

All Cinemachine components that have a **Default Blend** property also have a **Custom Blends** setting which holds a [Blender Settings asset](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/CinemachineBlending.html).
...
Timeline explicitly controls blends that you make by [overlapping Cinemachine Shots](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/setup-timeline.html) on the Timeline's [Cinemachine Track](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/concept-timeline.html). These blends are not affected by the other blend control settings like **Default Blend** and **Custom Blends** with Blender Settings assets.
...
Each [Cinemachine Camera](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/CinemachineCamera.html) has a **Blend Hint** property. This influences the way that the camera is blended with other cameras. It doesn't control the timing, but rather the algorithm, so it's orthogonal to the other controls mentioned above.
...
Cinemachine comes with two [sample scenes](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/samples-tutorials.html), `Early LookAt Custom Blend` and `Perspective To Ortho Custom Blend`, which illustrate this technique. Coding profficiency is required.

## Additional resources

-   [Camera control and transitions](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/concept-camera-control-transitions.html)
-   [Cinemachine and Timeline](https://docs.unity3d.com/Packages/com.unity.cinemachine@3.1/manual/concept-timeline.html)
