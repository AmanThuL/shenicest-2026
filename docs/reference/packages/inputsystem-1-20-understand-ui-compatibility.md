---
title: "Understand UI system compatibility"
page_title: "Understand UI system compatibility | Input System | 1.20.0"
source_url: "https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/understand-ui-compatibility.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/understand-ui-compatibility.html"
topic: "packages"
...
Some systems and versions require that you use the Input System’s [UI Input Module component](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/using-ui-input-module.html) to pass actions from the Input System to the UI.
...
-   In versions of Unity prior to 2023.2, you must use the [UI Input Module component](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/using-ui-input-module.html) to pass actions from the Input System to the UI.
-   From Unity 2023.2 and onwards, the UI actions defined in the default [project-wide actions](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/about-project-wide-actions.html) directly map to UI Toolkit input.  
...
XR ([tracked-type input](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/supported-ui-input-types-tracked.html)) is not yet supported in combination with UI Toolkit. This means that you cannot use devices such as VR controllers to operate interfaces created with UI Toolkit.

### UI Toolkit raycasting

UI Toolkit handles raycasting internally. No separate raycaster component is necessary. This means that UI Toolkit does not support <a href="https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/api/UnityEngine.InputSystem.UI.TrackedDeviceRaycaster.html" class="xref">TrackedDeviceRaycaster</a>.
...
When using uGUI, you always need to use the [UI Input Module component](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/using-ui-input-module.html) to pass actions from the Input System to the UI.
...
The Input System package is not compatible with IMGUI. However you can still use the Input System for other parts of your project, such as gameplay. For more information, refer to [Use IMGUI alongside the Input System package](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20/manual/use-imgui-alongside-input-system.html).
