---
title: "Graph Target"
page_title: "Graph Target | Shader Graph | 17.3.0"
source_url: "https://docs.unity3d.com/Packages/com.unity.shadergraph@17.3/manual/Graph-Target.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.shadergraph@17.3/manual/Graph-Target.html"
topic: "packages"
...
A Target determines the end point compatibility of a shader you generate using Shader Graph. You can select Targets for each Shader Graph asset, and use the [Graph Settings Menu](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.3/manual/Graph-Settings-Tab.html) to change the Targets.
