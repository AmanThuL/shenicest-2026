---
title: "TextMesh Pro - Font Assets"
page_title: "Font Assets | uGUI | 2.0.0"
source_url: "https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/FontAssets.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/FontAssets.html"
topic: "packages"
...
-   **Font atlas:** a black and white or grayscale texture file that contains all of the characters included in the font Asset.  
    ...
    ![Example image](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/images/FontAtlasExample.png)  
    *Example of a font atlas*
-   **Font material:** a material that controls the appearance of TextMesh Pro text using one of the [TextMesh Pro shaders](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/Shaders.html).

Font assets must be in a specific folder so TextMesh Pro can find them and include them in builds. To change the default folder for font assets, got to the [TextMesh Pro settings](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/Settings.html) and set the **Default Font Asset \> Path** option.

## Creating Font Assets

To create a TextMesh Pro font Asset, use the TexMesh Pro [Font Asset Creator](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/FontAssetsCreator.html).
...
-   **Distance Field:** This type of atlas contains [signed distance field (SDF)](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/FontAssetsSDF.html) information.  
...
![Example image](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/images/GetFontFeatures.png)
...
![Example image](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/images/ResetMenuItem.png)
...
![Example image](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/images/ClearDynamicDataMenuItem.png)
...
![Example image](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/images/ClearDynamicDataOnBuild.png)
