---
title: "TextMesh Pro - Creating text"
page_title: "Creating text | uGUI | 2.0.0"
source_url: "https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/TMPObjects.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/TMPObjects.html"
topic: "packages"
...
-   [TextMesh Pro UI Text GameObjects](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/TMPObjectUIText.html) use [Unity's UI system](https://docs.unity3d.com/Manual/UISystem.html), and are designed for use on a [Canvas](https://docs.unity3d.com/Manual/UICanvas.html).

-   [TextMesh Pro 3D Text GameObjects](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/TMPObject3DText.html) behave like regular 3D GameObjects in the Scene.
...
2.  In the **TextMesh Pro (UGUI)** Inspector, enter your text.
3.  Adjust the [UI text properties](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/TMPObjectUIText.html) as needed.

**Additional Shader Channels**

**TextMesh Pro (UGUI)** automatically enables **TexCoord1**, **Normal**, and **Tangent** in the **[Additional Shader Channels](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/UICanvas.html#additional-shader-channels)** of its parent [Canvas](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/UICanvas.html). This is required by TMP’s shaders and occurs during text mesh generation. If you inspect the Canvas and notice these channels are set, this is expected behavior. Be aware that any custom UI shaders on the same Canvas will also receive these additional vertex attributes.
...
-   The TextMesh Pro Dropdown GameObject uses [TextMesh Pro font assets](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/FontAssets.html) instead of regular Unity font assets.  
...
-   The TextMesh Pro Input Field GameObject uses uses [TextMesh Pro font assets](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/FontAssets.html) instead of regular Unity font assets, and has more options for defining the input field.  
...
2.  In the **TextMesh Pro** Inspector, enter your text.
3.  Adjust the [3D text properties](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/TextMeshPro/TMPObject3DText.html) as needed.
...
![Example image](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/images/FontFeatures.png)
