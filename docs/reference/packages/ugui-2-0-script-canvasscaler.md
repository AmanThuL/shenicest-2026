---
title: "uGUI - Canvas Scaler"
page_title: "Canvas Scaler | uGUI | 2.0.0"
source_url: "https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/script-CanvasScaler.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/script-CanvasScaler.html"
topic: "packages"
...
![](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/images/UI_CanvasScalerInspector.png)
...
-   See the page [Designing UI for Multiple Resolutions](https://docs.unity3d.com/Packages/com.unity.ugui@2.0/manual/HOWTO-UIMultiResolution.html) for a step by step explanation of how Rect Transform anchoring and Canvas Scaler can be used in conjunction to make UI layouts that adapt to different resolutions and aspect ratios.
