---
title: "Course 14. Preserve test state"
page_title: "Unity - Manual: 14. Preserve test state"
source_url: "https://docs.unity3d.com/6000.3/Documentation/Manual/test-framework/course/preserve-test-state.html"
final_url: "https://docs.unity3d.com/6000.3/Documentation/Manual/test-framework/course/preserve-test-state.html"
...
The solution to that is serialization. If you add a `[SerializeField]` attribute to the field in question, then it will retain its value. Note that there are some limitations to serialization in Unity, see [Unity Serialization](https://docs.unity3d.com/6000.3/Documentation/Manual/script-serialization.html).

## Exercise

The [sample](https://docs.unity3d.com/6000.3/Documentation/Manual/test-framework/course/test-framework-general-introduction.html#import-samples) `14_PreserveTestState` contains the solution for the previous assignment, with one exception; the file name is now a guid.
