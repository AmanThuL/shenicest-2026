---
title: "Performance Testing package 3.5 docs"
page_title: "Performance Testing Package for Unity Test Framework | Performance testing API | 3.5.0"
source_url: "https://docs.unity3d.com/Packages/com.unity.test-framework.performance@3.5/manual/index.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.test-framework.performance@3.5/manual/index.html"
topic: "performance"
...
![Performance test example01](https://docs.unity3d.com/Packages/com.unity.test-framework.performance@3.5/manual/images/example04.png)
...
Use [IPrebuildSetup](https://docs.unity3d.com/Packages/com.unity.test-framework@1.1/api/UnityEngine.TestTools.IPrebuildSetup.html) attribute when you need to generate assets. Place assets in Resources or [StreamingAssets](https://docs.unity3d.com/Manual/SpecialFolders.html) folders, scenes can be placed anywhere in the project, but should be added to build settings.
