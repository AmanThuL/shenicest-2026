---
title: "Analyzing Unity object memory leaks"
page_title: "Analyzing Unity object memory leaks | Memory Profiler | 1.1.11"
source_url: "https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1/manual/managed-shell-objects.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1/manual/managed-shell-objects.html"
topic: "performance"
...
1.  Open the [All Of Memory tab](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1/manual/main-component.html#all-of-memory-tab) of the Main panel.
2.  Enter `“(Leaked Managed Shell)”` into the search field.

Use the **Managed Fields** data group in the [Selection Details panel](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1/manual/selection-details-component.html) and the **References To** tab of the [References panel](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1/manual/references-component.html) to find out what references these objects still hold onto.

To ensure that Unity properly unloads a leaked managed shell in future:

1.  Use the **Referenced By** tab on the [References panel](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1/manual/references-component.html) to find out what is referencing them.
...
-   [Memory Profiler reference](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1/manual/memory-profiler-window-section.html)
-   [Find memory leaks](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1/manual/find-memory-leaks.html)
