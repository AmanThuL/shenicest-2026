---
title: "Create an HDRP Asset"
page_title: "Create an HDRP Asset | High Definition Render Pipeline | 17.3.0"
source_url: "https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/create-an-hdrp-asset.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/create-an-hdrp-asset.html"
...
To change which HDRP Asset your render pipeline uses by default, either manually select an HDRP Asset in the [Graphics settings window](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/Default-Settings-Window.html), or use the GraphicsSettings.renderPipelineAsset property via script.
