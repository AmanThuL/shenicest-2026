---
title: "Control shadow resolution and quality"
page_title: "Control shadow resolution and quality | High Definition Render Pipeline | 17.3.0"
source_url: "https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/Shadows-in-HDRP.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/Shadows-in-HDRP.html"
...
- [Shadow map resolution](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/Shadows-in-HDRP.html#Shadowmapresolution)
- [Shadow atlases](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/Shadows-in-HDRP.html#Shadowatlases)
- [Shadow bias](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/Shadows-in-HDRP.html#Shadowbias)
- [Shadow filtering](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/Shadows-in-HDRP.html#ShadowFiltering)

<span id="Shadowmapresolution"></span>
...
- A Directional Light renders one shadow map per cascade. Set the cascade count of Directional Lights from the [HD Shadow Settings](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/Override-Shadows.html) of your Scene’s [Volumes](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/understand-volumes.html). The default value is four cascades.
...
1.  Open your Unity Project’s [HDRP Asset](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/HDRP-Asset.html) in the Inspector window.
...
<span id="Shadowatlases"></span>

## Shadow atlases

HDRP renders all real-time shadows for a frame using a shadow map atlas for all [punctual light](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/Glossary.html#PunctualLight) shadows, an atlas for area lights and another one for Directional Light shadows.

HDRP also renders separate shadow atlases for cached shadows. For more information, refer to [Update shadows less frequently](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/shadow-update-mode.html).

Set the size of these atlases in your Unity Project’s [HDRP Asset](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/HDRP-Asset.html). The atlas size determines the maximum resolution of shadows in your Scene.
...
<span id="mixed-cached-shadow-maps"></span>
