---
title: "HDRP system requirements"
page_title: "System requirements and compatibility | High Definition Render Pipeline | 17.3.0"
source_url: "https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/System-Requirements.html"
final_url: "https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/System-Requirements.html"
...
HDRP is a [core Unity package](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/pack-core). For each alpha, beta or patch release of Unity, the main Unity installer contains the up-to-date version of the package.
...
To use ray tracing in HDRP, there are hardware requirements you must meet. For information on these requirements, refer to [Getting started with ray tracing](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.3/manual/Ray-Tracing-Getting-Started.html).
