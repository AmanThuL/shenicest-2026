...
Shader "Hidden/BOXOPHOBIC/The Visual Engine/Elements/Paint Cutout Slope (Model)"
{
	Properties
	{
		[StyledMessage(Info, Use the Cutout By Slope elements to cut out the alpha based on the object element normal orientation., 0, 15)] _ElementMessage( "Element Message", Float ) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_7_0_g23076 = _ElementSlopeRemap.x;
				float temp_output_9_0_g23076 = ( clampResult17_g23057 - temp_output_7_0_g23076 );
				float Terrain_Slope243 = saturate( ( temp_output_9_0_g23076 / ( ( _ElementSlopeRemap.y - temp_output_7_0_g23076 ) + 0.0001 ) ) );
				...
				float lerpResult18_g23068 = lerp( 1.0 , saturate( ( temp_output_9_0_g23070 / ( ( _ElementVolumeFadeValue - temp_output_7_0_g23070 ) + 0.0001 ) ) ) , _ElementVolumeFadeMode);
				half Blend_Edge69_g23068 = lerpResult18_g23068;
				float temp_output_6_0_g23071 = Blend_Edge69_g23068;
				half Dummy72_g23068 = ( _BoundsCategory + _BoundsEnd );
				float temp_output_7_0_g23071 = Dummy72_g23068;
				#ifdef TVE_DUMMY
				float staticSwitch14_g23071 = ( temp_output_6_0_g23071 + temp_output_7_0_g23071 );
				#else
				float staticSwitch14_g23071 = temp_output_6_0_g23071;
				#endif
				float Element_Alpha196 = ( _ElementIntensity * staticSwitch14_g23071 );
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 Input_Visual94_g23078 = appendResult267;
				float clampResult80_g23078 = clamp( (Input_Visual94_g23078).x , 0.1 , 10000.0 );
				float3 appendResult139_g23078 = (float3(clampResult80_g23078 , clampResult80_g23078 , clampResult80_g23078));
				float4 color263 = IsGammaSpace() ? float4( 1, 0.7333333, 0.7294118, 1 ) : float4( 1, 0.496933, 0.4910209, 1 );
				half3 Input_Tint76_g23078 = color263.rgb;
				half3 Element_Color47_g23078 = saturate( ( appendResult139_g23078 * Input_Tint76_g23078 ) );
				float4 appendResult131_g23078 = (float4(Element_Color47_g23078 , (Input_Visual94_g23078).w));
				
				
				finalColor = appendResult131_g23078;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;194;-1536,1216;Inherit;False;Element Bounds;18;;23068;4935729172cdadd45b9b14c3fa9c1db4;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;264;-1536,1152;Inherit;False;Element Type Paint;1;;23074;5810d2854679b554b88f8bb18ff3bfa0;0;0;1;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;249;-384,640;Inherit;False;Math Remap;-1;;23076;5eda8a2bb94ebef4ab0e43d19291cd8b;3,18,0,14,0,21,1;4;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;19;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;263;1536,-240;Inherit;False;Constant;_Color5;Color 1;63;0;Create;True;0;0;0;False;0;False;1,0.7333333,0.7294118,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;176;-832,-1408;Inherit;False;Element Compile;-1;;23077;5302407fc6d65554791e558e67d59358;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;112;-1536,-1408;Half;False;Property;_ElementMessage;Element Message;0;0;Create;True;0;0;0;True;1;StyledMessage(Info, Use the Cutout By Slope elements to cut out the alpha based on the object element normal orientation., 0, 15);False;0;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;203;1792,-384;Inherit;False;Element Visuals;-1;;23078;78cf0f00cfd72824e84597f2db54a76e;1,64,1;2;59;FLOAT4;0,0,0,0;False;77;FLOAT3;1,1,1;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=65EF94948440825468E418EE99F3524AD5982AAD