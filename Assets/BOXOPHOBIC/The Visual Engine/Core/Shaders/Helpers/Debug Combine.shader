...
Shader "Hidden/BOXOPHOBIC/The Visual Engine/Helpers/Debug Combine"
{
	Properties
	{
		...
		_CombineIntensityValue( "Combine Intensity", Range( 0, 1 ) ) = 0
		_CombineProjValue( "Combine ProjY Mask", Range( 0, 1 ) ) = 0
		[StyledRemapSlider] _CombineProjRemap( "Combine ProjY Mask", Vector ) = ( 0, 1, 0, 0 )
		_CombineFormValue( "Combine Form Mask", Range( 0, 16 ) ) = 1
		[Enum(Multiply,0,Additive,1,Multiply And Additive,2)] _CombineFormMath( "Combine Form Mask", Float ) = 2
		[StyledRemapSlider] _CombineBlendRemap( "Combine Blend Mask", Vector ) = ( 0, 1, 0, 0 )
	...
	LOD 0
		...
		Pass
		{
			...
			CGPROGRAM
				...
				uniform half _CombineIntensityValue;
				uniform half4 _CombineProjRemap;
				uniform half _CombineProjValue;
				uniform half _CombineFormValue;
				uniform half _CombineFormMath;
				uniform half4 _CombineBlendRemap;
				...
				v2f VertexFunction( appdata v  )
				{
					...
					TVEVertexData Data15_g251923 =(TVEVertexData)Data16_g251583;
					float Out_Dummy15_g251923 = 0.0;
					float3 Out_PositionOS15_g251923 = float3( 0,0,0 );
					float3 Out_NormalOS15_g251923 = float3( 0,0,0 );
					float4 Out_TangentOS15_g251923 = float4( 0,0,0,0 );
					float4 Out_TransformData15_g251923 = float4( 0,0,0,0 );
					float4 Out_RotationData15_g251923 = float4( 0,0,0,0 );
					float4 Out_Interpolator15_g251923 = float4( 0,0,0,0 );
					BreakVertexData( Data15_g251923 , Out_Dummy15_g251923 , Out_PositionOS15_g251923 , Out_NormalOS15_g251923 , Out_TangentOS15_g251923 , Out_TransformData15_g251923 , Out_RotationData15_g251923 , Out_Interpolator15_g251923 );
					
					o.ase_texcoord6.xyz = vertexToFrag73_g242429;
					o.ase_texcoord7.xyz = vertexToFrag76_g242429;
					float3 vertexPos57_g251915 = v.vertex.xyz;
					float4 ase_positionCS57_g251915 = UnityObjectToClipPos( vertexPos57_g251915 );
					o.ase_texcoord9 = ase_positionCS57_g251915;
					TVEVertexData Data1902_g251673 = Data16_g251583;
					float4 Out_Interpolator1902_g251673 = float4( 0,0,0,0 );
					{
					Out_Interpolator1902_g251673 = Data1902_g251673.Interpolator;
					}
					float4 vertexToFrag1901_g251673 = Out_Interpolator1902_g251673;
					o.ase_texcoord10 = vertexToFrag1901_g251673;
					...
					#endif
					float3 vertexValue = Out_PositionOS15_g251923;
					#ifdef ASE_ABSOLUTE_VERTEX_POS
					...
					#endif
					v.vertex.w = 1;
					v.normal = Out_NormalOS15_g251923;
					v.tangent = Out_TangentOS15_g251923;
							...
							) : SV_Target
				{
					...
					float3 color130_g251915 = IsGammaSpace() ? float3( 0.15, 0.15, 0.15 ) : float3( 0.01960665, 0.01960665, 0.01960665 );
					float3 color81_g251915 = IsGammaSpace() ? float3( 0.2, 0.2, 0.2 ) : float3( 0.03310476, 0.03310476, 0.03310476 );
					float2 temp_cast_4 = (60.0).xx;
					float2 appendResult128_g251917 = (float2(ScreenPosNorm.x , ( ( _ScreenParams.y / _ScreenParams.x ) * ScreenPosNorm.y )));
					float2 FinalUV13_g251916 = ( temp_cast_4 * ( 0.5 + appendResult128_g251917 ) );
					float2 temp_cast_5 = (0.5).xx;
					float2 temp_cast_6 = (1.0).xx;
					float4 appendResult16_g251916 = (float4(ddx( FinalUV13_g251916 ) , ddy( FinalUV13_g251916 )));
					float4 UVDerivatives17_g251916 = appendResult16_g251916;
					float4 break28_g251916 = UVDerivatives17_g251916;
					float2 appendResult19_g251916 = (float2(break28_g251916.x , break28_g251916.z));
					float2 appendResult20_g251916 = (float2(break28_g251916.x , break28_g251916.z));
					float dotResult24_g251916 = dot( appendResult19_g251916 , appendResult20_g251916 );
					float2 appendResult21_g251916 = (float2(break28_g251916.y , break28_g251916.w));
					float2 appendResult22_g251916 = (float2(break28_g251916.y , break28_g251916.w));
					float dotResult23_g251916 = dot( appendResult21_g251916 , appendResult22_g251916 );
					float2 appendResult25_g251916 = (float2(dotResult24_g251916 , dotResult23_g251916));
					float2 derivativesLength29_g251916 = sqrt( appendResult25_g251916 );
					float2 temp_cast_7 = (-1.0).xx;
					float2 temp_cast_8 = (1.0).xx;
					float2 clampResult57_g251916 = clamp( ( ( ( abs( ( frac( ( FinalUV13_g251916 + 0.25 ) ) - temp_cast_5 ) ) * 4.0 ) - temp_cast_6 ) * ( 0.35 / derivativesLength29_g251916 ) ) , temp_cast_7 , temp_cast_8 );
					float2 break71_g251916 = clampResult57_g251916;
					float2 break55_g251916 = derivativesLength29_g251916;
					float4 lerpResult73_g251916 = lerp( float4( color130_g251915 , 0.0 ) , float4( color81_g251915 , 0.0 ) , saturate( ( 0.5 + ( 0.5 * break71_g251916.x * break71_g251916.y * sqrt( saturate( ( 1.1 - max( break55_g251916.x, break55_g251916.y ) ) ) ) ) ) ));
					float3 color107_g251909 = IsGammaSpace() ? float3( 0.8679245, 0.2898379, 0.1760413 ) : float3( 0.7254258, 0.06830776, 0.02612457 );
					float3 color106_g251909 = IsGammaSpace() ? float3( 0.5630165, 0.6901961, 0.1607843 ) : float3( 0.2770731, 0.4341537, 0.02217388 );
					float localBreakData4_g251908 = ( 0.0 );
					float localBuildMasksData3_g251902 = ( 0.0 );
					TVEMasksData Data3_g251902 = (TVEMasksData)0;
					half Feature_Intensity1327_g251888 = _CombineIntensityValue;
					float ifLocalVar18_g251904 = 0;
					if( Feature_Intensity1327_g251888 <= 0.0 )
					ifLocalVar18_g251904 = 0.0;
					else
					ifLocalVar18_g251904 = 1.0;
					float4 temp_cast_9 = (ifLocalVar18_g251904).xxxx;
					float4 In_MaskA3_g251902 = temp_cast_9;
					half Surface_Value1362_g251888 = ( _CombineIntensityValue * TVE_IsEnabled );
					float localIfModelDataByShader26_g242408 = ( 0.0 );
					TVEModelData Data26_g242408 = (TVEModelData)0;
					TVEModelData Data16_g242437 =(TVEModelData)0;
					float In_Dummy16_g242437 = 0.0;
					...
					TVEModelData Data15_g251891 =(TVEModelData)Data26_g242408;
					float Out_Dummy15_g251891 = 0.0;
					float3 Out_PositionWS15_g251891 = float3( 0,0,0 );
					float3 Out_PositionWO15_g251891 = float3( 0,0,0 );
					float3 Out_PivotWS15_g251891 = float3( 0,0,0 );
					float3 Out_PivotWO15_g251891 = float3( 0,0,0 );
					float3 Out_NormalWS15_g251891 = float3( 0,0,0 );
					float3 Out_TangentWS15_g251891 = float3( 0,0,0 );
					float3 Out_BitangentWS15_g251891 = float3( 0,0,0 );
					float3 Out_TriplanarWeights15_g251891 = float3( 0,0,0 );
					float3 Out_ViewDirWS15_g251891 = float3( 0,0,0 );
					float4 Out_CoordsData15_g251891 = float4( 0,0,0,0 );
					float4 Out_VertexData15_g251891 = float4( 0,0,0,0 );
					float4 Out_Interpolator15_g251891 = float4( 0,0,0,0 );
					BreakModelFragData( Data15_g251891 , Out_Dummy15_g251891 , Out_PositionWS15_g251891 , Out_PositionWO15_g251891 , Out_PivotWS15_g251891 , Out_PivotWO15_g251891 , Out_NormalWS15_g251891 , Out_TangentWS15_g251891 , Out_BitangentWS15_g251891 , Out_TriplanarWeights15_g251891 , Out_ViewDirWS15_g251891 , Out_CoordsData15_g251891 , Out_VertexData15_g251891 , Out_Interpolator15_g251891 );
					half3 Model_NormalWS1286_g251888 = Out_NormalWS15_g251891;
					float temp_output_7_0_g251897 = _CombineProjRemap.x;
					float temp_output_9_0_g251897 = ( saturate( (Model_NormalWS1286_g251888).y ) - temp_output_7_0_g251897 );
					float lerpResult1315_g251888 = lerp( 1.0 , saturate( ( temp_output_9_0_g251897 * _CombineProjRemap.z ) ) , _CombineProjValue);
					half Blend_ProjMask1357_g251888 = lerpResult1315_g251888;
					half Blend_VertMask1334_g251888 = 1.0;
					float localBuildGlobalData204_g242450 = ( 0.0 );
					TVEGlobalData Data204_g242450 =(TVEGlobalData)(TVEGlobalData)0;
					half Dummy211_g242450 = ( _GlobalCategory + _GlobalEnd );
					float In_Dummy204_g242450 = Dummy211_g242450;
					...
					float temp_output_82_0_g242467 = _GlobalCoatLayerValue;
					float temp_output_82_0_g242469 = temp_output_82_0_g242467;
					float4 tex2DArrayNode83_g242469 = SAMPLE_TEXTURE2D_ARRAY( TVE_CoatBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g242469).zw + ( (temp_output_203_0_g242469).xy * temp_output_81_0_g242469 ) ),temp_output_82_0_g242469) );
					float4 appendResult210_g242469 = (float4(tex2DArrayNode83_g242469.rgb , tex2DArrayNode83_g242469.a));
					float4 temp_output_204_0_g242469 = TVE_CoatNearCoord;
					float4 tex2DArrayNode122_g242469 = SAMPLE_TEXTURE2D_ARRAY( TVE_CoatNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g242469).zw + ( (temp_output_204_0_g242469).xy * temp_output_81_0_g242469 ) ),temp_output_82_0_g242469) );
					float4 appendResult212_g242469 = (float4(tex2DArrayNode122_g242469.rgb , tex2DArrayNode122_g242469.a));
					float4 TVE_RenderNearPositionR628_g242450 = TVE_RenderNearPositionR;
					float temp_output_507_0_g242450 = saturate( ( distance( Model_PositionWS497_g242450 , (TVE_RenderNearPositionR628_g242450).xyz ) / (TVE_RenderNearPositionR628_g242450).w ) );
					float temp_output_7_0_g242539 = 1.0;
					...
					float temp_output_82_0_g242491 = _GlobalPaintLayerValue;
					float temp_output_82_0_g242494 = temp_output_82_0_g242491;
					float4 tex2DArrayNode83_g242494 = SAMPLE_TEXTURE2D_ARRAY( TVE_PaintBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g242494).zw + ( (temp_output_203_0_g242494).xy * temp_output_81_0_g242494 ) ),temp_output_82_0_g242494) );
					float4 appendResult210_g242494 = (float4(tex2DArrayNode83_g242494.rgb , tex2DArrayNode83_g242494.a));
					float4 temp_output_204_0_g242494 = TVE_PaintNearCoord;
					float4 tex2DArrayNode122_g242494 = SAMPLE_TEXTURE2D_ARRAY( TVE_PaintNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g242494).zw + ( (temp_output_204_0_g242494).xy * temp_output_81_0_g242494 ) ),temp_output_82_0_g242494) );
					float4 appendResult212_g242494 = (float4(tex2DArrayNode122_g242494.rgb , tex2DArrayNode122_g242494.a));
					float4 lerpResult131_g242494 = lerp( appendResult210_g242494 , appendResult212_g242494 , Global_TexBlend509_g242450);
					float4 temp_output_171_109_g242491 = lerpResult131_g242494;
					float4 lerpResult174_g242491 = lerp( TVE_PaintParams , temp_output_171_109_g242491 , TVE_PaintLayers[(int)temp_output_82_0_g242491]);
					...
					float temp_output_132_0_g242475 = _GlobalAtmoLayerValue;
					float temp_output_82_0_g242477 = temp_output_132_0_g242475;
					float4 tex2DArrayNode83_g242477 = SAMPLE_TEXTURE2D_ARRAY( TVE_AtmoBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g242477).zw + ( (temp_output_203_0_g242477).xy * temp_output_81_0_g242477 ) ),temp_output_82_0_g242477) );
					float4 appendResult210_g242477 = (float4(tex2DArrayNode83_g242477.rgb , tex2DArrayNode83_g242477.a));
					float4 temp_output_204_0_g242477 = TVE_AtmoNearCoord;
					float4 tex2DArrayNode122_g242477 = SAMPLE_TEXTURE2D_ARRAY( TVE_AtmoNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g242477).zw + ( (temp_output_204_0_g242477).xy * temp_output_81_0_g242477 ) ),temp_output_82_0_g242477) );
					float4 appendResult212_g242477 = (float4(tex2DArrayNode122_g242477.rgb , tex2DArrayNode122_g242477.a));
					float4 lerpResult131_g242477 = lerp( appendResult210_g242477 , appendResult212_g242477 , Global_TexBlend509_g242450);
					float4 temp_output_137_109_g242475 = lerpResult131_g242477;
					float4 lerpResult145_g242475 = lerp( TVE_AtmoParams , temp_output_137_109_g242475 , TVE_AtmoLayers[(int)temp_output_132_0_g242475]);
					...
					float temp_output_132_0_g242543 = _GlobalEffexLayerValue;
					float temp_output_82_0_g242545 = temp_output_132_0_g242543;
					float4 tex2DArrayNode83_g242545 = SAMPLE_TEXTURE2D_ARRAY( TVE_EffexBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g242545).zw + ( (temp_output_203_0_g242545).xy * temp_output_81_0_g242545 ) ),temp_output_82_0_g242545) );
					float4 appendResult210_g242545 = (float4(tex2DArrayNode83_g242545.rgb , tex2DArrayNode83_g242545.a));
					float4 temp_output_204_0_g242545 = TVE_EffexNearCoord;
					float4 tex2DArrayNode122_g242545 = SAMPLE_TEXTURE2D_ARRAY( TVE_EffexNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g242545).zw + ( (temp_output_204_0_g242545).xy * temp_output_81_0_g242545 ) ),temp_output_82_0_g242545) );
					float4 appendResult212_g242545 = (float4(tex2DArrayNode122_g242545.rgb , tex2DArrayNode122_g242545.a));
					float4 lerpResult131_g242545 = lerp( appendResult210_g242545 , appendResult212_g242545 , Global_TexBlend509_g242450);
					float4 temp_output_137_109_g242543 = lerpResult131_g242545;
					float4 lerpResult145_g242543 = lerp( TVE_EffexParams , temp_output_137_109_g242543 , TVE_EffexLayers[(int)temp_output_132_0_g242543]);
					...
					float temp_output_82_0_g242523 = _GlobalGlowLayerValue;
					float temp_output_82_0_g242525 = temp_output_82_0_g242523;
					float4 tex2DArrayNode83_g242525 = SAMPLE_TEXTURE2D_ARRAY( TVE_GlowBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g242525).zw + ( (temp_output_203_0_g242525).xy * temp_output_81_0_g242525 ) ),temp_output_82_0_g242525) );
					float4 appendResult210_g242525 = (float4(tex2DArrayNode83_g242525.rgb , tex2DArrayNode83_g242525.a));
					float4 temp_output_204_0_g242525 = TVE_GlowNearCoord;
					float4 tex2DArrayNode122_g242525 = SAMPLE_TEXTURE2D_ARRAY( TVE_GlowNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g242525).zw + ( (temp_output_204_0_g242525).xy * temp_output_81_0_g242525 ) ),temp_output_82_0_g242525) );
					float4 appendResult212_g242525 = (float4(tex2DArrayNode122_g242525.rgb , tex2DArrayNode122_g242525.a));
					float4 lerpResult131_g242525 = lerp( appendResult210_g242525 , appendResult212_g242525 , Global_TexBlend509_g242450);
					float4 temp_output_159_109_g242523 = lerpResult131_g242525;
					float4 lerpResult167_g242523 = lerp( TVE_GlowParams , temp_output_159_109_g242523 , TVE_GlowLayers[(int)temp_output_82_0_g242523]);
					...
					float temp_output_130_0_g242459 = _GlobalFormLayerValue;
					float temp_output_82_0_g242461 = temp_output_130_0_g242459;
					float4 tex2DArrayNode83_g242461 = SAMPLE_TEXTURE2D_ARRAY( TVE_FormBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g242461).zw + ( (temp_output_203_0_g242461).xy * temp_output_81_0_g242461 ) ),temp_output_82_0_g242461) );
					float4 appendResult210_g242461 = (float4(tex2DArrayNode83_g242461.rgb , tex2DArrayNode83_g242461.a));
					float4 temp_output_204_0_g242461 = TVE_FormNearCoord;
					float4 tex2DArrayNode122_g242461 = SAMPLE_TEXTURE2D_ARRAY( TVE_FormNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g242461).zw + ( (temp_output_204_0_g242461).xy * temp_output_81_0_g242461 ) ),temp_output_82_0_g242461) );
					float4 appendResult212_g242461 = (float4(tex2DArrayNode122_g242461.rgb , tex2DArrayNode122_g242461.a));
					float4 lerpResult131_g242461 = lerp( appendResult210_g242461 , appendResult212_g242461 , Global_TexBlend509_g242450);
					float4 temp_output_135_109_g242459 = lerpResult131_g242461;
					float4 lerpResult143_g242459 = lerp( TVE_FormParams , temp_output_135_109_g242459 , TVE_FormLayers[(int)temp_output_130_0_g242459]);
					...
					float temp_output_136_0_g242507 = _GlobalVertxLayerValue;
					float temp_output_82_0_g242509 = temp_output_136_0_g242507;
					float4 tex2DArrayNode83_g242509 = SAMPLE_TEXTURE2D_ARRAY( TVE_VertxBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g242509).zw + ( (temp_output_203_0_g242509).xy * temp_output_81_0_g242509 ) ),temp_output_82_0_g242509) );
					float4 appendResult210_g242509 = (float4(tex2DArrayNode83_g242509.rgb , tex2DArrayNode83_g242509.a));
					float4 temp_output_204_0_g242509 = TVE_VertxNearCoord;
					float4 tex2DArrayNode122_g242509 = SAMPLE_TEXTURE2D_ARRAY( TVE_VertxNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g242509).zw + ( (temp_output_204_0_g242509).xy * temp_output_81_0_g242509 ) ),temp_output_82_0_g242509) );
					float4 appendResult212_g242509 = (float4(tex2DArrayNode122_g242509.rgb , tex2DArrayNode122_g242509.a));
					float4 lerpResult131_g242509 = lerp( appendResult210_g242509 , appendResult212_g242509 , Global_TexBlend509_g242450);
					float4 temp_output_141_109_g242507 = lerpResult131_g242509;
					float4 lerpResult149_g242507 = lerp( TVE_VertxParams , temp_output_141_109_g242507 , TVE_VertxLayers[(int)temp_output_136_0_g242507]);
					...
					float temp_output_136_0_g242483 = _GlobalFlowLayerValue;
					float temp_output_82_0_g242485 = temp_output_136_0_g242483;
					float4 tex2DArrayNode83_g242485 = SAMPLE_TEXTURE2D_ARRAY( TVE_FlowBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g242485).zw + ( (temp_output_203_0_g242485).xy * temp_output_81_0_g242485 ) ),temp_output_82_0_g242485) );
					float4 appendResult210_g242485 = (float4(tex2DArrayNode83_g242485.rgb , tex2DArrayNode83_g242485.a));
					float4 temp_output_204_0_g242485 = TVE_FlowNearCoord;
					float4 tex2DArrayNode122_g242485 = SAMPLE_TEXTURE2D_ARRAY( TVE_FlowNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g242485).zw + ( (temp_output_204_0_g242485).xy * temp_output_81_0_g242485 ) ),temp_output_82_0_g242485) );
					float4 appendResult212_g242485 = (float4(tex2DArrayNode122_g242485.rgb , tex2DArrayNode122_g242485.a));
					float4 lerpResult131_g242485 = lerp( appendResult210_g242485 , appendResult212_g242485 , Global_TexBlend509_g242450);
					float4 temp_output_141_109_g242483 = lerpResult131_g242485;
					float4 lerpResult149_g242483 = lerp( TVE_FlowParams , temp_output_141_109_g242483 , TVE_FlowLayers[(int)temp_output_136_0_g242483]);
					...
					float4 In_UserTexture204_g242450 = User_Texture677_g242450;
					BuildGlobalData( Data204_g242450 , In_Dummy204_g242450 , In_CoatTexture204_g242450 , In_DrawTexture204_g242450 , In_PaintTexture204_g242450 , In_AtmoTexture204_g242450 , In_EffexTexture204_g242450 , In_GlowTexture204_g242450 , In_FormTexture204_g242450 , In_LandTexture204_g242450 , In_VertxTexture204_g242450 , In_FlowTexture204_g242450 , In_UserTexture204_g242450 );
					TVEGlobalData Data15_g251889 =(TVEGlobalData)Data204_g242450;
					float Out_Dummy15_g251889 = 0.0;
					float4 Out_CoatTexture15_g251889 = float4( 0,0,0,0 );
					float4 Out_DrawTexture15_g251889 = float4( 0,0,0,0 );
					float4 Out_PaintTexture15_g251889 = float4( 0,0,0,0 );
					float4 Out_AtmoTexture15_g251889 = float4( 0,0,0,0 );
					float4 Out_EffexTexture15_g251889 = float4( 0,0,0,0 );
					float4 Out_GlowTexture15_g251889 = float4( 0,0,0,0 );
					float4 Out_FormTexture15_g251889 = float4( 0,0,0,0 );
					float4 Out_LandTexture15_g251889 = float4( 0,0,0,0 );
					float4 Out_VertxTexture15_g251889 = float4( 0,0,0,0 );
					float4 Out_FlowTexture15_g251889 = float4( 0,0,0,0 );
					float4 Out_UserTexture15_g251889 = float4( 0,0,0,0 );
					BreakData( Data15_g251889 , Out_Dummy15_g251889 , Out_CoatTexture15_g251889 , Out_DrawTexture15_g251889 , Out_PaintTexture15_g251889 , Out_AtmoTexture15_g251889 , Out_EffexTexture15_g251889 , Out_GlowTexture15_g251889 , Out_FormTexture15_g251889 , Out_LandTexture15_g251889 , Out_VertxTexture15_g251889 , Out_FlowTexture15_g251889 , Out_UserTexture15_g251889 );
					half4 Global_FormTexture1276_g251888 = Out_FormTexture15_g251889;
					float3 temp_output_1278_17_g251888 = Out_PositionWO15_g251891;
					float3 Model_PositionWO1289_g251888 = temp_output_1278_17_g251888;
					float temp_output_7_0_g251906 = -_CombineFormValue;
					float temp_output_9_0_g251906 = ( ( ( (Global_FormTexture1276_g251888).z - (Model_PositionWO1289_g251888).y ) - 0.01 ) - temp_output_7_0_g251906 );
					float temp_output_1496_0_g251888 = saturate( ( temp_output_9_0_g251906 / ( ( 0.0 - temp_output_7_0_g251906 ) + 0.0001 ) ) );
					float temp_output_64_0_g251905 = ( temp_output_1496_0_g251888 * temp_output_1496_0_g251888 );
					float Multiply89_g251905 = temp_output_64_0_g251905;
					float Additive89_g251905 = 1.0;
					float temp_output_78_0_g251905 = ( temp_output_64_0_g251905 * 0.5 );
					float MulAdd89_g251905 = temp_output_78_0_g251905;
					float temp_output_67_0_g251905 = _CombineFormMath;
					float Option89_g251905 = temp_output_67_0_g251905;
					float localSwitchFormMask89_g251905 = SwitchFormMask( Multiply89_g251905 , Additive89_g251905 , MulAdd89_g251905 , Option89_g251905 );
					half Blend_FormMask_Mul1355_g251888 = localSwitchFormMask89_g251905;
					float Multiply88_g251905 = 0.0;
					float Additive88_g251905 = temp_output_64_0_g251905;
					float MulAdd88_g251905 = temp_output_78_0_g251905;
					float Option88_g251905 = temp_output_67_0_g251905;
					float localSwitchFormMask88_g251905 = SwitchFormMask( Multiply88_g251905 , Additive88_g251905 , MulAdd88_g251905 , Option88_g251905 );
					half Blend_FormMask_Add1356_g251888 = localSwitchFormMask88_g251905;
					float temp_output_7_0_g251900 = _CombineBlendRemap.x;
					float temp_output_9_0_g251900 = ( saturate( ( ( Surface_Value1362_g251888 * Blend_ProjMask1357_g251888 * Blend_VertMask1334_g251888 * Blend_FormMask_Mul1355_g251888 ) + Blend_FormMask_Add1356_g251888 ) ) - temp_output_7_0_g251900 );
					half Blend_Mask1358_g251888 = saturate( ( temp_output_9_0_g251900 * _CombineBlendRemap.z ) );
					float ifLocalVar18_g251907 = 0;
					if( Feature_Intensity1327_g251888 <= 0.0 )
					ifLocalVar18_g251907 = 0.0;
					else
					ifLocalVar18_g251907 = Blend_Mask1358_g251888;
					float4 appendResult1506_g251888 = (float4(ifLocalVar18_g251907 , 0.0 , 0.0 , 0.0));
					float4 In_MaskB3_g251902 = appendResult1506_g251888;
					float2 temp_output_1331_0_g251888 = ((Global_FormTexture1276_g251888).xy*2.0 + -1.0);
					float2 break1291_g251888 = temp_output_1331_0_g251888;
					float dotResult1292_g251888 = dot( temp_output_1331_0_g251888 , temp_output_1331_0_g251888 );
					float3 appendResult1329_g251888 = (float3(break1291_g251888.x , sqrt( ( 1.0 - saturate( dotResult1292_g251888 ) ) ) , break1291_g251888.y));
					half3 Local_NormalWS1339_g251888 = appendResult1329_g251888;
					float3 ifLocalVar18_g251903 = 0;
					if( Feature_Intensity1327_g251888 <= 0.0 )
					ifLocalVar18_g251903 = Model_NormalWS1286_g251888;
					else
					ifLocalVar18_g251903 = Local_NormalWS1339_g251888;
					float4 appendResult1505_g251888 = (float4(ifLocalVar18_g251903 , 0.0));
					float4 In_MaskC3_g251902 = appendResult1505_g251888;
					float4 temp_cast_20 = (0.0).xxxx;
					float4 In_MaskD3_g251902 = temp_cast_20;
					float4 temp_cast_21 = (0.0).xxxx;
					float4 In_MaskE3_g251902 = temp_cast_21;
					float4 temp_cast_22 = (0.0).xxxx;
					float4 In_MaskF3_g251902 = temp_cast_22;
					float4 temp_cast_23 = (0.0).xxxx;
					float4 In_MaskG3_g251902 = temp_cast_23;
					float4 temp_cast_24 = (0.0).xxxx;
					float4 In_MaskH3_g251902 = temp_cast_24;
					float4 temp_cast_25 = (0.0).xxxx;
					float4 In_MaskI3_g251902 = temp_cast_25;
					float4 temp_cast_26 = (0.0).xxxx;
					float4 In_MaskJ3_g251902 = temp_cast_26;
					float4 temp_cast_27 = (0.0).xxxx;
					float4 In_MaskK3_g251902 = temp_cast_27;
					float4 temp_cast_28 = (0.0).xxxx;
					float4 In_MaskL3_g251902 = temp_cast_28;
					{
					Data3_g251902.MaskA = In_MaskA3_g251902;
					Data3_g251902.MaskB = In_MaskB3_g251902;
					Data3_g251902.MaskC = In_MaskC3_g251902;
					Data3_g251902.MaskD = In_MaskD3_g251902;
					Data3_g251902.MaskE = In_MaskE3_g251902;
					Data3_g251902.MaskF = In_MaskF3_g251902;
					Data3_g251902.MaskG = In_MaskG3_g251902;
					Data3_g251902.MaskH = In_MaskH3_g251902;
					Data3_g251902.MaskI = In_MaskI3_g251902;
					Data3_g251902.MaskJ= In_MaskJ3_g251902;
					Data3_g251902.MaskK= In_MaskK3_g251902;
					Data3_g251902.MaskL = In_MaskL3_g251902;
					}
					TVEMasksData Data4_g251908 = Data3_g251902;
					float4 Out_MaskA4_g251908 = float4( 0,0,0,0 );
					float4 Out_MaskB4_g251908 = float4( 0,0,0,0 );
					float4 Out_MaskC4_g251908 = float4( 0,0,0,0 );
					float4 Out_MaskD4_g251908 = float4( 0,0,0,0 );
					float4 Out_MaskE4_g251908 = float4( 0,0,0,0 );
					float4 Out_MaskF4_g251908 = float4( 0,0,0,0 );
					float4 Out_MaskG4_g251908 = float4( 0,0,0,0 );
					float4 Out_MaskH4_g251908 = float4( 0,0,0,0 );
					{
					Out_MaskA4_g251908 = Data4_g251908.MaskA;
					Out_MaskB4_g251908 = Data4_g251908.MaskB;
					Out_MaskC4_g251908 = Data4_g251908.MaskC;
					Out_MaskD4_g251908 = Data4_g251908.MaskD;
					Out_MaskE4_g251908 = Data4_g251908.MaskE;
					Out_MaskF4_g251908 = Data4_g251908.MaskF;
					Out_MaskG4_g251908 = Data4_g251908.MaskG;
					Out_MaskH4_g251908 = Data4_g251908.MaskH;
					}
					float3 lerpResult2568 = lerp( color107_g251909 , color106_g251909 , (Out_MaskA4_g251908).x);
					float3 ifLocalVar40_g251912 = 0;
					if( TVE_DEBUG_Index == 0.0 )
					ifLocalVar40_g251912 = lerpResult2568;
					float3 ifLocalVar40_g251913 = 0;
					if( TVE_DEBUG_Index == 2.0 )
					ifLocalVar40_g251913 = (Out_MaskB4_g251908).xxx;
					float3 ifLocalVar40_g251911 = 0;
					if( TVE_DEBUG_Index == 4.0 )
					ifLocalVar40_g251911 = (Out_MaskC4_g251908).xyz;
					float3 temp_output_2585_0 = ifLocalVar40_g251911;
					float3 temp_output_2550_0 = ( ifLocalVar40_g251912 + ifLocalVar40_g251913 + temp_output_2585_0 );
					half3 Final_Debug2399 = temp_output_2550_0;
					float temp_output_7_0_g251922 = TVE_DEBUG_Min;
					float3 temp_cast_29 = (temp_output_7_0_g251922).xxx;
					float3 temp_output_9_0_g251922 = ( Final_Debug2399 - temp_cast_29 );
					float lerpResult76_g251915 = lerp( 1.0 , _IsTVEShader , TVE_DEBUG_Filter);
					float Filter152_g251915 = lerpResult76_g251915;
					float3 lerpResult72_g251915 = lerp( (lerpResult73_g251916).rgb , saturate( ( temp_output_9_0_g251922 / ( ( TVE_DEBUG_Max - temp_output_7_0_g251922 ) + 0.0001 ) ) ) , Filter152_g251915);
					float dotResult61_g251915 = dot( NormalWS , ViewDirWS );
					float temp_output_65_0_g251915 = ( 1.0 - saturate( dotResult61_g251915 ) );
					float Shading_Fresnel59_g251915 = (( 1.0 - ( temp_output_65_0_g251915 * temp_output_65_0_g251915 ) )*0.3 + 0.7);
					float4 ase_positionCS57_g251915 = IN.ase_texcoord9;
					float depthLinearEye57_g251915 = LinearEyeDepth( ase_positionCS57_g251915.z / ase_positionCS57_g251915.w );
					float temp_output_69_0_g251915 = saturate(  (0.0 + ( depthLinearEye57_g251915 - 300.0 ) * ( 1.0 - 0.0 ) / ( 0.0 - 300.0 ) ) );
					float Shading_Distance58_g251915 = (( temp_output_69_0_g251915 * temp_output_69_0_g251915 )*0.5 + 0.5);
					float lerpResult84_g251915 = lerp( 1.0 , Shading_Fresnel59_g251915 , ( Shading_Distance58_g251915 * TVE_DEBUG_Shading ));
					float localBreakVisualData4_g251920 = ( 0.0 );
					float localBuildVisualData3_g251679 = ( 0.0 );
					float localBuildVisualData3_g251674 = ( 0.0 );
					TVEVisualData Data3_g251674 =(TVEVisualData)0;
					float temp_output_14_0_g251674 = 0.0;
					float In_Dummy3_g251674 = temp_output_14_0_g251674;
					float3 temp_cast_30 = (0.5).xxx;
					float3 temp_output_4_0_g251674 = temp_cast_30;
					float3 In_Albedo3_g251674 = temp_output_4_0_g251674;
					float3 temp_cast_31 = (0.5).xxx;
					float3 temp_output_44_0_g251674 = temp_cast_31;
					float3 In_AlbedoBase3_g251674 = temp_output_44_0_g251674;
					float2 temp_cast_32 = (0.0).xx;
					float2 In_NormalTS3_g251674 = temp_cast_32;
					float3 temp_cast_33 = (0.5).xxx;
					float3 In_NormalWS3_g251674 = temp_cast_33;
					float4 In_Shader3_g251674 = half4( 0, 1, 0, 1 );
					float4 In_Feature3_g251674 = half4( 1, 1, 1, 1 );
					float4 In_Season3_g251674 = half4( 1, 1, 1, 1 );
					float4 In_Emissive3_g251674 = half4( 1, 1, 1, 1 );
					float temp_output_12_0_g251674 = 0.5;
					float In_Grayscale3_g251674 = temp_output_12_0_g251674;
					float temp_output_16_0_g251674 = 1.0;
					float In_Luminosity3_g251674 = temp_output_16_0_g251674;
					float In_MultiMask3_g251674 = 1.0;
					float In_AlphaClip3_g251674 = 1.0;
					float In_AlphaFade3_g251674 = 1.0;
					float3 temp_cast_34 = (1.0).xxx;
					float3 In_Translucency3_g251674 = temp_cast_34;
					float In_Transmission3_g251674 = 1.0;
					float In_Thickness3_g251674 = 0.0;
					float In_Diffusion3_g251674 = 0.0;
					float In_Depth3_g251674 = 0.0;
					BuildVisualData( Data3_g251674 , In_Dummy3_g251674 , In_Albedo3_g251674 , In_AlbedoBase3_g251674 , In_NormalTS3_g251674 , In_NormalWS3_g251674 , In_Shader3_g251674 , In_Feature3_g251674 , In_Season3_g251674 , In_Emissive3_g251674 , In_Grayscale3_g251674 , In_Luminosity3_g251674 , In_MultiMask3_g251674 , In_AlphaClip3_g251674 , In_AlphaFade3_g251674 , In_Translucency3_g251674 , In_Transmission3_g251674 , In_Thickness3_g251674 , In_Diffusion3_g251674 , In_Depth3_g251674 );
					TVEVisualData Data3_g251679 =(TVEVisualData)Data3_g251674;
					half Dummy130_g251677 = ( _MainCategory + _MainEnd );
					float temp_output_14_0_g251679 = Dummy130_g251677;
					float In_Dummy3_g251679 = temp_output_14_0_g251679;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture276_g251700) = _MainAlbedoTex;
					#if defined( TVE_FILTER_DEFAULT )
					SamplerState staticSwitch36_g251682 = sampler_Linear_Repeat_Aniso8;
					#elif defined( TVE_FILTER_POINT )
					SamplerState staticSwitch36_g251682 = sampler_Point_Repeat;
					#elif defined( TVE_FILTER_LOW )
					SamplerState staticSwitch36_g251682 = sampler_Linear_Repeat;
					...
					SamplerState staticSwitch36_g251682 = sampler_Linear_Repeat_Aniso8;
					#endif
					SamplerState Sampler276_g251700 = staticSwitch36_g251682;
					float localBreakTextureData456_g251700 = ( 0.0 );
					float localBuildTextureData431_g251699 = ( 0.0 );
					TVEMasksData Data431_g251699 =(TVEMasksData)(TVEMasksData)0;
					float localComputeMeshCoords444_g251699 = ( 0.0 );
					float4 temp_output_6_0_g251715 = _main_coord_value;
					float4 temp_output_7_0_g251715 = ( _MainSampleMode + _MainCoordMode + _MainCoordValue );
					#ifdef TVE_DUMMY
					float4 staticSwitch14_g251715 = ( temp_output_6_0_g251715 + temp_output_7_0_g251715 );
					#else
					float4 staticSwitch14_g251715 = temp_output_6_0_g251715;
					#endif
					half4 Local_Coords180_g251677 = staticSwitch14_g251715;
					float4 Coords444_g251699 = Local_Coords180_g251677;
					TVEModelData Data15_g251675 =(TVEModelData)Data26_g242408;
					float Out_Dummy15_g251675 = 0.0;
					float3 Out_PositionWS15_g251675 = float3( 0,0,0 );
					float3 Out_PositionWO15_g251675 = float3( 0,0,0 );
					float3 Out_PivotWS15_g251675 = float3( 0,0,0 );
					float3 Out_PivotWO15_g251675 = float3( 0,0,0 );
					float3 Out_NormalWS15_g251675 = float3( 0,0,0 );
					float3 Out_TangentWS15_g251675 = float3( 0,0,0 );
					float3 Out_BitangentWS15_g251675 = float3( 0,0,0 );
					float3 Out_TriplanarWeights15_g251675 = float3( 0,0,0 );
					float3 Out_ViewDirWS15_g251675 = float3( 0,0,0 );
					float4 Out_CoordsData15_g251675 = float4( 0,0,0,0 );
					float4 Out_VertexData15_g251675 = float4( 0,0,0,0 );
					float4 Out_Interpolator15_g251675 = float4( 0,0,0,0 );
					BreakModelFragData( Data15_g251675 , Out_Dummy15_g251675 , Out_PositionWS15_g251675 , Out_PositionWO15_g251675 , Out_PivotWS15_g251675 , Out_PivotWO15_g251675 , Out_NormalWS15_g251675 , Out_TangentWS15_g251675 , Out_BitangentWS15_g251675 , Out_TriplanarWeights15_g251675 , Out_ViewDirWS15_g251675 , Out_CoordsData15_g251675 , Out_VertexData15_g251675 , Out_Interpolator15_g251675 );
					TVEModelData Data16_g251676 =(TVEModelData)Data15_g251675;
					float In_Dummy16_g251676 = Out_Dummy15_g251675;
					float3 In_PositionWS16_g251676 = Out_PositionWS15_g251675;
					float3 In_PositionWO16_g251676 = Out_PositionWO15_g251675;
					float3 In_PivotWS16_g251676 = Out_PivotWS15_g251675;
					float3 In_PivotWO16_g251676 = Out_PivotWO15_g251675;
					float3 In_NormalWS16_g251676 = Out_NormalWS15_g251675;
					float3 In_TangentWS16_g251676 = Out_TangentWS15_g251675;
					float3 In_BitangentWS16_g251676 = Out_BitangentWS15_g251675;
					float3 In_TriplanarWeights16_g251676 = Out_TriplanarWeights15_g251675;
					float3 In_ViewDirWS16_g251676 = Out_ViewDirWS15_g251675;
					float4 In_CoordsData16_g251676 = Out_CoordsData15_g251675;
					float4 In_VertexData16_g251676 = Out_VertexData15_g251675;
					float4 vertexToFrag1901_g251673 = IN.ase_texcoord10;
					float4 In_Interpolator16_g251676 = vertexToFrag1901_g251673;
					BuildModelFragData( Data16_g251676 , In_Dummy16_g251676 , In_PositionWS16_g251676 , In_PositionWO16_g251676 , In_PivotWS16_g251676 , In_PivotWO16_g251676 , In_NormalWS16_g251676 , In_TangentWS16_g251676 , In_BitangentWS16_g251676 , In_TriplanarWeights16_g251676 , In_ViewDirWS16_g251676 , In_CoordsData16_g251676 , In_VertexData16_g251676 , In_Interpolator16_g251676 );
					TVEModelData Data15_g251678 =(TVEModelData)Data16_g251676;
					...
					float4 Model_CoordsData324_g251677 = Out_CoordsData15_g251678;
					float4 MeshCoords444_g251699 = Model_CoordsData324_g251677;
					float2 UV0444_g251699 = float2( 0,0 );
					float2 UV3444_g251699 = float2( 0,0 );
					ComputeMeshCoords( Coords444_g251699 , MeshCoords444_g251699 , UV0444_g251699 , UV3444_g251699 );
					float4 appendResult430_g251699 = (float4(UV0444_g251699 , UV3444_g251699));
					float4 In_MaskA431_g251699 = appendResult430_g251699;
					float localComputeWorldCoords315_g251699 = ( 0.0 );
					float4 Coords315_g251699 = Local_Coords180_g251677;
					float3 Model_PositionWO222_g251677 = Out_PositionWO15_g251678;
					float3 PositionWS315_g251699 = Model_PositionWO222_g251677;
					float2 ZY315_g251699 = float2( 0,0 );
					float2 XZ315_g251699 = float2( 0,0 );
					float2 XY315_g251699 = float2( 0,0 );
					ComputeWorldCoords( Coords315_g251699 , PositionWS315_g251699 , ZY315_g251699 , XZ315_g251699 , XY315_g251699 );
					float2 ZY402_g251699 = ZY315_g251699;
					float2 XZ403_g251699 = XZ315_g251699;
					float4 appendResult432_g251699 = (float4(ZY402_g251699 , XZ403_g251699));
					float4 In_MaskB431_g251699 = appendResult432_g251699;
					float2 XY404_g251699 = XY315_g251699;
					float localComputeStochasticCoords409_g251699 = ( 0.0 );
					float2 UV409_g251699 = ZY402_g251699;
					float2 UV1409_g251699 = float2( 0,0 );
					float2 UV2409_g251699 = float2( 0,0 );
					float2 UV3409_g251699 = float2( 0,0 );
					float3 Weights409_g251699 = float3( 0,0,0 );
					ComputeStochasticCoords( UV409_g251699 , UV1409_g251699 , UV2409_g251699 , UV3409_g251699 , Weights409_g251699 );
					float4 appendResult433_g251699 = (float4(XY404_g251699 , UV1409_g251699));
					float4 In_MaskC431_g251699 = appendResult433_g251699;
					float4 appendResult434_g251699 = (float4(UV2409_g251699 , UV3409_g251699));
					float4 In_MaskD431_g251699 = appendResult434_g251699;
					float localComputeStochasticCoords422_g251699 = ( 0.0 );
					float2 UV422_g251699 = XZ403_g251699;
					float2 UV1422_g251699 = float2( 0,0 );
					float2 UV2422_g251699 = float2( 0,0 );
					float2 UV3422_g251699 = float2( 0,0 );
					float3 Weights422_g251699 = float3( 0,0,0 );
					ComputeStochasticCoords( UV422_g251699 , UV1422_g251699 , UV2422_g251699 , UV3422_g251699 , Weights422_g251699 );
					float4 appendResult435_g251699 = (float4(UV1422_g251699 , UV2422_g251699));
					float4 In_MaskE431_g251699 = appendResult435_g251699;
					float localComputeStochasticCoords423_g251699 = ( 0.0 );
					float2 UV423_g251699 = XY404_g251699;
					float2 UV1423_g251699 = float2( 0,0 );
					float2 UV2423_g251699 = float2( 0,0 );
					float2 UV3423_g251699 = float2( 0,0 );
					float3 Weights423_g251699 = float3( 0,0,0 );
					ComputeStochasticCoords( UV423_g251699 , UV1423_g251699 , UV2423_g251699 , UV3423_g251699 , Weights423_g251699 );
					float4 appendResult436_g251699 = (float4(UV3422_g251699 , UV1423_g251699));
					float4 In_MaskF431_g251699 = appendResult436_g251699;
					float4 appendResult437_g251699 = (float4(UV2423_g251699 , UV3423_g251699));
					float4 In_MaskG431_g251699 = appendResult437_g251699;
					float4 In_MaskH431_g251699 = float4( Weights409_g251699 , 0.0 );
					float4 In_MaskI431_g251699 = float4( Weights422_g251699 , 0.0 );
					float4 In_MaskJ431_g251699 = float4( Weights423_g251699 , 0.0 );
					half3 Model_NormalWS226_g251677 = Out_NormalWS15_g251678;
					float3 temp_output_449_0_g251699 = Model_NormalWS226_g251677;
					float4 In_MaskK431_g251699 = float4( temp_output_449_0_g251699 , 0.0 );
					half3 Model_TangentWS366_g251677 = Out_TangentWS15_g251678;
					float3 temp_output_450_0_g251699 = Model_TangentWS366_g251677;
					float4 In_MaskL431_g251699 = float4( temp_output_450_0_g251699 , 0.0 );
					half3 Model_BitangentWS367_g251677 = Out_BitangentWS15_g251678;
					float3 temp_output_451_0_g251699 = Model_BitangentWS367_g251677;
					float4 In_MaskM431_g251699 = float4( temp_output_451_0_g251699 , 0.0 );
					half3 Model_TriplanarWeights368_g251677 = Out_TriplanarWeights15_g251678;
					float3 temp_output_445_0_g251699 = Model_TriplanarWeights368_g251677;
					float4 In_MaskN431_g251699 = float4( temp_output_445_0_g251699 , 0.0 );
					BuildTextureData( Data431_g251699 , In_MaskA431_g251699 , In_MaskB431_g251699 , In_MaskC431_g251699 , In_MaskD431_g251699 , In_MaskE431_g251699 , In_MaskF431_g251699 , In_MaskG431_g251699 , In_MaskH431_g251699 , In_MaskI431_g251699 , In_MaskJ431_g251699 , In_MaskK431_g251699 , In_MaskL431_g251699 , In_MaskM431_g251699 , In_MaskN431_g251699 );
					TVEMasksData Data456_g251700 =(TVEMasksData)Data431_g251699;
					float4 Out_MaskA456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskB456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskC456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskD456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskE456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskF456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskG456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskH456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskI456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskJ456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskK456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskL456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskM456_g251700 = float4( 0,0,0,0 );
					float4 Out_MaskN456_g251700 = float4( 0,0,0,0 );
					BreakTextureData( Data456_g251700 , Out_MaskA456_g251700 , Out_MaskB456_g251700 , Out_MaskC456_g251700 , Out_MaskD456_g251700 , Out_MaskE456_g251700 , Out_MaskF456_g251700 , Out_MaskG456_g251700 , Out_MaskH456_g251700 , Out_MaskI456_g251700 , Out_MaskJ456_g251700 , Out_MaskK456_g251700 , Out_MaskL456_g251700 , Out_MaskM456_g251700 , Out_MaskN456_g251700 );
					half2 UV276_g251700 = (Out_MaskA456_g251700).xy;
					float temp_output_504_0_g251700 = 0.0;
					half Bias276_g251700 = temp_output_504_0_g251700;
					half2 Normal276_g251700 = float2( 0,0 );
					half4 localSampleCoord276_g251700 = SampleCoord( Texture276_g251700 , Sampler276_g251700 , UV276_g251700 , Bias276_g251700 , Normal276_g251700 );
					float4 temp_output_407_277_g251677 = localSampleCoord276_g251700;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture502_g251700) = _MainAlbedoTex;
					SamplerState Sampler502_g251700 = staticSwitch36_g251682;
					half2 UV502_g251700 = (Out_MaskA456_g251700).zw;
					half Bias502_g251700 = temp_output_504_0_g251700;
					half2 Normal502_g251700 = float2( 0,0 );
					half4 localSampleCoord502_g251700 = SampleCoord( Texture502_g251700 , Sampler502_g251700 , UV502_g251700 , Bias502_g251700 , Normal502_g251700 );
					float4 temp_output_407_278_g251677 = localSampleCoord502_g251700;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture496_g251700) = _MainAlbedoTex;
					SamplerState Sampler496_g251700 = staticSwitch36_g251682;
					float2 temp_output_463_0_g251700 = (Out_MaskB456_g251700).zw;
					half2 XZ496_g251700 = temp_output_463_0_g251700;
					half Bias496_g251700 = temp_output_504_0_g251700;
					half3 NormalWS512_g251700 = (Out_MaskK456_g251700).xyz;
					half3 NormalWS496_g251700 = NormalWS512_g251700;
					half3 Normal496_g251700 = float3( 0,0,0 );
					half4 localSamplePlanar2D496_g251700 = SamplePlanar2D( Texture496_g251700 , Sampler496_g251700 , XZ496_g251700 , Bias496_g251700 , NormalWS496_g251700 , Normal496_g251700 );
					float4 temp_output_407_0_g251677 = localSamplePlanar2D496_g251700;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture490_g251700) = _MainAlbedoTex;
					SamplerState Sampler490_g251700 = staticSwitch36_g251682;
					float2 temp_output_462_0_g251700 = (Out_MaskB456_g251700).xy;
					half2 ZY490_g251700 = temp_output_462_0_g251700;
					half2 XZ490_g251700 = temp_output_463_0_g251700;
					float2 temp_output_464_0_g251700 = (Out_MaskC456_g251700).xy;
					half2 XY490_g251700 = temp_output_464_0_g251700;
					half Bias490_g251700 = temp_output_504_0_g251700;
					half3 Triplanar522_g251700 = (Out_MaskN456_g251700).xyz;
					half3 Triplanar490_g251700 = Triplanar522_g251700;
					half3 NormalWS490_g251700 = NormalWS512_g251700;
					half3 Normal490_g251700 = float3( 0,0,0 );
					half4 localSamplePlanar3D490_g251700 = SamplePlanar3D( Texture490_g251700 , Sampler490_g251700 , ZY490_g251700 , XZ490_g251700 , XY490_g251700 , Bias490_g251700 , Triplanar490_g251700 , NormalWS490_g251700 , Normal490_g251700 );
					float4 temp_output_407_201_g251677 = localSamplePlanar3D490_g251700;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture498_g251700) = _MainAlbedoTex;
					SamplerState Sampler498_g251700 = staticSwitch36_g251682;
					half2 XZ498_g251700 = temp_output_463_0_g251700;
					float2 temp_output_473_0_g251700 = (Out_MaskE456_g251700).xy;
					half2 XZ_1498_g251700 = temp_output_473_0_g251700;
					float2 temp_output_474_0_g251700 = (Out_MaskE456_g251700).zw;
					half2 XZ_2498_g251700 = temp_output_474_0_g251700;
					float2 temp_output_475_0_g251700 = (Out_MaskF456_g251700).xy;
					half2 XZ_3498_g251700 = temp_output_475_0_g251700;
					float temp_output_510_0_g251700 = exp2( temp_output_504_0_g251700 );
					half Bias498_g251700 = temp_output_510_0_g251700;
					float3 temp_output_480_0_g251700 = (Out_MaskI456_g251700).xyz;
					half3 Weights_2498_g251700 = temp_output_480_0_g251700;
					half3 NormalWS498_g251700 = NormalWS512_g251700;
					half3 Normal498_g251700 = float3( 0,0,0 );
					half4 localSampleStochastic2D498_g251700 = SampleStochastic2D( Texture498_g251700 , Sampler498_g251700 , XZ498_g251700 , XZ_1498_g251700 , XZ_2498_g251700 , XZ_3498_g251700 , Bias498_g251700 , Weights_2498_g251700 , NormalWS498_g251700 , Normal498_g251700 );
					float4 temp_output_407_202_g251677 = localSampleStochastic2D498_g251700;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture500_g251700) = _MainAlbedoTex;
					SamplerState Sampler500_g251700 = staticSwitch36_g251682;
					half2 ZY500_g251700 = temp_output_462_0_g251700;
					half2 ZY_1500_g251700 = (Out_MaskC456_g251700).zw;
					half2 ZY_2500_g251700 = (Out_MaskD456_g251700).xy;
					half2 ZY_3500_g251700 = (Out_MaskD456_g251700).zw;
					half2 XZ500_g251700 = temp_output_463_0_g251700;
					half2 XZ_1500_g251700 = temp_output_473_0_g251700;
					half2 XZ_2500_g251700 = temp_output_474_0_g251700;
					half2 XZ_3500_g251700 = temp_output_475_0_g251700;
					half2 XY500_g251700 = temp_output_464_0_g251700;
					half2 XY_1500_g251700 = (Out_MaskF456_g251700).zw;
					half2 XY_2500_g251700 = (Out_MaskG456_g251700).xy;
					half2 XY_3500_g251700 = (Out_MaskG456_g251700).zw;
					half Bias500_g251700 = temp_output_510_0_g251700;
					half3 Weights_1500_g251700 = (Out_MaskH456_g251700).xyz;
					half3 Weights_2500_g251700 = temp_output_480_0_g251700;
					half3 Weights_3500_g251700 = (Out_MaskJ456_g251700).xyz;
					half3 Triplanar500_g251700 = Triplanar522_g251700;
					half3 NormalWS500_g251700 = NormalWS512_g251700;
					half3 Normal500_g251700 = float3( 0,0,0 );
					half4 localSampleStochastic3D500_g251700 = SampleStochastic3D( Texture500_g251700 , Sampler500_g251700 , ZY500_g251700 , ZY_1500_g251700 , ZY_2500_g251700 , ZY_3500_g251700 , XZ500_g251700 , XZ_1500_g251700 , XZ_2500_g251700 , XZ_3500_g251700 , XY500_g251700 , XY_1500_g251700 , XY_2500_g251700 , XY_3500_g251700 , Bias500_g251700 , Weights_1500_g251700 , Weights_2500_g251700 , Weights_3500_g251700 , Triplanar500_g251700 , NormalWS500_g251700 , Normal500_g251700 );
					float4 temp_output_407_203_g251677 = localSampleStochastic3D500_g251700;
					#if defined( TVE_MAIN_SAMPLE_MAIN_UV )
					float4 staticSwitch184_g251677 = temp_output_407_277_g251677;
					#elif defined( TVE_MAIN_SAMPLE_EXTRA_UV )
					float4 staticSwitch184_g251677 = temp_output_407_278_g251677;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_2D )
					float4 staticSwitch184_g251677 = temp_output_407_0_g251677;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_3D )
					float4 staticSwitch184_g251677 = temp_output_407_201_g251677;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_2D )
					float4 staticSwitch184_g251677 = temp_output_407_202_g251677;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_3D )
					float4 staticSwitch184_g251677 = temp_output_407_203_g251677;
					#else
					float4 staticSwitch184_g251677 = temp_output_407_277_g251677;
					#endif
					half4 Local_AlbedoSample185_g251677 = staticSwitch184_g251677;
					float3 lerpResult53_g251677 = lerp( float3( 1,1,1 ) , (Local_AlbedoSample185_g251677).xyz , _MainAlbedoValue);
					half3 Local_AlbedoRGB107_g251677 = lerpResult53_g251677;
					float temp_output_17_0_g251697 = _MainMultiWriteMode;
					float Option91_g251697 = temp_output_17_0_g251697;
					float4 Model_VertexData418_g251677 = Out_VertexData15_g251678;
					float4 temp_output_84_0_g251697 = Model_VertexData418_g251677;
					float4 ChannelA91_g251697 = temp_output_84_0_g251697;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture276_g251685) = _MainShaderTex;
					#if defined( TVE_FILTER_DEFAULT )
					SamplerState staticSwitch38_g251684 = sampler_Linear_Repeat;
					#elif defined( TVE_FILTER_POINT )
					SamplerState staticSwitch38_g251684 = sampler_Point_Repeat;
					#elif defined( TVE_FILTER_LOW )
					SamplerState staticSwitch38_g251684 = sampler_Linear_Repeat;
					#elif defined( TVE_FILTER_MEDIUM )
					SamplerState staticSwitch38_g251684 = sampler_Linear_Repeat;
					#elif defined( TVE_FILTER_HIGH )
					SamplerState staticSwitch38_g251684 = sampler_Linear_Repeat_Aniso8;
					#else
					SamplerState staticSwitch38_g251684 = sampler_Linear_Repeat;
					#endif
					SamplerState Sampler276_g251685 = staticSwitch38_g251684;
					float localBreakTextureData456_g251685 = ( 0.0 );
					TVEMasksData Data456_g251685 =(TVEMasksData)Data431_g251699;
					float4 Out_MaskA456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskB456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskC456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskD456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskE456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskF456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskG456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskH456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskI456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskJ456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskK456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskL456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskM456_g251685 = float4( 0,0,0,0 );
					float4 Out_MaskN456_g251685 = float4( 0,0,0,0 );
					BreakTextureData( Data456_g251685 , Out_MaskA456_g251685 , Out_MaskB456_g251685 , Out_MaskC456_g251685 , Out_MaskD456_g251685 , Out_MaskE456_g251685 , Out_MaskF456_g251685 , Out_MaskG456_g251685 , Out_MaskH456_g251685 , Out_MaskI456_g251685 , Out_MaskJ456_g251685 , Out_MaskK456_g251685 , Out_MaskL456_g251685 , Out_MaskM456_g251685 , Out_MaskN456_g251685 );
					half2 UV276_g251685 = (Out_MaskA456_g251685).xy;
					float temp_output_504_0_g251685 = 0.0;
					half Bias276_g251685 = temp_output_504_0_g251685;
					half2 Normal276_g251685 = float2( 0,0 );
					half4 localSampleCoord276_g251685 = SampleCoord( Texture276_g251685 , Sampler276_g251685 , UV276_g251685 , Bias276_g251685 , Normal276_g251685 );
					float4 temp_output_405_277_g251677 = localSampleCoord276_g251685;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture502_g251685) = _MainShaderTex;
					SamplerState Sampler502_g251685 = staticSwitch38_g251684;
					half2 UV502_g251685 = (Out_MaskA456_g251685).zw;
					half Bias502_g251685 = temp_output_504_0_g251685;
					half2 Normal502_g251685 = float2( 0,0 );
					half4 localSampleCoord502_g251685 = SampleCoord( Texture502_g251685 , Sampler502_g251685 , UV502_g251685 , Bias502_g251685 , Normal502_g251685 );
					float4 temp_output_405_278_g251677 = localSampleCoord502_g251685;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture496_g251685) = _MainShaderTex;
					SamplerState Sampler496_g251685 = staticSwitch38_g251684;
					float2 temp_output_463_0_g251685 = (Out_MaskB456_g251685).zw;
					half2 XZ496_g251685 = temp_output_463_0_g251685;
					half Bias496_g251685 = temp_output_504_0_g251685;
					half3 NormalWS512_g251685 = (Out_MaskK456_g251685).xyz;
					half3 NormalWS496_g251685 = NormalWS512_g251685;
					half3 Normal496_g251685 = float3( 0,0,0 );
					half4 localSamplePlanar2D496_g251685 = SamplePlanar2D( Texture496_g251685 , Sampler496_g251685 , XZ496_g251685 , Bias496_g251685 , NormalWS496_g251685 , Normal496_g251685 );
					float4 temp_output_405_0_g251677 = localSamplePlanar2D496_g251685;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture490_g251685) = _MainShaderTex;
					SamplerState Sampler490_g251685 = staticSwitch38_g251684;
					float2 temp_output_462_0_g251685 = (Out_MaskB456_g251685).xy;
					half2 ZY490_g251685 = temp_output_462_0_g251685;
					half2 XZ490_g251685 = temp_output_463_0_g251685;
					float2 temp_output_464_0_g251685 = (Out_MaskC456_g251685).xy;
					half2 XY490_g251685 = temp_output_464_0_g251685;
					half Bias490_g251685 = temp_output_504_0_g251685;
					half3 Triplanar522_g251685 = (Out_MaskN456_g251685).xyz;
					half3 Triplanar490_g251685 = Triplanar522_g251685;
					half3 NormalWS490_g251685 = NormalWS512_g251685;
					half3 Normal490_g251685 = float3( 0,0,0 );
					half4 localSamplePlanar3D490_g251685 = SamplePlanar3D( Texture490_g251685 , Sampler490_g251685 , ZY490_g251685 , XZ490_g251685 , XY490_g251685 , Bias490_g251685 , Triplanar490_g251685 , NormalWS490_g251685 , Normal490_g251685 );
					float4 temp_output_405_201_g251677 = localSamplePlanar3D490_g251685;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture498_g251685) = _MainShaderTex;
					SamplerState Sampler498_g251685 = staticSwitch38_g251684;
					half2 XZ498_g251685 = temp_output_463_0_g251685;
					float2 temp_output_473_0_g251685 = (Out_MaskE456_g251685).xy;
					half2 XZ_1498_g251685 = temp_output_473_0_g251685;
					float2 temp_output_474_0_g251685 = (Out_MaskE456_g251685).zw;
					half2 XZ_2498_g251685 = temp_output_474_0_g251685;
					float2 temp_output_475_0_g251685 = (Out_MaskF456_g251685).xy;
					half2 XZ_3498_g251685 = temp_output_475_0_g251685;
					float temp_output_510_0_g251685 = exp2( temp_output_504_0_g251685 );
					half Bias498_g251685 = temp_output_510_0_g251685;
					float3 temp_output_480_0_g251685 = (Out_MaskI456_g251685).xyz;
					half3 Weights_2498_g251685 = temp_output_480_0_g251685;
					half3 NormalWS498_g251685 = NormalWS512_g251685;
					half3 Normal498_g251685 = float3( 0,0,0 );
					half4 localSampleStochastic2D498_g251685 = SampleStochastic2D( Texture498_g251685 , Sampler498_g251685 , XZ498_g251685 , XZ_1498_g251685 , XZ_2498_g251685 , XZ_3498_g251685 , Bias498_g251685 , Weights_2498_g251685 , NormalWS498_g251685 , Normal498_g251685 );
					float4 temp_output_405_202_g251677 = localSampleStochastic2D498_g251685;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture500_g251685) = _MainShaderTex;
					SamplerState Sampler500_g251685 = staticSwitch38_g251684;
					half2 ZY500_g251685 = temp_output_462_0_g251685;
					half2 ZY_1500_g251685 = (Out_MaskC456_g251685).zw;
					half2 ZY_2500_g251685 = (Out_MaskD456_g251685).xy;
					half2 ZY_3500_g251685 = (Out_MaskD456_g251685).zw;
					half2 XZ500_g251685 = temp_output_463_0_g251685;
					half2 XZ_1500_g251685 = temp_output_473_0_g251685;
					half2 XZ_2500_g251685 = temp_output_474_0_g251685;
					half2 XZ_3500_g251685 = temp_output_475_0_g251685;
					half2 XY500_g251685 = temp_output_464_0_g251685;
					half2 XY_1500_g251685 = (Out_MaskF456_g251685).zw;
					half2 XY_2500_g251685 = (Out_MaskG456_g251685).xy;
					half2 XY_3500_g251685 = (Out_MaskG456_g251685).zw;
					half Bias500_g251685 = temp_output_510_0_g251685;
					half3 Weights_1500_g251685 = (Out_MaskH456_g251685).xyz;
					half3 Weights_2500_g251685 = temp_output_480_0_g251685;
					half3 Weights_3500_g251685 = (Out_MaskJ456_g251685).xyz;
					half3 Triplanar500_g251685 = Triplanar522_g251685;
					half3 NormalWS500_g251685 = NormalWS512_g251685;
					half3 Normal500_g251685 = float3( 0,0,0 );
					half4 localSampleStochastic3D500_g251685 = SampleStochastic3D( Texture500_g251685 , Sampler500_g251685 , ZY500_g251685 , ZY_1500_g251685 , ZY_2500_g251685 , ZY_3500_g251685 , XZ500_g251685 , XZ_1500_g251685 , XZ_2500_g251685 , XZ_3500_g251685 , XY500_g251685 , XY_1500_g251685 , XY_2500_g251685 , XY_3500_g251685 , Bias500_g251685 , Weights_1500_g251685 , Weights_2500_g251685 , Weights_3500_g251685 , Triplanar500_g251685 , NormalWS500_g251685 , Normal500_g251685 );
					float4 temp_output_405_203_g251677 = localSampleStochastic3D500_g251685;
					#if defined( TVE_MAIN_SAMPLE_MAIN_UV )
					float4 staticSwitch198_g251677 = temp_output_405_277_g251677;
					#elif defined( TVE_MAIN_SAMPLE_EXTRA_UV )
					float4 staticSwitch198_g251677 = temp_output_405_278_g251677;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_2D )
					float4 staticSwitch198_g251677 = temp_output_405_0_g251677;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_3D )
					float4 staticSwitch198_g251677 = temp_output_405_201_g251677;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_2D )
					float4 staticSwitch198_g251677 = temp_output_405_202_g251677;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_3D )
					float4 staticSwitch198_g251677 = temp_output_405_203_g251677;
					#else
					float4 staticSwitch198_g251677 = temp_output_405_277_g251677;
					#endif
					half4 Local_ShaderSample199_g251677 = staticSwitch198_g251677;
					float2 appendResult428_g251677 = (float2((Local_AlbedoSample185_g251677).w , (Local_ShaderSample199_g251677).z));
					float2 temp_output_85_0_g251697 = appendResult428_g251677;
					float4 ChannelB91_g251697 = float4( temp_output_85_0_g251697, 0.0 , 0.0 );
					float localSwitchChannel691_g251697 = SwitchChannel6( Option91_g251697 , ChannelA91_g251697 , ChannelB91_g251697 );
					float clampResult17_g251695 = clamp( localSwitchChannel691_g251697 , 0.0001 , 0.9999 );
					float temp_output_7_0_g251696 = _MainMultiWriteRemap.x;
					float temp_output_9_0_g251696 = ( clampResult17_g251695 - temp_output_7_0_g251696 );
					half Local_MultiMask78_g251677 = saturate( ( temp_output_9_0_g251696 * _MainMultiWriteRemap.z ) );
					float lerpResult58_g251677 = lerp( 1.0 , Local_MultiMask78_g251677 , _MainColorMode);
					float4 lerpResult62_g251677 = lerp( _MainColorTwo , _MainColor , lerpResult58_g251677);
					half3 Local_ColorRGB93_g251677 = (lerpResult62_g251677).rgb;
					half3 Local_Albedo139_g251677 = ( Local_AlbedoRGB107_g251677 * Local_ColorRGB93_g251677 );
					float3 temp_output_4_0_g251679 = Local_Albedo139_g251677;
					float3 In_Albedo3_g251679 = temp_output_4_0_g251679;
					float3 temp_output_44_0_g251679 = Local_Albedo139_g251677;
					float3 In_AlbedoBase3_g251679 = temp_output_44_0_g251679;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture276_g251706) = _MainNormalTex;
					#if defined( TVE_FILTER_DEFAULT )
					SamplerState staticSwitch37_g251683 = sampler_Linear_Repeat;
					#elif defined( TVE_FILTER_POINT )
					SamplerState staticSwitch37_g251683 = sampler_Point_Repeat;
					#elif defined( TVE_FILTER_LOW )
					SamplerState staticSwitch37_g251683 = sampler_Linear_Repeat;
					#elif defined( TVE_FILTER_MEDIUM )
					SamplerState staticSwitch37_g251683 = sampler_Linear_Repeat_Aniso8;
					#elif defined( TVE_FILTER_HIGH )
					SamplerState staticSwitch37_g251683 = sampler_Linear_Repeat_Aniso8;
					#else
					SamplerState staticSwitch37_g251683 = sampler_Linear_Repeat;
					#endif
					SamplerState Sampler276_g251706 = staticSwitch37_g251683;
					float localBreakTextureData456_g251706 = ( 0.0 );
					TVEMasksData Data456_g251706 =(TVEMasksData)Data431_g251699;
					float4 Out_MaskA456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskB456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskC456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskD456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskE456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskF456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskG456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskH456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskI456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskJ456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskK456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskL456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskM456_g251706 = float4( 0,0,0,0 );
					float4 Out_MaskN456_g251706 = float4( 0,0,0,0 );
					BreakTextureData( Data456_g251706 , Out_MaskA456_g251706 , Out_MaskB456_g251706 , Out_MaskC456_g251706 , Out_MaskD456_g251706 , Out_MaskE456_g251706 , Out_MaskF456_g251706 , Out_MaskG456_g251706 , Out_MaskH456_g251706 , Out_MaskI456_g251706 , Out_MaskJ456_g251706 , Out_MaskK456_g251706 , Out_MaskL456_g251706 , Out_MaskM456_g251706 , Out_MaskN456_g251706 );
					half2 UV276_g251706 = (Out_MaskA456_g251706).xy;
					float temp_output_504_0_g251706 = 0.0;
					half Bias276_g251706 = temp_output_504_0_g251706;
					half2 Normal276_g251706 = float2( 0,0 );
					half4 localSampleCoord276_g251706 = SampleCoord( Texture276_g251706 , Sampler276_g251706 , UV276_g251706 , Bias276_g251706 , Normal276_g251706 );
					float2 temp_output_406_394_g251677 = Normal276_g251706;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture502_g251706) = _MainNormalTex;
					SamplerState Sampler502_g251706 = staticSwitch37_g251683;
					half2 UV502_g251706 = (Out_MaskA456_g251706).zw;
					half Bias502_g251706 = temp_output_504_0_g251706;
					half2 Normal502_g251706 = float2( 0,0 );
					half4 localSampleCoord502_g251706 = SampleCoord( Texture502_g251706 , Sampler502_g251706 , UV502_g251706 , Bias502_g251706 , Normal502_g251706 );
					float2 temp_output_406_397_g251677 = Normal502_g251706;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture496_g251706) = _MainNormalTex;
					SamplerState Sampler496_g251706 = staticSwitch37_g251683;
					float2 temp_output_463_0_g251706 = (Out_MaskB456_g251706).zw;
					half2 XZ496_g251706 = temp_output_463_0_g251706;
					half Bias496_g251706 = temp_output_504_0_g251706;
					half3 NormalWS512_g251706 = (Out_MaskK456_g251706).xyz;
					half3 NormalWS496_g251706 = NormalWS512_g251706;
					half3 Normal496_g251706 = float3( 0,0,0 );
					half4 localSamplePlanar2D496_g251706 = SamplePlanar2D( Texture496_g251706 , Sampler496_g251706 , XZ496_g251706 , Bias496_g251706 , NormalWS496_g251706 , Normal496_g251706 );
					float3 temp_output_35_0_g251709 = Normal496_g251706;
					half3 TangentWS519_g251706 = (Out_MaskL456_g251706).xyz;
					float dotResult84_g251709 = dot( temp_output_35_0_g251709 , TangentWS519_g251706 );
					half3 BitangentWS521_g251706 = (Out_MaskM456_g251706).xyz;
					float dotResult85_g251709 = dot( temp_output_35_0_g251709 , BitangentWS521_g251706 );
					float2 appendResult87_g251709 = (float2(dotResult84_g251709 , dotResult85_g251709));
					float2 temp_output_406_375_g251677 = appendResult87_g251709;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture490_g251706) = _MainNormalTex;
					SamplerState Sampler490_g251706 = staticSwitch37_g251683;
					float2 temp_output_462_0_g251706 = (Out_MaskB456_g251706).xy;
					half2 ZY490_g251706 = temp_output_462_0_g251706;
					half2 XZ490_g251706 = temp_output_463_0_g251706;
					float2 temp_output_464_0_g251706 = (Out_MaskC456_g251706).xy;
					half2 XY490_g251706 = temp_output_464_0_g251706;
					half Bias490_g251706 = temp_output_504_0_g251706;
					half3 Triplanar522_g251706 = (Out_MaskN456_g251706).xyz;
					half3 Triplanar490_g251706 = Triplanar522_g251706;
					half3 NormalWS490_g251706 = NormalWS512_g251706;
					half3 Normal490_g251706 = float3( 0,0,0 );
					half4 localSamplePlanar3D490_g251706 = SamplePlanar3D( Texture490_g251706 , Sampler490_g251706 , ZY490_g251706 , XZ490_g251706 , XY490_g251706 , Bias490_g251706 , Triplanar490_g251706 , NormalWS490_g251706 , Normal490_g251706 );
					float3 temp_output_35_0_g251710 = Normal490_g251706;
					float dotResult84_g251710 = dot( temp_output_35_0_g251710 , TangentWS519_g251706 );
					float dotResult85_g251710 = dot( temp_output_35_0_g251710 , BitangentWS521_g251706 );
					float2 appendResult87_g251710 = (float2(dotResult84_g251710 , dotResult85_g251710));
					float2 temp_output_406_353_g251677 = appendResult87_g251710;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture498_g251706) = _MainNormalTex;
					SamplerState Sampler498_g251706 = staticSwitch37_g251683;
					half2 XZ498_g251706 = temp_output_463_0_g251706;
					float2 temp_output_473_0_g251706 = (Out_MaskE456_g251706).xy;
					half2 XZ_1498_g251706 = temp_output_473_0_g251706;
					float2 temp_output_474_0_g251706 = (Out_MaskE456_g251706).zw;
					half2 XZ_2498_g251706 = temp_output_474_0_g251706;
					float2 temp_output_475_0_g251706 = (Out_MaskF456_g251706).xy;
					half2 XZ_3498_g251706 = temp_output_475_0_g251706;
					float temp_output_510_0_g251706 = exp2( temp_output_504_0_g251706 );
					half Bias498_g251706 = temp_output_510_0_g251706;
					float3 temp_output_480_0_g251706 = (Out_MaskI456_g251706).xyz;
					half3 Weights_2498_g251706 = temp_output_480_0_g251706;
					half3 NormalWS498_g251706 = NormalWS512_g251706;
					half3 Normal498_g251706 = float3( 0,0,0 );
					half4 localSampleStochastic2D498_g251706 = SampleStochastic2D( Texture498_g251706 , Sampler498_g251706 , XZ498_g251706 , XZ_1498_g251706 , XZ_2498_g251706 , XZ_3498_g251706 , Bias498_g251706 , Weights_2498_g251706 , NormalWS498_g251706 , Normal498_g251706 );
					float3 temp_output_35_0_g251711 = Normal498_g251706;
					float dotResult84_g251711 = dot( temp_output_35_0_g251711 , TangentWS519_g251706 );
					float dotResult85_g251711 = dot( temp_output_35_0_g251711 , BitangentWS521_g251706 );
					float2 appendResult87_g251711 = (float2(dotResult84_g251711 , dotResult85_g251711));
					float2 temp_output_406_391_g251677 = appendResult87_g251711;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture500_g251706) = _MainNormalTex;
					SamplerState Sampler500_g251706 = staticSwitch37_g251683;
					half2 ZY500_g251706 = temp_output_462_0_g251706;
					half2 ZY_1500_g251706 = (Out_MaskC456_g251706).zw;
					half2 ZY_2500_g251706 = (Out_MaskD456_g251706).xy;
					half2 ZY_3500_g251706 = (Out_MaskD456_g251706).zw;
					half2 XZ500_g251706 = temp_output_463_0_g251706;
					half2 XZ_1500_g251706 = temp_output_473_0_g251706;
					half2 XZ_2500_g251706 = temp_output_474_0_g251706;
					half2 XZ_3500_g251706 = temp_output_475_0_g251706;
					half2 XY500_g251706 = temp_output_464_0_g251706;
					half2 XY_1500_g251706 = (Out_MaskF456_g251706).zw;
					half2 XY_2500_g251706 = (Out_MaskG456_g251706).xy;
					half2 XY_3500_g251706 = (Out_MaskG456_g251706).zw;
					half Bias500_g251706 = temp_output_510_0_g251706;
					half3 Weights_1500_g251706 = (Out_MaskH456_g251706).xyz;
					half3 Weights_2500_g251706 = temp_output_480_0_g251706;
					half3 Weights_3500_g251706 = (Out_MaskJ456_g251706).xyz;
					half3 Triplanar500_g251706 = Triplanar522_g251706;
					half3 NormalWS500_g251706 = NormalWS512_g251706;
					half3 Normal500_g251706 = float3( 0,0,0 );
					half4 localSampleStochastic3D500_g251706 = SampleStochastic3D( Texture500_g251706 , Sampler500_g251706 , ZY500_g251706 , ZY_1500_g251706 , ZY_2500_g251706 , ZY_3500_g251706 , XZ500_g251706 , XZ_1500_g251706 , XZ_2500_g251706 , XZ_3500_g251706 , XY500_g251706 , XY_1500_g251706 , XY_2500_g251706 , XY_3500_g251706 , Bias500_g251706 , Weights_1500_g251706 , Weights_2500_g251706 , Weights_3500_g251706 , Triplanar500_g251706 , NormalWS500_g251706 , Normal500_g251706 );
					float3 temp_output_35_0_g251707 = Normal500_g251706;
					float dotResult84_g251707 = dot( temp_output_35_0_g251707 , TangentWS519_g251706 );
					float dotResult85_g251707 = dot( temp_output_35_0_g251707 , BitangentWS521_g251706 );
					float2 appendResult87_g251707 = (float2(dotResult84_g251707 , dotResult85_g251707));
					float2 temp_output_406_390_g251677 = appendResult87_g251707;
					#if defined( TVE_MAIN_SAMPLE_MAIN_UV )
					float2 staticSwitch193_g251677 = temp_output_406_394_g251677;
					#elif defined( TVE_MAIN_SAMPLE_EXTRA_UV )
					float2 staticSwitch193_g251677 = temp_output_406_397_g251677;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_2D )
					float2 staticSwitch193_g251677 = temp_output_406_375_g251677;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_3D )
					float2 staticSwitch193_g251677 = temp_output_406_353_g251677;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_2D )
					float2 staticSwitch193_g251677 = temp_output_406_391_g251677;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_3D )
					float2 staticSwitch193_g251677 = temp_output_406_390_g251677;
					#else
					float2 staticSwitch193_g251677 = temp_output_406_394_g251677;
					#endif
					half2 Local_NormaSample191_g251677 = staticSwitch193_g251677;
					half2 Local_NormalTS108_g251677 = ( Local_NormaSample191_g251677 * _MainNormalValue );
					float2 In_NormalTS3_g251679 = Local_NormalTS108_g251677;
					float2 break80_g251698 = Local_NormalTS108_g251677;
					float3 temp_output_77_0_g251698 = Model_TangentWS366_g251677;
					float3 temp_output_78_0_g251698 = Model_BitangentWS367_g251677;
					float3 temp_output_76_0_g251698 = Model_NormalWS226_g251677;
					half3 Local_NormalWS250_g251677 = ( ( break80_g251698.x * temp_output_77_0_g251698 ) + ( break80_g251698.y * temp_output_78_0_g251698 ) + temp_output_76_0_g251698 );
					float3 In_NormalWS3_g251679 = Local_NormalWS250_g251677;
					float temp_output_209_0_g251677 = (Local_ShaderSample199_g251677).y;
					float temp_output_7_0_g251691 = _MainOcclusionRemap.x;
					float temp_output_9_0_g251691 = ( temp_output_209_0_g251677 - temp_output_7_0_g251691 );
					float lerpResult23_g251677 = lerp( 1.0 , saturate( ( temp_output_9_0_g251691 * _MainOcclusionRemap.z ) ) , _MainOcclusionValue);
					half Local_Occlusion313_g251677 = lerpResult23_g251677;
					float temp_output_213_0_g251677 = (Local_ShaderSample199_g251677).w;
					float temp_output_7_0_g251694 = _MainSmoothnessRemap.x;
					float temp_output_9_0_g251694 = ( temp_output_213_0_g251677 - temp_output_7_0_g251694 );
					half Local_Smoothness317_g251677 = ( saturate( ( temp_output_9_0_g251694 * _MainSmoothnessRemap.z ) ) * _MainSmoothnessValue );
					float4 appendResult73_g251677 = (float4(( (Local_ShaderSample199_g251677).x * _MainMetallicValue ) , Local_Occlusion313_g251677 , (Local_ShaderSample199_g251677).z , Local_Smoothness317_g251677));
					half4 Local_Masks109_g251677 = appendResult73_g251677;
					float4 In_Shader3_g251679 = Local_Masks109_g251677;
					float4 In_Feature3_g251679 = half4( 1, 1, 1, 1 );
					float4 In_Season3_g251679 = half4( 1, 1, 1, 1 );
					float4 In_Emissive3_g251679 = half4( 1, 1, 1, 1 );
					float3 temp_output_3_0_g251712 = Local_Albedo139_g251677;
					float dotResult20_g251712 = dot( temp_output_3_0_g251712 , float3( 0.2126, 0.7152, 0.0722 ) );
					half Local_Grayscale110_g251677 = dotResult20_g251712;
					float temp_output_12_0_g251679 = Local_Grayscale110_g251677;
					float In_Grayscale3_g251679 = temp_output_12_0_g251679;
					float temp_output_3_0_g251713 = Local_Grayscale110_g251677;
					float clampResult27_g251713 = clamp( saturate( ( temp_output_3_0_g251713 * 5.0 ) ) , 0.2 , 1.0 );
					half Local_Luminosity145_g251677 = clampResult27_g251713;
					float temp_output_16_0_g251679 = Local_Luminosity145_g251677;
					float In_Luminosity3_g251679 = temp_output_16_0_g251679;
					float In_MultiMask3_g251679 = Local_MultiMask78_g251677;
					float temp_output_187_0_g251677 = (Local_AlbedoSample185_g251677).w;
					#ifdef TVE_CLIPPING
					float staticSwitch236_g251677 = ( temp_output_187_0_g251677 - _MainAlphaClipValue );
					#else
					float staticSwitch236_g251677 = temp_output_187_0_g251677;
					#endif
					half Local_AlphaClip111_g251677 = staticSwitch236_g251677;
					float In_AlphaClip3_g251679 = Local_AlphaClip111_g251677;
					half Local_AlphaFade246_g251677 = (lerpResult62_g251677).a;
					float In_AlphaFade3_g251679 = Local_AlphaFade246_g251677;
					float3 temp_cast_43 = (1.0).xxx;
					float3 In_Translucency3_g251679 = temp_cast_43;
					float In_Transmission3_g251679 = 1.0;
					float In_Thickness3_g251679 = 0.0;
					float In_Diffusion3_g251679 = 0.0;
					float In_Depth3_g251679 = 0.0;
					BuildVisualData( Data3_g251679 , In_Dummy3_g251679 , In_Albedo3_g251679 , In_AlbedoBase3_g251679 , In_NormalTS3_g251679 , In_NormalWS3_g251679 , In_Shader3_g251679 , In_Feature3_g251679 , In_Season3_g251679 , In_Emissive3_g251679 , In_Grayscale3_g251679 , In_Luminosity3_g251679 , In_MultiMask3_g251679 , In_AlphaClip3_g251679 , In_AlphaFade3_g251679 , In_Translucency3_g251679 , In_Transmission3_g251679 , In_Thickness3_g251679 , In_Diffusion3_g251679 , In_Depth3_g251679 );
					TVEVisualData Data4_g251920 =(TVEVisualData)Data3_g251679;
					float Out_Dummy4_g251920 = 0.0;
					float3 Out_Albedo4_g251920 = float3( 0,0,0 );
					float3 Out_AlbedoBase4_g251920 = float3( 0,0,0 );
					float2 Out_NormalTS4_g251920 = float2( 0,0 );
					float3 Out_NormalWS4_g251920 = float3( 0,0,0 );
					float4 Out_Shader4_g251920 = float4( 0,0,0,0 );
					float4 Out_Feature4_g251920 = float4( 0,0,0,0 );
					float4 Out_Season4_g251920 = float4( 0,0,0,0 );
					float4 Out_Emissive4_g251920 = float4( 0,0,0,0 );
					float Out_MultiMask4_g251920 = 0.0;
					float Out_Grayscale4_g251920 = 0.0;
					float Out_Luminosity4_g251920 = 0.0;
					float Out_AlphaClip4_g251920 = 0.0;
					float Out_AlphaFade4_g251920 = 0.0;
					float3 Out_Translucency4_g251920 = float3( 0,0,0 );
					float Out_Transmission4_g251920 = 0.0;
					float Out_Thickness4_g251920 = 0.0;
					float Out_Diffusion4_g251920 = 0.0;
					float Out_Depth4_g251920 = 0.0;
					BreakVisualData( Data4_g251920 , Out_Dummy4_g251920 , Out_Albedo4_g251920 , Out_AlbedoBase4_g251920 , Out_NormalTS4_g251920 , Out_NormalWS4_g251920 , Out_Shader4_g251920 , Out_Feature4_g251920 , Out_Season4_g251920 , Out_Emissive4_g251920 , Out_MultiMask4_g251920 , Out_Grayscale4_g251920 , Out_Luminosity4_g251920 , Out_AlphaClip4_g251920 , Out_AlphaFade4_g251920 , Out_Translucency4_g251920 , Out_Transmission4_g251920 , Out_Thickness4_g251920 , Out_Diffusion4_g251920 , Out_Depth4_g251920 );
					float Alpha109_g251915 = Out_AlphaClip4_g251920;
					float lerpResult91_g251915 = lerp( 1.0 , Alpha109_g251915 , ( TVE_DEBUG_Clip * _RenderClip ));
					float lerpResult154_g251915 = lerp( 1.0 , lerpResult91_g251915 , Filter152_g251915);
					clip( lerpResult154_g251915 );
					...
					o.Emission = ( lerpResult72_g251915 * lerpResult84_g251915 );
					o.Alpha = 1;
					half3 BakedGI = 0;
		...
		Pass
		{
			...
			CGPROGRAM
				...
				v2f VertexFunction (appdata v  ) {
					...
					o.ase_texcoord4.xyz = vertexToFrag73_g242429;
					o.ase_texcoord5.xyz = vertexToFrag76_g242429;
					float3 vertexPos57_g251915 = v.vertex.xyz;
					float4 ase_positionCS57_g251915 = UnityObjectToClipPos( vertexPos57_g251915 );
					o.ase_texcoord7 = ase_positionCS57_g251915;
					TVEVertexData Data1902_g251673 = Data16_g251583;
					float4 Out_Interpolator1902_g251673 = float4( 0,0,0,0 );
					{
					Out_Interpolator1902_g251673 = Data1902_g251673.Interpolator;
					...
					float4 vertexToFrag1901_g251673 = Out_Interpolator1902_g251673;
					o.ase_texcoord8 = vertexToFrag1901_g251673;
				...
				)
				{
					...
					TVEModelData Data16_g242437 =(TVEModelData)0;
					float In_Dummy16_g242437 = 0.0;
					float3 vertexToFrag73_g242429 = IN.ase_texcoord4.xyz;
					float3 PositionWS122_g242429 = vertexToFrag73_g242429;
					float3 In_PositionWS16_g242437 = PositionWS122_g242429;
					float3 vertexToFrag76_g242429 = IN.ase_texcoord5.xyz;
					float3 PivotWS121_g242429 = vertexToFrag76_g242429;
					#ifdef TVE_SCOPE_DYNAMIC
					float3 staticSwitch204_g242429 = ( PositionWS122_g242429 - PivotWS121_g242429 );
					#else
					...
					half3 ViewDirWS169_g242429 = normalizeResult296_g242429;
					float3 In_ViewDirWS16_g242437 = ViewDirWS169_g242429;
					float4 appendResult397_g242429 = (float4(IN.ase_texcoord6.xy , IN.ase_texcoord6.zw));
					float4 CoordsData398_g242429 = appendResult397_g242429;
					float4 In_CoordsData16_g242437 = CoordsData398_g242429;
					half4 VertexMasks171_g242429 = IN.ase_color;
					float4 In_VertexData16_g242437 = VertexMasks171_g242429;
					...
					half3 ViewDirWS169_g242409 = normalizeResult296_g242409;
					float3 In_ViewDirWS16_g242417 = ViewDirWS169_g242409;
					float4 appendResult397_g242409 = (float4(IN.ase_texcoord6.xy , IN.ase_texcoord6.zw));
					float4 CoordsData398_g242409 = appendResult397_g242409;
					float4 In_CoordsData16_g242417 = CoordsData398_g242409;
					half4 VertexMasks171_g242409 = float4( 0,0,0,0 );
					float4 In_VertexData16_g242417 = VertexMasks171_g242409;
					...
					float temp_output_65_0_g251915 = ( 1.0 - saturate( dotResult61_g251915 ) );
					float Shading_Fresnel59_g251915 = (( 1.0 - ( temp_output_65_0_g251915 * temp_output_65_0_g251915 ) )*0.3 + 0.7);
					float4 ase_positionCS57_g251915 = IN.ase_texcoord7;
					float depthLinearEye57_g251915 = LinearEyeDepth( ase_positionCS57_g251915.z / ase_positionCS57_g251915.w );
					float temp_output_69_0_g251915 = saturate(  (0.0 + ( depthLinearEye57_g251915 - 300.0 ) * ( 1.0 - 0.0 ) / ( 0.0 - 300.0 ) ) );
					float Shading_Distance58_g251915 = (( temp_output_69_0_g251915 * temp_output_69_0_g251915 )*0.5 + 0.5);
					float lerpResult84_g251915 = lerp( 1.0 , Shading_Fresnel59_g251915 , ( Shading_Distance58_g251915 * TVE_DEBUG_Shading ));
					...
					float4 In_CoordsData16_g251676 = Out_CoordsData15_g251675;
					float4 In_VertexData16_g251676 = Out_VertexData15_g251675;
					float4 vertexToFrag1901_g251673 = IN.ase_texcoord8;
					float4 In_Interpolator16_g251676 = vertexToFrag1901_g251673;
					BuildModelFragData( Data16_g251676 , In_Dummy16_g251676 , In_PositionWS16_g251676 , In_PositionWO16_g251676 , In_PivotWS16_g251676 , In_PivotWO16_g251676 , In_NormalWS16_g251676 , In_TangentWS16_g251676 , In_BitangentWS16_g251676 , In_TriplanarWeights16_g251676 , In_ViewDirWS16_g251676 , In_CoordsData16_g251676 , In_VertexData16_g251676 , In_Interpolator16_g251676 );
					TVEModelData Data15_g251678 =(TVEModelData)Data16_g251676;
					float Out_Dummy15_g251678 = 0.0;
...
/*ASEBEGIN
Version=19912
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":2631,"pos":[-7296,-5376],"params":["Inherit","False","Property","_IsShaderType","_IsShaderType","40","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2634,"pos":[-7296,-4992],"params":["Inherit","False","Block Model","27","","242429","7ad7765e793a6714babedee0033c36e9","19,463,1,289,1,240,1,437,1,291,1,431,1,404,1,290,1,181,0,183,0,185,0,184,0,188,0,190,0,192,0,189,0,300,0,419,0,193,0","11","102","FLOAT3","0,0,0","False","163","FLOAT3","0,0,0","False","186","FLOAT3","0,0,0","False","187","FLOAT3","0,0,0","False","166","FLOAT3","0,0,0","False","164","FLOAT3","0,0,0","False","301","FLOAT3","0,0,0","False","418","FLOAT3","0,0,0","False","167","FLOAT4","0,0,0,0","False","172","FLOAT4","0,0,0,0","False","175","FLOAT4","0,0,0,0","False","2","OBJECT","128","OBJECT","314"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2375,"pos":[-5888,-4992],"params":["Inherit","False","Block Global","41","","242450","212e17d4006dc88449d56ce0340cb5ff","46,385,1,692,1,667,1,276,1,396,1,417,1,282,1,402,1,560,1,285,1,283,1,308,1,650,1,483,0,484,0,486,0,488,0,561,0,487,0,652,0,482,0,485,0,668,0,691,0,315,1,703,1,719,1,716,1,715,1,709,1,710,1,706,1,701,1,704,1,707,1,655,0,311,1,317,1,421,1,321,1,398,1,700,0,694,1,713,1,404,1,675,0","1","206","OBJECT","0,0,0,0","False","1","OBJECT","151"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2606,"pos":[-4096,-4992],"params":["Inherit","False","Block Blanket Conform","146","","251558","3ce1684c4351aeb42b79a955aa483301","2,389,0,377,1","3","146","OBJECT","0,0,0,0","False","397","OBJECT","0,0,0,0","False","186","OBJECT","0,0,0,0","False","3","OBJECT","128","OBJECT","398","OBJECT","399"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2658,"pos":[-2304,-4992],"params":["Inherit","False","Block Visual","-1","","251673","9511980f05dcfdf4d8967cd55c0d1784","1,1910,1","3","1904","OBJECT","0,0,0,0","False","1894","OBJECT","0,0,0,0","False","1896","OBJECT","0,0,0,0","False","3","OBJECT","1900","OBJECT","1895","OBJECT","1897"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2380,"pos":[-1920,-4992],"params":["Inherit","False","Block Main","120","","251677","b04cfed9a7b4c0841afdb49a38c282c5","13,65,1,136,1,41,1,133,1,40,1,344,0,347,0,342,0,346,0,343,0,345,0,329,1,408,1","3","430","OBJECT","0,0,0,0","False","225","OBJECT","0,0,0,0","False","414","OBJECT","0,0,0,0","False","3","OBJECT","106","OBJECT","417","OBJECT","415"]}
...
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2653,"pos":[-896,-4992],"params":["Inherit","False","2454","Visual Data","1","0","OBJECT","","False","1","OBJECT","0"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2669,"pos":[-640,-4992],"params":["Inherit","False","Block Blanket Combine","7","","251888","53fb3d4258ea82249a03b2e86f740373","6,1386,0,1326,0,1368,0,1374,0,1318,1,1476,0","3","585","OBJECT","0,0,0,0","False","1199","OBJECT","0,0,0,0","False","971","OBJECT","0,0,0,0","False","4","OBJECT","552","OBJECT","1290","OBJECT","1277","OBJECT","1512"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2509,"pos":[-256,-4992],"params":["Inherit","False","Break Masks Data","-1","","251908","23311522ecc97b54e8b77d849401069d","0","1","6","OBJECT","0","False","8","FLOAT4","14","FLOAT4","0","FLOAT4","23","FLOAT4","5","FLOAT4","24","FLOAT4","25","FLOAT4","26","FLOAT4","27"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2551,"pos":[512,-4992],"params":["Inherit","False","Tool Debug Active","22","","251909","0bb5baa3fd5a859489bbfc09acf77496","0","2","80","FLOAT3","0,0,0","False","102","FLOAT","0","False","2","FLOAT3","108","FLOAT3","0"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2585,"pos":[1152,-4480],"params":["Inherit","False","Tool Debug Index","-1","","251911","db6ad3771e2815f4e84bed76b862e261","0","2","39","FLOAT3","0,0,0","False","36","FLOAT","4","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2594,"pos":[1152,-4992],"params":["Inherit","False","Tool Debug Index","-1","","251912","db6ad3771e2815f4e84bed76b862e261","0","2","39","FLOAT3","0,0,0","False","36","FLOAT","0","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2586,"pos":[1152,-4736],"params":["Inherit","False","Tool Debug Index","-1","","251913","db6ad3771e2815f4e84bed76b862e261","0","2","39","FLOAT3","0,0,0","False","36","FLOAT","2","False","1","FLOAT3","0"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2203,"pos":[3456,-5120],"params":["Inherit","False","Base Compile","-1","","251914","e67c8238031dbf04ab79a5d4d63d1b4f","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2609,"pos":[3072,-4992],"params":["Inherit","False","Tool Debug Color","0","","251915","d992d3ed4a7539141ba053d3e0c12277","0","3","80","FLOAT3","0,0,0","False","106","OBJECT","0,0,0","False","107","OBJECT","0,0,0","False","5","FLOAT","114","FLOAT3","0","FLOAT3","113","FLOAT3","148","FLOAT4","149"]}
...
{"wire":[2669,585,2653,0]}
{"wire":[2669,1199,2508,0]}
{"wire":[2669,971,2507,0]}
{"wire":[2509,6,2669,1512]}
{"wire":[2567,0,2509,14]}
{"wire":[2511,0,2509,23]}
...
ASEEND*/
//CHKSM=A75D100650893905B7EE04B8CA4DF7327ABF6097