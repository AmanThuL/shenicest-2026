...
Shader "Hidden/BOXOPHOBIC/The Visual Engine/Helpers/Debug Colormap"
{
	Properties
	{
		...
		_ColormapIntensityValue( "Colormap Intensity", Range( 0, 1 ) ) = 0
		_ColormapMeshValue( "Colormap Mesh Mask", Range( 0, 1 ) ) = 0
		[Enum(Vertex R,0,Vertex G,1,Vertex B,2,Vertex A,3)] _ColormapMeshMode( "Colormap Mesh Mask", Float ) = 3
		[StyledRemapSlider] _ColormapMeshRemap( "Colormap Mesh Mask", Vector ) = ( 0, 1, 0, 0 )
	...
	LOD 0
		...
		Pass
		{
			...
			CGPROGRAM
				...
				uniform half _ColormapIntensityValue;
				uniform half _ColormapMeshMode;
				uniform half4 _ColormapMeshRemap;
				uniform half _ColormapMeshValue;
				...
				v2f VertexFunction( appdata v  )
				{
					...
					TVEVertexData Data15_g252725 =(TVEVertexData)Data16_g252057;
					float Out_Dummy15_g252725 = 0.0;
					float3 Out_PositionOS15_g252725 = float3( 0,0,0 );
					float3 Out_NormalOS15_g252725 = float3( 0,0,0 );
					float4 Out_TangentOS15_g252725 = float4( 0,0,0,0 );
					float4 Out_TransformData15_g252725 = float4( 0,0,0,0 );
					float4 Out_RotationData15_g252725 = float4( 0,0,0,0 );
					float4 Out_Interpolator15_g252725 = float4( 0,0,0,0 );
					BreakVertexData( Data15_g252725 , Out_Dummy15_g252725 , Out_PositionOS15_g252725 , Out_NormalOS15_g252725 , Out_TangentOS15_g252725 , Out_TransformData15_g252725 , Out_RotationData15_g252725 , Out_Interpolator15_g252725 );
					
					o.ase_texcoord6.xyz = vertexToFrag73_g251759;
					o.ase_texcoord7.xyz = vertexToFrag76_g251759;
					float3 vertexPos57_g252717 = v.vertex.xyz;
					float4 ase_positionCS57_g252717 = UnityObjectToClipPos( vertexPos57_g252717 );
					o.ase_texcoord9 = ase_positionCS57_g252717;
					...
					o.ase_texcoord10 = vertexToFrag1901_g252254;
					...
					#endif
					float3 vertexValue = Out_PositionOS15_g252725;
					#ifdef ASE_ABSOLUTE_VERTEX_POS
					...
					#endif
					v.vertex.w = 1;
					v.normal = Out_NormalOS15_g252725;
					v.tangent = Out_TangentOS15_g252725;
							...
							) : SV_Target
				{
					...
					float3 color130_g252717 = IsGammaSpace() ? float3( 0.15, 0.15, 0.15 ) : float3( 0.01960665, 0.01960665, 0.01960665 );
					float3 color81_g252717 = IsGammaSpace() ? float3( 0.2, 0.2, 0.2 ) : float3( 0.03310476, 0.03310476, 0.03310476 );
					float2 temp_cast_4 = (60.0).xx;
					float2 appendResult128_g252719 = (float2(ScreenPosNorm.x , ( ( _ScreenParams.y / _ScreenParams.x ) * ScreenPosNorm.y )));
					float2 FinalUV13_g252718 = ( temp_cast_4 * ( 0.5 + appendResult128_g252719 ) );
					float2 temp_cast_5 = (0.5).xx;
					float2 temp_cast_6 = (1.0).xx;
					float4 appendResult16_g252718 = (float4(ddx( FinalUV13_g252718 ) , ddy( FinalUV13_g252718 )));
					float4 UVDerivatives17_g252718 = appendResult16_g252718;
					float4 break28_g252718 = UVDerivatives17_g252718;
					float2 appendResult19_g252718 = (float2(break28_g252718.x , break28_g252718.z));
					float2 appendResult20_g252718 = (float2(break28_g252718.x , break28_g252718.z));
					float dotResult24_g252718 = dot( appendResult19_g252718 , appendResult20_g252718 );
					float2 appendResult21_g252718 = (float2(break28_g252718.y , break28_g252718.w));
					float2 appendResult22_g252718 = (float2(break28_g252718.y , break28_g252718.w));
					float dotResult23_g252718 = dot( appendResult21_g252718 , appendResult22_g252718 );
					float2 appendResult25_g252718 = (float2(dotResult24_g252718 , dotResult23_g252718));
					float2 derivativesLength29_g252718 = sqrt( appendResult25_g252718 );
					float2 temp_cast_7 = (-1.0).xx;
					float2 temp_cast_8 = (1.0).xx;
					float2 clampResult57_g252718 = clamp( ( ( ( abs( ( frac( ( FinalUV13_g252718 + 0.25 ) ) - temp_cast_5 ) ) * 4.0 ) - temp_cast_6 ) * ( 0.35 / derivativesLength29_g252718 ) ) , temp_cast_7 , temp_cast_8 );
					float2 break71_g252718 = clampResult57_g252718;
					float2 break55_g252718 = derivativesLength29_g252718;
					float4 lerpResult73_g252718 = lerp( float4( color130_g252717 , 0.0 ) , float4( color81_g252717 , 0.0 ) , saturate( ( 0.5 + ( 0.5 * break71_g252718.x * break71_g252718.y * sqrt( saturate( ( 1.1 - max( break55_g252718.x, break55_g252718.y ) ) ) ) ) ) ));
					float3 color107_g252709 = IsGammaSpace() ? float3( 0.8679245, 0.2898379, 0.1760413 ) : float3( 0.7254258, 0.06830776, 0.02612457 );
					float3 color106_g252709 = IsGammaSpace() ? float3( 0.5630165, 0.6901961, 0.1607843 ) : float3( 0.2770731, 0.4341537, 0.02217388 );
					float localBreakData4_g252708 = ( 0.0 );
					float localBuildMasksData3_g252694 = ( 0.0 );
					TVEMasksData Data3_g252694 = (TVEMasksData)0;
					half Feature_Intensity508_g252690 = _ColormapIntensityValue;
					float ifLocalVar18_g252695 = 0;
					if( Feature_Intensity508_g252690 <= 0.0 )
					ifLocalVar18_g252695 = 0.0;
					else
					ifLocalVar18_g252695 = 1.0;
					float4 appendResult517_g252690 = (float4(ifLocalVar18_g252695 , 0.0 , 0.0 , 0.0));
					float4 In_MaskA3_g252694 = appendResult517_g252690;
					float localBuildGlobalData204_g251779 = ( 0.0 );
					TVEGlobalData Data204_g251779 =(TVEGlobalData)(TVEGlobalData)0;
					half Dummy211_g251779 = ( _GlobalCategory + _GlobalEnd );
					float In_Dummy204_g251779 = Dummy211_g251779;
					...
					float4 In_UserTexture204_g251779 = User_Texture677_g251779;
					BuildGlobalData( Data204_g251779 , In_Dummy204_g251779 , In_CoatTexture204_g251779 , In_DrawTexture204_g251779 , In_PaintTexture204_g251779 , In_AtmoTexture204_g251779 , In_EffexTexture204_g251779 , In_GlowTexture204_g251779 , In_FormTexture204_g251779 , In_LandTexture204_g251779 , In_VertxTexture204_g251779 , In_FlowTexture204_g251779 , In_UserTexture204_g251779 );
					TVEGlobalData Data15_g252696 =(TVEGlobalData)Data204_g251779;
					float Out_Dummy15_g252696 = 0.0;
					float4 Out_CoatTexture15_g252696 = float4( 0,0,0,0 );
					float4 Out_DrawTexture15_g252696 = float4( 0,0,0,0 );
					float4 Out_PaintTexture15_g252696 = float4( 0,0,0,0 );
					float4 Out_AtmoTexture15_g252696 = float4( 0,0,0,0 );
					float4 Out_EffexTexture15_g252696 = float4( 0,0,0,0 );
					float4 Out_GlowTexture15_g252696 = float4( 0,0,0,0 );
					float4 Out_FormTexture15_g252696 = float4( 0,0,0,0 );
					float4 Out_LandTexture15_g252696 = float4( 0,0,0,0 );
					float4 Out_VertxTexture15_g252696 = float4( 0,0,0,0 );
					float4 Out_FlowTexture15_g252696 = float4( 0,0,0,0 );
					float4 Out_UserTexture15_g252696 = float4( 0,0,0,0 );
					BreakData( Data15_g252696 , Out_Dummy15_g252696 , Out_CoatTexture15_g252696 , Out_DrawTexture15_g252696 , Out_PaintTexture15_g252696 , Out_AtmoTexture15_g252696 , Out_EffexTexture15_g252696 , Out_GlowTexture15_g252696 , Out_FormTexture15_g252696 , Out_LandTexture15_g252696 , Out_VertxTexture15_g252696 , Out_FlowTexture15_g252696 , Out_UserTexture15_g252696 );
					half4 Global_DrawTexture209_g252690 = Out_DrawTexture15_g252696;
					half Blend_GlobalAlpha534_g252690 = (Global_DrawTexture209_g252690).w;
					float temp_output_17_0_g252706 = _ColormapMeshMode;
					float Option70_g252706 = temp_output_17_0_g252706;
					TVEModelData Data15_g252692 =(TVEModelData)Data16_g251767;
					float Out_Dummy15_g252692 = 0.0;
					float3 Out_PositionWS15_g252692 = float3( 0,0,0 );
					float3 Out_PositionWO15_g252692 = float3( 0,0,0 );
					float3 Out_PivotWS15_g252692 = float3( 0,0,0 );
					float3 Out_PivotWO15_g252692 = float3( 0,0,0 );
					float3 Out_NormalWS15_g252692 = float3( 0,0,0 );
					float3 Out_TangentWS15_g252692 = float3( 0,0,0 );
					float3 Out_BitangentWS15_g252692 = float3( 0,0,0 );
					float3 Out_TriplanarWeights15_g252692 = float3( 0,0,0 );
					float3 Out_ViewDirWS15_g252692 = float3( 0,0,0 );
					float4 Out_CoordsData15_g252692 = float4( 0,0,0,0 );
					float4 Out_VertexData15_g252692 = float4( 0,0,0,0 );
					float4 Out_Interpolator15_g252692 = float4( 0,0,0,0 );
					BreakModelFragData( Data15_g252692 , Out_Dummy15_g252692 , Out_PositionWS15_g252692 , Out_PositionWO15_g252692 , Out_PivotWS15_g252692 , Out_PivotWO15_g252692 , Out_NormalWS15_g252692 , Out_TangentWS15_g252692 , Out_BitangentWS15_g252692 , Out_TriplanarWeights15_g252692 , Out_ViewDirWS15_g252692 , Out_CoordsData15_g252692 , Out_VertexData15_g252692 , Out_Interpolator15_g252692 );
					half4 Model_VertexData307_g252690 = Out_VertexData15_g252692;
					float4 temp_output_3_0_g252706 = Model_VertexData307_g252690;
					float4 Channel70_g252706 = temp_output_3_0_g252706;
					float localSwitchChannel470_g252706 = SwitchChannel4( Option70_g252706 , Channel70_g252706 );
					float temp_output_521_0_g252690 = localSwitchChannel470_g252706;
					float temp_output_7_0_g252705 = _ColormapMeshRemap.x;
					float temp_output_9_0_g252705 = ( temp_output_521_0_g252690 - temp_output_7_0_g252705 );
					float lerpResult370_g252690 = lerp( 1.0 , saturate( ( temp_output_9_0_g252705 * _ColormapMeshRemap.z ) ) , _ColormapMeshValue);
					half Blend_MeshMask309_g252690 = lerpResult370_g252690;
					half Blend_Mask242_g252690 = ( _ColormapIntensityValue * Blend_GlobalAlpha534_g252690 * Blend_MeshMask309_g252690 * TVE_IsEnabled );
					float4 appendResult544_g252690 = (float4(Blend_Mask242_g252690 , 0.0 , 0.0 , 0.0));
					float4 temp_cast_19 = (0.0).xxxx;
					float4 temp_cast_20 = (0.0).xxxx;
					float4 ifLocalVar18_g252707 = 0;
					if( Feature_Intensity508_g252690 <= 0.0 )
					ifLocalVar18_g252707 = temp_cast_20;
					else
					ifLocalVar18_g252707 = appendResult544_g252690;
					float4 In_MaskB3_g252694 = ifLocalVar18_g252707;
					float4 temp_cast_21 = (0.0).xxxx;
					float4 In_MaskC3_g252694 = temp_cast_21;
					float4 temp_cast_22 = (0.0).xxxx;
					float4 In_MaskD3_g252694 = temp_cast_22;
					float4 temp_cast_23 = (0.0).xxxx;
					float4 In_MaskE3_g252694 = temp_cast_23;
					float4 temp_cast_24 = (0.0).xxxx;
					float4 In_MaskF3_g252694 = temp_cast_24;
					float4 temp_cast_25 = (0.0).xxxx;
					float4 In_MaskG3_g252694 = temp_cast_25;
					float4 temp_cast_26 = (0.0).xxxx;
					float4 In_MaskH3_g252694 = temp_cast_26;
					float4 temp_cast_27 = (0.0).xxxx;
					float4 In_MaskI3_g252694 = temp_cast_27;
					float4 temp_cast_28 = (0.0).xxxx;
					float4 In_MaskJ3_g252694 = temp_cast_28;
					float4 temp_cast_29 = (0.0).xxxx;
					float4 In_MaskK3_g252694 = temp_cast_29;
					float4 temp_cast_30 = (0.0).xxxx;
					float4 In_MaskL3_g252694 = temp_cast_30;
					{
					Data3_g252694.MaskA = In_MaskA3_g252694;
					Data3_g252694.MaskB = In_MaskB3_g252694;
					Data3_g252694.MaskC = In_MaskC3_g252694;
					Data3_g252694.MaskD = In_MaskD3_g252694;
					Data3_g252694.MaskE = In_MaskE3_g252694;
					Data3_g252694.MaskF = In_MaskF3_g252694;
					Data3_g252694.MaskG = In_MaskG3_g252694;
					Data3_g252694.MaskH = In_MaskH3_g252694;
					Data3_g252694.MaskI = In_MaskI3_g252694;
					Data3_g252694.MaskJ= In_MaskJ3_g252694;
					Data3_g252694.MaskK= In_MaskK3_g252694;
					Data3_g252694.MaskL = In_MaskL3_g252694;
					}
					TVEMasksData Data4_g252708 = Data3_g252694;
					float4 Out_MaskA4_g252708 = float4( 0,0,0,0 );
					float4 Out_MaskB4_g252708 = float4( 0,0,0,0 );
					float4 Out_MaskC4_g252708 = float4( 0,0,0,0 );
					float4 Out_MaskD4_g252708 = float4( 0,0,0,0 );
					float4 Out_MaskE4_g252708 = float4( 0,0,0,0 );
					float4 Out_MaskF4_g252708 = float4( 0,0,0,0 );
					float4 Out_MaskG4_g252708 = float4( 0,0,0,0 );
					float4 Out_MaskH4_g252708 = float4( 0,0,0,0 );
					{
					Out_MaskA4_g252708 = Data4_g252708.MaskA;
					Out_MaskB4_g252708 = Data4_g252708.MaskB;
					Out_MaskC4_g252708 = Data4_g252708.MaskC;
					Out_MaskD4_g252708 = Data4_g252708.MaskD;
					Out_MaskE4_g252708 = Data4_g252708.MaskE;
					Out_MaskF4_g252708 = Data4_g252708.MaskF;
					Out_MaskG4_g252708 = Data4_g252708.MaskG;
					Out_MaskH4_g252708 = Data4_g252708.MaskH;
					}
					float4 temp_output_2509_14 = Out_MaskA4_g252708;
					float3 lerpResult2568 = lerp( color107_g252709 , color106_g252709 , (temp_output_2509_14).x);
					float3 ifLocalVar40_g252713 = 0;
					if( TVE_DEBUG_Index == 0.0 )
					ifLocalVar40_g252713 = lerpResult2568;
					float3 ifLocalVar40_g252714 = 0;
					if( TVE_DEBUG_Index == 2.0 )
					ifLocalVar40_g252714 = (Out_MaskB4_g252708).xxx;
					float3 color107_g252711 = IsGammaSpace() ? float3( 0.8679245, 0.2898379, 0.1760413 ) : float3( 0.7254258, 0.06830776, 0.02612457 );
					float3 color106_g252711 = IsGammaSpace() ? float3( 0.5630165, 0.6901961, 0.1607843 ) : float3( 0.2770731, 0.4341537, 0.02217388 );
					float3 lerpResult2607 = lerp( color107_g252711 , color106_g252711 , (temp_output_2509_14).w);
					float3 ifLocalVar40_g252715 = 0;
					if( TVE_DEBUG_Index == 4.0 )
					ifLocalVar40_g252715 = lerpResult2607;
					half IsTerranShader2496 = _IsTerrainShader;
					float3 lerpResult2660 = lerp( ( ifLocalVar40_g252713 + ifLocalVar40_g252714 + ifLocalVar40_g252715 ) , float3( 0,0,0 ) , IsTerranShader2496);
					half3 Final_Debug2399 = lerpResult2660;
					float temp_output_7_0_g252724 = TVE_DEBUG_Min;
					float3 temp_cast_31 = (temp_output_7_0_g252724).xxx;
					float3 temp_output_9_0_g252724 = ( Final_Debug2399 - temp_cast_31 );
					float lerpResult76_g252717 = lerp( 1.0 , _IsTVEShader , TVE_DEBUG_Filter);
					float Filter152_g252717 = lerpResult76_g252717;
					float3 lerpResult72_g252717 = lerp( (lerpResult73_g252718).rgb , saturate( ( temp_output_9_0_g252724 / ( ( TVE_DEBUG_Max - temp_output_7_0_g252724 ) + 0.0001 ) ) ) , Filter152_g252717);
					float dotResult61_g252717 = dot( NormalWS , ViewDirWS );
					float temp_output_65_0_g252717 = ( 1.0 - saturate( dotResult61_g252717 ) );
					float Shading_Fresnel59_g252717 = (( 1.0 - ( temp_output_65_0_g252717 * temp_output_65_0_g252717 ) )*0.3 + 0.7);
					float4 ase_positionCS57_g252717 = IN.ase_texcoord9;
					float depthLinearEye57_g252717 = LinearEyeDepth( ase_positionCS57_g252717.z / ase_positionCS57_g252717.w );
					float temp_output_69_0_g252717 = saturate(  (0.0 + ( depthLinearEye57_g252717 - 300.0 ) * ( 1.0 - 0.0 ) / ( 0.0 - 300.0 ) ) );
					float Shading_Distance58_g252717 = (( temp_output_69_0_g252717 * temp_output_69_0_g252717 )*0.5 + 0.5);
					float lerpResult84_g252717 = lerp( 1.0 , Shading_Fresnel59_g252717 , ( Shading_Distance58_g252717 * TVE_DEBUG_Shading ));
					float localBreakVisualData4_g252722 = ( 0.0 );
					...
					float3 temp_cast_32 = (0.5).xxx;
					float3 temp_output_4_0_g252255 = temp_cast_32;
					float3 In_Albedo3_g252255 = temp_output_4_0_g252255;
					float3 temp_cast_33 = (0.5).xxx;
					float3 temp_output_44_0_g252255 = temp_cast_33;
					float3 In_AlbedoBase3_g252255 = temp_output_44_0_g252255;
					float2 temp_cast_34 = (0.0).xx;
					float2 In_NormalTS3_g252255 = temp_cast_34;
					float3 temp_cast_35 = (0.5).xxx;
					float3 In_NormalWS3_g252255 = temp_cast_35;
					...
					float3 temp_cast_36 = (1.0).xxx;
					float3 In_Translucency3_g252255 = temp_cast_36;
					...
					float4 vertexToFrag1901_g252254 = IN.ase_texcoord10;
					...
					float3 In_Translucency3_g252260 = temp_cast_45;
					...
					TVEVisualData Data4_g252722 =(TVEVisualData)Data3_g252260;
					float Out_Dummy4_g252722 = 0.0;
					float3 Out_Albedo4_g252722 = float3( 0,0,0 );
					float3 Out_AlbedoBase4_g252722 = float3( 0,0,0 );
					float2 Out_NormalTS4_g252722 = float2( 0,0 );
					float3 Out_NormalWS4_g252722 = float3( 0,0,0 );
					float4 Out_Shader4_g252722 = float4( 0,0,0,0 );
					float4 Out_Feature4_g252722 = float4( 0,0,0,0 );
					float4 Out_Season4_g252722 = float4( 0,0,0,0 );
					float4 Out_Emissive4_g252722 = float4( 0,0,0,0 );
					float Out_MultiMask4_g252722 = 0.0;
					float Out_Grayscale4_g252722 = 0.0;
					float Out_Luminosity4_g252722 = 0.0;
					float Out_AlphaClip4_g252722 = 0.0;
					float Out_AlphaFade4_g252722 = 0.0;
					float3 Out_Translucency4_g252722 = float3( 0,0,0 );
					float Out_Transmission4_g252722 = 0.0;
					float Out_Thickness4_g252722 = 0.0;
					float Out_Diffusion4_g252722 = 0.0;
					float Out_Depth4_g252722 = 0.0;
					BreakVisualData( Data4_g252722 , Out_Dummy4_g252722 , Out_Albedo4_g252722 , Out_AlbedoBase4_g252722 , Out_NormalTS4_g252722 , Out_NormalWS4_g252722 , Out_Shader4_g252722 , Out_Feature4_g252722 , Out_Season4_g252722 , Out_Emissive4_g252722 , Out_MultiMask4_g252722 , Out_Grayscale4_g252722 , Out_Luminosity4_g252722 , Out_AlphaClip4_g252722 , Out_AlphaFade4_g252722 , Out_Translucency4_g252722 , Out_Transmission4_g252722 , Out_Thickness4_g252722 , Out_Diffusion4_g252722 , Out_Depth4_g252722 );
					float Alpha109_g252717 = Out_AlphaClip4_g252722;
					float lerpResult91_g252717 = lerp( 1.0 , Alpha109_g252717 , ( TVE_DEBUG_Clip * _RenderClip ));
					float lerpResult154_g252717 = lerp( 1.0 , lerpResult91_g252717 , Filter152_g252717);
					clip( lerpResult154_g252717 );
					...
					o.Emission = ( lerpResult72_g252717 * lerpResult84_g252717 );
					o.Alpha = 1;
					half3 BakedGI = 0;
		...
		Pass
		{
			...
			CGPROGRAM
				...
				v2f VertexFunction (appdata v  ) {
					...
					float3 vertexPos57_g252717 = v.vertex.xyz;
					float4 ase_positionCS57_g252717 = UnityObjectToClipPos( vertexPos57_g252717 );
					o.ase_texcoord7 = ase_positionCS57_g252717;
					TVEVertexData Data1902_g252254 = Data16_g252057;
					float4 Out_Interpolator1902_g252254 = float4( 0,0,0,0 );
					{
					Out_Interpolator1902_g252254 = Data1902_g252254.Interpolator;
					...
					float4 vertexToFrag1901_g252254 = Out_Interpolator1902_g252254;
					o.ase_texcoord8 = vertexToFrag1901_g252254;
				...
				)
				{
					...
					float temp_output_65_0_g252717 = ( 1.0 - saturate( dotResult61_g252717 ) );
					float Shading_Fresnel59_g252717 = (( 1.0 - ( temp_output_65_0_g252717 * temp_output_65_0_g252717 ) )*0.3 + 0.7);
					float4 ase_positionCS57_g252717 = IN.ase_texcoord7;
					float depthLinearEye57_g252717 = LinearEyeDepth( ase_positionCS57_g252717.z / ase_positionCS57_g252717.w );
					float temp_output_69_0_g252717 = saturate(  (0.0 + ( depthLinearEye57_g252717 - 300.0 ) * ( 1.0 - 0.0 ) / ( 0.0 - 300.0 ) ) );
					float Shading_Distance58_g252717 = (( temp_output_69_0_g252717 * temp_output_69_0_g252717 )*0.5 + 0.5);
					float lerpResult84_g252717 = lerp( 1.0 , Shading_Fresnel59_g252717 , ( Shading_Distance58_g252717 * TVE_DEBUG_Shading ));
					...
					float4 In_CoordsData16_g252257 = Out_CoordsData15_g252256;
					float4 In_VertexData16_g252257 = Out_VertexData15_g252256;
					float4 vertexToFrag1901_g252254 = IN.ase_texcoord8;
					float4 In_Interpolator16_g252257 = vertexToFrag1901_g252254;
					BuildModelFragData( Data16_g252257 , In_Dummy16_g252257 , In_PositionWS16_g252257 , In_PositionWO16_g252257 , In_PivotWS16_g252257 , In_PivotWO16_g252257 , In_NormalWS16_g252257 , In_TangentWS16_g252257 , In_BitangentWS16_g252257 , In_TriplanarWeights16_g252257 , In_ViewDirWS16_g252257 , In_CoordsData16_g252257 , In_VertexData16_g252257 , In_Interpolator16_g252257 );
					TVEModelData Data15_g252259 =(TVEModelData)Data16_g252257;
					float Out_Dummy15_g252259 = 0.0;
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2707,"pos":[-4480,-5120],"params":["Inherit","False","Block Blanket Conform","122","","252032","3ce1684c4351aeb42b79a955aa483301","2,389,0,377,1","3","146","OBJECT","0,0,0,0","False","397","OBJECT","0,0,0,0","False","186","OBJECT","0,0,0,0","False","3","OBJECT","128","OBJECT","398","OBJECT","399"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2714,"pos":[-2304,-5120],"params":["Inherit","False","Block Main","137","","252258","b04cfed9a7b4c0841afdb49a38c282c5","13,65,1,136,1,41,1,133,1,40,1,344,0,347,0,342,0,346,0,343,0,345,0,329,1,408,1","3","430","OBJECT","0,0,0,0","False","225","OBJECT","0,0,0,0","False","414","OBJECT","0,0,0,0","False","3","OBJECT","106","OBJECT","417","OBJECT","415"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2727,"pos":[-640,-5120],"params":["Inherit","False","Block Colormap","7","","252690","4c7c6ab34eae10e4f92b30da5ead18ad","6,503,0,334,1,336,1,339,1,355,0,344,0","4","198","OBJECT","0,0,0,0","False","223","OBJECT","0,0,0,0","False","207","OBJECT","0,0,0,0","False","346","FLOAT","1","False","4","OBJECT","204","OBJECT","541","OBJECT","542","OBJECT","472"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2509,"pos":[0,-5120],"params":["Inherit","False","Break Masks Data","-1","","252708","23311522ecc97b54e8b77d849401069d","0","1","6","OBJECT","0","False","8","FLOAT4","14","FLOAT4","0","FLOAT4","23","FLOAT4","5","FLOAT4","24","FLOAT4","25","FLOAT4","26","FLOAT4","27"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2646,"pos":[768,-5120],"params":["Inherit","False","Tool Debug Active","117","","252709","0bb5baa3fd5a859489bbfc09acf77496","0","2","80","FLOAT3","0,0,0","False","102","FLOAT","0","False","2","FLOAT3","108","FLOAT3","0"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2649,"pos":[768,-4592],"params":["Inherit","False","Tool Debug Active","117","","252711","0bb5baa3fd5a859489bbfc09acf77496","0","2","80","FLOAT3","0,0,0","False","102","FLOAT","0","False","2","FLOAT3","108","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":2490,"pos":[-7296,-5248],"params":["Inherit","False","Property","_IsTerrainShader","_IsTerrainShader","136","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2594,"pos":[1408,-5120],"params":["Inherit","False","Tool Debug Index","-1","","252713","db6ad3771e2815f4e84bed76b862e261","0","2","39","FLOAT3","0,0,0","False","36","FLOAT","0","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2611,"pos":[1408,-4864],"params":["Inherit","False","Tool Debug Index","-1","","252714","db6ad3771e2815f4e84bed76b862e261","0","2","39","FLOAT3","0,0,0","False","36","FLOAT","2","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2609,"pos":[1408,-4592],"params":["Inherit","False","Tool Debug Index","-1","","252715","db6ad3771e2815f4e84bed76b862e261","0","2","39","FLOAT3","0,0,0","False","36","FLOAT","4","False","1","FLOAT3","0"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2203,"pos":[3712,-5248],"params":["Inherit","False","Base Compile","-1","","252716","e67c8238031dbf04ab79a5d4d63d1b4f","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2672,"pos":[3328,-5120],"params":["Inherit","False","Tool Debug Color","0","","252717","d992d3ed4a7539141ba053d3e0c12277","0","3","80","FLOAT3","0,0,0","False","106","OBJECT","0,0,0","False","107","OBJECT","0,0,0","False","5","FLOAT","114","FLOAT3","0","FLOAT3","113","FLOAT3","148","FLOAT4","149"]}
...
{"wire":[2727,198,2600,0]}
{"wire":[2727,223,2508,0]}
{"wire":[2727,207,2507,0]}
{"wire":[2509,6,2727,472]}
{"wire":[2567,0,2509,14]}
{"wire":[2608,0,2509,14]}
...
ASEEND*/
//CHKSM=16103A731FDD1E8E9FBB9C236224FED1F0E91B0B