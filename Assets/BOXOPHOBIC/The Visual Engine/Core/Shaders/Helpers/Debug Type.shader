...
Shader "Hidden/BOXOPHOBIC/The Visual Engine/Helpers/Debug Type"
{
	Properties
	{
		...
		Pass
		{
			...
			CGPROGRAM
				...
				v2f VertexFunction( appdata v  )
				{
					...
					TVEVertexData Data15_g251687 =(TVEVertexData)Data16_g251583;
					float Out_Dummy15_g251687 = 0.0;
					float3 Out_PositionOS15_g251687 = float3( 0,0,0 );
					float3 Out_NormalOS15_g251687 = float3( 0,0,0 );
					float4 Out_TangentOS15_g251687 = float4( 0,0,0,0 );
					float4 Out_TransformData15_g251687 = float4( 0,0,0,0 );
					float4 Out_RotationData15_g251687 = float4( 0,0,0,0 );
					float4 Out_Interpolator15_g251687 = float4( 0,0,0,0 );
					BreakVertexData( Data15_g251687 , Out_Dummy15_g251687 , Out_PositionOS15_g251687 , Out_NormalOS15_g251687 , Out_TangentOS15_g251687 , Out_TransformData15_g251687 , Out_RotationData15_g251687 , Out_Interpolator15_g251687 );
					
					float3 vertexPos57_g251679 = v.vertex.xyz;
					float4 ase_positionCS57_g251679 = UnityObjectToClipPos( vertexPos57_g251679 );
					o.ase_texcoord6 = ase_positionCS57_g251679;
					o.ase_texcoord7.xyz = vertexToFrag73_g240733;
					o.ase_texcoord8.xyz = vertexToFrag76_g240733;
					TVEVertexData Data1902_g251635 = Data16_g251583;
					float4 Out_Interpolator1902_g251635 = float4( 0,0,0,0 );
					{
					Out_Interpolator1902_g251635 = Data1902_g251635.Interpolator;
					}
					float4 vertexToFrag1901_g251635 = Out_Interpolator1902_g251635;
					o.ase_texcoord10 = vertexToFrag1901_g251635;
					...
					#endif
					float3 vertexValue = Out_PositionOS15_g251687;
					#ifdef ASE_ABSOLUTE_VERTEX_POS
					...
					#endif
					v.vertex.w = 1;
					v.normal = Out_NormalOS15_g251687;
					v.tangent = Out_TangentOS15_g251687;
							...
							) : SV_Target
				{
					...
					float temp_output_2433_114 = 0.0;
					float3 temp_cast_0 = (temp_output_2433_114).xxx;
					
					float3 color130_g251679 = IsGammaSpace() ? float3( 0.15, 0.15, 0.15 ) : float3( 0.01960665, 0.01960665, 0.01960665 );
					float3 color81_g251679 = IsGammaSpace() ? float3( 0.2, 0.2, 0.2 ) : float3( 0.03310476, 0.03310476, 0.03310476 );
					float2 temp_cast_3 = (60.0).xx;
					float2 appendResult128_g251681 = (float2(ScreenPosNorm.x , ( ( _ScreenParams.y / _ScreenParams.x ) * ScreenPosNorm.y )));
					float2 FinalUV13_g251680 = ( temp_cast_3 * ( 0.5 + appendResult128_g251681 ) );
					float2 temp_cast_4 = (0.5).xx;
					float2 temp_cast_5 = (1.0).xx;
					float4 appendResult16_g251680 = (float4(ddx( FinalUV13_g251680 ) , ddy( FinalUV13_g251680 )));
					float4 UVDerivatives17_g251680 = appendResult16_g251680;
					float4 break28_g251680 = UVDerivatives17_g251680;
					float2 appendResult19_g251680 = (float2(break28_g251680.x , break28_g251680.z));
					float2 appendResult20_g251680 = (float2(break28_g251680.x , break28_g251680.z));
					float dotResult24_g251680 = dot( appendResult19_g251680 , appendResult20_g251680 );
					float2 appendResult21_g251680 = (float2(break28_g251680.y , break28_g251680.w));
					float2 appendResult22_g251680 = (float2(break28_g251680.y , break28_g251680.w));
					float dotResult23_g251680 = dot( appendResult21_g251680 , appendResult22_g251680 );
					float2 appendResult25_g251680 = (float2(dotResult24_g251680 , dotResult23_g251680));
					float2 derivativesLength29_g251680 = sqrt( appendResult25_g251680 );
					float2 temp_cast_6 = (-1.0).xx;
					float2 temp_cast_7 = (1.0).xx;
					float2 clampResult57_g251680 = clamp( ( ( ( abs( ( frac( ( FinalUV13_g251680 + 0.25 ) ) - temp_cast_4 ) ) * 4.0 ) - temp_cast_5 ) * ( 0.35 / derivativesLength29_g251680 ) ) , temp_cast_6 , temp_cast_7 );
					float2 break71_g251680 = clampResult57_g251680;
					float2 break55_g251680 = derivativesLength29_g251680;
					float4 lerpResult73_g251680 = lerp( float4( color130_g251679 , 0.0 ) , float4( color81_g251679 , 0.0 ) , saturate( ( 0.5 + ( 0.5 * break71_g251680.x * break71_g251680.y * sqrt( saturate( ( 1.1 - max( break55_g251680.x, break55_g251680.y ) ) ) ) ) ) ));
					half IsShaderType2402 = _IsShaderType;
					float4 color2395 = IsGammaSpace() ? float4( 0.9254902, 0.7960784, 0.4156863, 1 ) : float4( 0.8387991, 0.5972018, 0.1441285, 1 );
					float3 ifLocalVar40_g251584 = 0;
					if( IsShaderType2402 == 1.0 )
					ifLocalVar40_g251584 = color2395.rgb;
					float4 color2398 = IsGammaSpace() ? float4( 0.6196079, 0.7686275, 0.1490196, 0 ) : float4( 0.3419145, 0.5520116, 0.01938236, 0 );
					float3 ifLocalVar40_g251585 = 0;
					if( IsShaderType2402 == 2.0 )
					ifLocalVar40_g251585 = color2398.rgb;
					...
					if( IsShaderType2402 == 3.0 )
					ifLocalVar40_g251586 = color2391.rgb;
					float4 color2412 = IsGammaSpace() ? float4( 0.8117647, 0.3490196, 0.2627451, 0 ) : float4( 0.6239604, 0.09989873, 0.05612849, 0 );
					float3 ifLocalVar40_g251587 = 0;
					if( IsShaderType2402 == 4.0 )
					ifLocalVar40_g251587 = color2412.rgb;
					half3 Final_Debug2386 = ( ifLocalVar40_g251584 + ifLocalVar40_g251585 + ifLocalVar40_g251586 + ifLocalVar40_g251587 );
					float temp_output_7_0_g251686 = TVE_DEBUG_Min;
					float3 temp_cast_8 = (temp_output_7_0_g251686).xxx;
					float3 temp_output_9_0_g251686 = ( Final_Debug2386 - temp_cast_8 );
					float lerpResult76_g251679 = lerp( 1.0 , _IsTVEShader , TVE_DEBUG_Filter);
					float Filter152_g251679 = lerpResult76_g251679;
					float3 lerpResult72_g251679 = lerp( (lerpResult73_g251680).rgb , saturate( ( temp_output_9_0_g251686 / ( ( TVE_DEBUG_Max - temp_output_7_0_g251686 ) + 0.0001 ) ) ) , Filter152_g251679);
					float dotResult61_g251679 = dot( NormalWS , ViewDirWS );
					float temp_output_65_0_g251679 = ( 1.0 - saturate( dotResult61_g251679 ) );
					float Shading_Fresnel59_g251679 = (( 1.0 - ( temp_output_65_0_g251679 * temp_output_65_0_g251679 ) )*0.3 + 0.7);
					float4 ase_positionCS57_g251679 = IN.ase_texcoord6;
					float depthLinearEye57_g251679 = LinearEyeDepth( ase_positionCS57_g251679.z / ase_positionCS57_g251679.w );
					float temp_output_69_0_g251679 = saturate(  (0.0 + ( depthLinearEye57_g251679 - 300.0 ) * ( 1.0 - 0.0 ) / ( 0.0 - 300.0 ) ) );
					float Shading_Distance58_g251679 = (( temp_output_69_0_g251679 * temp_output_69_0_g251679 )*0.5 + 0.5);
					float lerpResult84_g251679 = lerp( 1.0 , Shading_Fresnel59_g251679 , ( Shading_Distance58_g251679 * TVE_DEBUG_Shading ));
					float localBreakVisualData4_g251684 = ( 0.0 );
					float localBuildVisualData3_g251641 = ( 0.0 );
					float localBuildVisualData3_g251636 = ( 0.0 );
					TVEVisualData Data3_g251636 =(TVEVisualData)0;
					float temp_output_14_0_g251636 = 0.0;
					float In_Dummy3_g251636 = temp_output_14_0_g251636;
					float3 temp_cast_9 = (0.5).xxx;
					float3 temp_output_4_0_g251636 = temp_cast_9;
					float3 In_Albedo3_g251636 = temp_output_4_0_g251636;
					float3 temp_cast_10 = (0.5).xxx;
					float3 temp_output_44_0_g251636 = temp_cast_10;
					float3 In_AlbedoBase3_g251636 = temp_output_44_0_g251636;
					float2 temp_cast_11 = (0.0).xx;
					float2 In_NormalTS3_g251636 = temp_cast_11;
					float3 temp_cast_12 = (0.5).xxx;
					float3 In_NormalWS3_g251636 = temp_cast_12;
					float4 In_Shader3_g251636 = half4( 0, 1, 0, 1 );
					float4 In_Feature3_g251636 = half4( 1, 1, 1, 1 );
					float4 In_Season3_g251636 = half4( 1, 1, 1, 1 );
					float4 In_Emissive3_g251636 = half4( 1, 1, 1, 1 );
					float temp_output_12_0_g251636 = 0.5;
					float In_Grayscale3_g251636 = temp_output_12_0_g251636;
					float temp_output_16_0_g251636 = 1.0;
					float In_Luminosity3_g251636 = temp_output_16_0_g251636;
					float In_MultiMask3_g251636 = 1.0;
					float In_AlphaClip3_g251636 = 1.0;
					float In_AlphaFade3_g251636 = 1.0;
					float3 temp_cast_13 = (1.0).xxx;
					float3 In_Translucency3_g251636 = temp_cast_13;
					float In_Transmission3_g251636 = 1.0;
					float In_Thickness3_g251636 = 0.0;
					float In_Diffusion3_g251636 = 0.0;
					float In_Depth3_g251636 = 0.0;
					BuildVisualData( Data3_g251636 , In_Dummy3_g251636 , In_Albedo3_g251636 , In_AlbedoBase3_g251636 , In_NormalTS3_g251636 , In_NormalWS3_g251636 , In_Shader3_g251636 , In_Feature3_g251636 , In_Season3_g251636 , In_Emissive3_g251636 , In_Grayscale3_g251636 , In_Luminosity3_g251636 , In_MultiMask3_g251636 , In_AlphaClip3_g251636 , In_AlphaFade3_g251636 , In_Translucency3_g251636 , In_Transmission3_g251636 , In_Thickness3_g251636 , In_Diffusion3_g251636 , In_Depth3_g251636 );
					TVEVisualData Data3_g251641 =(TVEVisualData)Data3_g251636;
					half Dummy130_g251639 = ( _MainCategory + _MainEnd );
					float temp_output_14_0_g251641 = Dummy130_g251639;
					float In_Dummy3_g251641 = temp_output_14_0_g251641;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture276_g251662) = _MainAlbedoTex;
					#if defined( TVE_FILTER_DEFAULT )
					SamplerState staticSwitch36_g251644 = sampler_Linear_Repeat_Aniso8;
					#elif defined( TVE_FILTER_POINT )
					SamplerState staticSwitch36_g251644 = sampler_Point_Repeat;
					#elif defined( TVE_FILTER_LOW )
					SamplerState staticSwitch36_g251644 = sampler_Linear_Repeat;
					...
					SamplerState staticSwitch36_g251644 = sampler_Linear_Repeat_Aniso8;
					#endif
					SamplerState Sampler276_g251662 = staticSwitch36_g251644;
					float localBreakTextureData456_g251662 = ( 0.0 );
					float localBuildTextureData431_g251661 = ( 0.0 );
					TVEMasksData Data431_g251661 =(TVEMasksData)(TVEMasksData)0;
					float localComputeMeshCoords444_g251661 = ( 0.0 );
					float4 temp_output_6_0_g251677 = _main_coord_value;
					float4 temp_output_7_0_g251677 = ( _MainSampleMode + _MainCoordMode + _MainCoordValue );
					#ifdef TVE_DUMMY
					float4 staticSwitch14_g251677 = ( temp_output_6_0_g251677 + temp_output_7_0_g251677 );
					#else
					float4 staticSwitch14_g251677 = temp_output_6_0_g251677;
					#endif
					half4 Local_Coords180_g251639 = staticSwitch14_g251677;
					float4 Coords444_g251661 = Local_Coords180_g251639;
					TVEModelData Data16_g240741 =(TVEModelData)0;
					float In_Dummy16_g240741 = 0.0;
					...
					float4 In_Interpolator16_g240741 = Phase_Data176_g240733;
					BuildModelFragData( Data16_g240741 , In_Dummy16_g240741 , In_PositionWS16_g240741 , In_PositionWO16_g240741 , In_PivotWS16_g240741 , In_PivotWO16_g240741 , In_NormalWS16_g240741 , In_TangentWS16_g240741 , In_BitangentWS16_g240741 , In_TriplanarWeights16_g240741 , In_ViewDirWS16_g240741 , In_CoordsData16_g240741 , In_VertexData16_g240741 , In_Interpolator16_g240741 );
					TVEModelData Data15_g251637 =(TVEModelData)Data16_g240741;
					float Out_Dummy15_g251637 = 0.0;
					float3 Out_PositionWS15_g251637 = float3( 0,0,0 );
					float3 Out_PositionWO15_g251637 = float3( 0,0,0 );
					float3 Out_PivotWS15_g251637 = float3( 0,0,0 );
					float3 Out_PivotWO15_g251637 = float3( 0,0,0 );
					float3 Out_NormalWS15_g251637 = float3( 0,0,0 );
					float3 Out_TangentWS15_g251637 = float3( 0,0,0 );
					float3 Out_BitangentWS15_g251637 = float3( 0,0,0 );
					float3 Out_TriplanarWeights15_g251637 = float3( 0,0,0 );
					float3 Out_ViewDirWS15_g251637 = float3( 0,0,0 );
					float4 Out_CoordsData15_g251637 = float4( 0,0,0,0 );
					float4 Out_VertexData15_g251637 = float4( 0,0,0,0 );
					float4 Out_Interpolator15_g251637 = float4( 0,0,0,0 );
					BreakModelFragData( Data15_g251637 , Out_Dummy15_g251637 , Out_PositionWS15_g251637 , Out_PositionWO15_g251637 , Out_PivotWS15_g251637 , Out_PivotWO15_g251637 , Out_NormalWS15_g251637 , Out_TangentWS15_g251637 , Out_BitangentWS15_g251637 , Out_TriplanarWeights15_g251637 , Out_ViewDirWS15_g251637 , Out_CoordsData15_g251637 , Out_VertexData15_g251637 , Out_Interpolator15_g251637 );
					TVEModelData Data16_g251638 =(TVEModelData)Data15_g251637;
					float In_Dummy16_g251638 = Out_Dummy15_g251637;
					float3 In_PositionWS16_g251638 = Out_PositionWS15_g251637;
					float3 In_PositionWO16_g251638 = Out_PositionWO15_g251637;
					float3 In_PivotWS16_g251638 = Out_PivotWS15_g251637;
					float3 In_PivotWO16_g251638 = Out_PivotWO15_g251637;
					float3 In_NormalWS16_g251638 = Out_NormalWS15_g251637;
					float3 In_TangentWS16_g251638 = Out_TangentWS15_g251637;
					float3 In_BitangentWS16_g251638 = Out_BitangentWS15_g251637;
					float3 In_TriplanarWeights16_g251638 = Out_TriplanarWeights15_g251637;
					float3 In_ViewDirWS16_g251638 = Out_ViewDirWS15_g251637;
					float4 In_CoordsData16_g251638 = Out_CoordsData15_g251637;
					float4 In_VertexData16_g251638 = Out_VertexData15_g251637;
					float4 vertexToFrag1901_g251635 = IN.ase_texcoord10;
					float4 In_Interpolator16_g251638 = vertexToFrag1901_g251635;
					BuildModelFragData( Data16_g251638 , In_Dummy16_g251638 , In_PositionWS16_g251638 , In_PositionWO16_g251638 , In_PivotWS16_g251638 , In_PivotWO16_g251638 , In_NormalWS16_g251638 , In_TangentWS16_g251638 , In_BitangentWS16_g251638 , In_TriplanarWeights16_g251638 , In_ViewDirWS16_g251638 , In_CoordsData16_g251638 , In_VertexData16_g251638 , In_Interpolator16_g251638 );
					TVEModelData Data15_g251640 =(TVEModelData)Data16_g251638;
					float Out_Dummy15_g251640 = 0.0;
					float3 Out_PositionWS15_g251640 = float3( 0,0,0 );
					float3 Out_PositionWO15_g251640 = float3( 0,0,0 );
					float3 Out_PivotWS15_g251640 = float3( 0,0,0 );
					float3 Out_PivotWO15_g251640 = float3( 0,0,0 );
					float3 Out_NormalWS15_g251640 = float3( 0,0,0 );
					float3 Out_TangentWS15_g251640 = float3( 0,0,0 );
					float3 Out_BitangentWS15_g251640 = float3( 0,0,0 );
					float3 Out_TriplanarWeights15_g251640 = float3( 0,0,0 );
					float3 Out_ViewDirWS15_g251640 = float3( 0,0,0 );
					float4 Out_CoordsData15_g251640 = float4( 0,0,0,0 );
					float4 Out_VertexData15_g251640 = float4( 0,0,0,0 );
					float4 Out_Interpolator15_g251640 = float4( 0,0,0,0 );
					BreakModelFragData( Data15_g251640 , Out_Dummy15_g251640 , Out_PositionWS15_g251640 , Out_PositionWO15_g251640 , Out_PivotWS15_g251640 , Out_PivotWO15_g251640 , Out_NormalWS15_g251640 , Out_TangentWS15_g251640 , Out_BitangentWS15_g251640 , Out_TriplanarWeights15_g251640 , Out_ViewDirWS15_g251640 , Out_CoordsData15_g251640 , Out_VertexData15_g251640 , Out_Interpolator15_g251640 );
					float4 Model_CoordsData324_g251639 = Out_CoordsData15_g251640;
					float4 MeshCoords444_g251661 = Model_CoordsData324_g251639;
					float2 UV0444_g251661 = float2( 0,0 );
					float2 UV3444_g251661 = float2( 0,0 );
					ComputeMeshCoords( Coords444_g251661 , MeshCoords444_g251661 , UV0444_g251661 , UV3444_g251661 );
					float4 appendResult430_g251661 = (float4(UV0444_g251661 , UV3444_g251661));
					float4 In_MaskA431_g251661 = appendResult430_g251661;
					float localComputeWorldCoords315_g251661 = ( 0.0 );
					float4 Coords315_g251661 = Local_Coords180_g251639;
					float3 Model_PositionWO222_g251639 = Out_PositionWO15_g251640;
					float3 PositionWS315_g251661 = Model_PositionWO222_g251639;
					float2 ZY315_g251661 = float2( 0,0 );
					float2 XZ315_g251661 = float2( 0,0 );
					float2 XY315_g251661 = float2( 0,0 );
					ComputeWorldCoords( Coords315_g251661 , PositionWS315_g251661 , ZY315_g251661 , XZ315_g251661 , XY315_g251661 );
					float2 ZY402_g251661 = ZY315_g251661;
					float2 XZ403_g251661 = XZ315_g251661;
					float4 appendResult432_g251661 = (float4(ZY402_g251661 , XZ403_g251661));
					float4 In_MaskB431_g251661 = appendResult432_g251661;
					float2 XY404_g251661 = XY315_g251661;
					float localComputeStochasticCoords409_g251661 = ( 0.0 );
					float2 UV409_g251661 = ZY402_g251661;
					float2 UV1409_g251661 = float2( 0,0 );
					float2 UV2409_g251661 = float2( 0,0 );
					float2 UV3409_g251661 = float2( 0,0 );
					float3 Weights409_g251661 = float3( 0,0,0 );
					ComputeStochasticCoords( UV409_g251661 , UV1409_g251661 , UV2409_g251661 , UV3409_g251661 , Weights409_g251661 );
					float4 appendResult433_g251661 = (float4(XY404_g251661 , UV1409_g251661));
					float4 In_MaskC431_g251661 = appendResult433_g251661;
					float4 appendResult434_g251661 = (float4(UV2409_g251661 , UV3409_g251661));
					float4 In_MaskD431_g251661 = appendResult434_g251661;
					float localComputeStochasticCoords422_g251661 = ( 0.0 );
					float2 UV422_g251661 = XZ403_g251661;
					float2 UV1422_g251661 = float2( 0,0 );
					float2 UV2422_g251661 = float2( 0,0 );
					float2 UV3422_g251661 = float2( 0,0 );
					float3 Weights422_g251661 = float3( 0,0,0 );
					ComputeStochasticCoords( UV422_g251661 , UV1422_g251661 , UV2422_g251661 , UV3422_g251661 , Weights422_g251661 );
					float4 appendResult435_g251661 = (float4(UV1422_g251661 , UV2422_g251661));
					float4 In_MaskE431_g251661 = appendResult435_g251661;
					float localComputeStochasticCoords423_g251661 = ( 0.0 );
					float2 UV423_g251661 = XY404_g251661;
					float2 UV1423_g251661 = float2( 0,0 );
					float2 UV2423_g251661 = float2( 0,0 );
					float2 UV3423_g251661 = float2( 0,0 );
					float3 Weights423_g251661 = float3( 0,0,0 );
					ComputeStochasticCoords( UV423_g251661 , UV1423_g251661 , UV2423_g251661 , UV3423_g251661 , Weights423_g251661 );
					float4 appendResult436_g251661 = (float4(UV3422_g251661 , UV1423_g251661));
					float4 In_MaskF431_g251661 = appendResult436_g251661;
					float4 appendResult437_g251661 = (float4(UV2423_g251661 , UV3423_g251661));
					float4 In_MaskG431_g251661 = appendResult437_g251661;
					float4 In_MaskH431_g251661 = float4( Weights409_g251661 , 0.0 );
					float4 In_MaskI431_g251661 = float4( Weights422_g251661 , 0.0 );
					float4 In_MaskJ431_g251661 = float4( Weights423_g251661 , 0.0 );
					half3 Model_NormalWS226_g251639 = Out_NormalWS15_g251640;
					float3 temp_output_449_0_g251661 = Model_NormalWS226_g251639;
					float4 In_MaskK431_g251661 = float4( temp_output_449_0_g251661 , 0.0 );
					half3 Model_TangentWS366_g251639 = Out_TangentWS15_g251640;
					float3 temp_output_450_0_g251661 = Model_TangentWS366_g251639;
					float4 In_MaskL431_g251661 = float4( temp_output_450_0_g251661 , 0.0 );
					half3 Model_BitangentWS367_g251639 = Out_BitangentWS15_g251640;
					float3 temp_output_451_0_g251661 = Model_BitangentWS367_g251639;
					float4 In_MaskM431_g251661 = float4( temp_output_451_0_g251661 , 0.0 );
					half3 Model_TriplanarWeights368_g251639 = Out_TriplanarWeights15_g251640;
					float3 temp_output_445_0_g251661 = Model_TriplanarWeights368_g251639;
					float4 In_MaskN431_g251661 = float4( temp_output_445_0_g251661 , 0.0 );
					BuildTextureData( Data431_g251661 , In_MaskA431_g251661 , In_MaskB431_g251661 , In_MaskC431_g251661 , In_MaskD431_g251661 , In_MaskE431_g251661 , In_MaskF431_g251661 , In_MaskG431_g251661 , In_MaskH431_g251661 , In_MaskI431_g251661 , In_MaskJ431_g251661 , In_MaskK431_g251661 , In_MaskL431_g251661 , In_MaskM431_g251661 , In_MaskN431_g251661 );
					TVEMasksData Data456_g251662 =(TVEMasksData)Data431_g251661;
					float4 Out_MaskA456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskB456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskC456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskD456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskE456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskF456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskG456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskH456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskI456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskJ456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskK456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskL456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskM456_g251662 = float4( 0,0,0,0 );
					float4 Out_MaskN456_g251662 = float4( 0,0,0,0 );
					BreakTextureData( Data456_g251662 , Out_MaskA456_g251662 , Out_MaskB456_g251662 , Out_MaskC456_g251662 , Out_MaskD456_g251662 , Out_MaskE456_g251662 , Out_MaskF456_g251662 , Out_MaskG456_g251662 , Out_MaskH456_g251662 , Out_MaskI456_g251662 , Out_MaskJ456_g251662 , Out_MaskK456_g251662 , Out_MaskL456_g251662 , Out_MaskM456_g251662 , Out_MaskN456_g251662 );
					half2 UV276_g251662 = (Out_MaskA456_g251662).xy;
					float temp_output_504_0_g251662 = 0.0;
					half Bias276_g251662 = temp_output_504_0_g251662;
					half2 Normal276_g251662 = float2( 0,0 );
					half4 localSampleCoord276_g251662 = SampleCoord( Texture276_g251662 , Sampler276_g251662 , UV276_g251662 , Bias276_g251662 , Normal276_g251662 );
					float4 temp_output_407_277_g251639 = localSampleCoord276_g251662;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture502_g251662) = _MainAlbedoTex;
					SamplerState Sampler502_g251662 = staticSwitch36_g251644;
					half2 UV502_g251662 = (Out_MaskA456_g251662).zw;
					half Bias502_g251662 = temp_output_504_0_g251662;
					half2 Normal502_g251662 = float2( 0,0 );
					half4 localSampleCoord502_g251662 = SampleCoord( Texture502_g251662 , Sampler502_g251662 , UV502_g251662 , Bias502_g251662 , Normal502_g251662 );
					float4 temp_output_407_278_g251639 = localSampleCoord502_g251662;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture496_g251662) = _MainAlbedoTex;
					SamplerState Sampler496_g251662 = staticSwitch36_g251644;
					float2 temp_output_463_0_g251662 = (Out_MaskB456_g251662).zw;
					half2 XZ496_g251662 = temp_output_463_0_g251662;
					half Bias496_g251662 = temp_output_504_0_g251662;
					half3 NormalWS512_g251662 = (Out_MaskK456_g251662).xyz;
					half3 NormalWS496_g251662 = NormalWS512_g251662;
					half3 Normal496_g251662 = float3( 0,0,0 );
					half4 localSamplePlanar2D496_g251662 = SamplePlanar2D( Texture496_g251662 , Sampler496_g251662 , XZ496_g251662 , Bias496_g251662 , NormalWS496_g251662 , Normal496_g251662 );
					float4 temp_output_407_0_g251639 = localSamplePlanar2D496_g251662;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture490_g251662) = _MainAlbedoTex;
					SamplerState Sampler490_g251662 = staticSwitch36_g251644;
					float2 temp_output_462_0_g251662 = (Out_MaskB456_g251662).xy;
					half2 ZY490_g251662 = temp_output_462_0_g251662;
					half2 XZ490_g251662 = temp_output_463_0_g251662;
					float2 temp_output_464_0_g251662 = (Out_MaskC456_g251662).xy;
					half2 XY490_g251662 = temp_output_464_0_g251662;
					half Bias490_g251662 = temp_output_504_0_g251662;
					half3 Triplanar522_g251662 = (Out_MaskN456_g251662).xyz;
					half3 Triplanar490_g251662 = Triplanar522_g251662;
					half3 NormalWS490_g251662 = NormalWS512_g251662;
					half3 Normal490_g251662 = float3( 0,0,0 );
					half4 localSamplePlanar3D490_g251662 = SamplePlanar3D( Texture490_g251662 , Sampler490_g251662 , ZY490_g251662 , XZ490_g251662 , XY490_g251662 , Bias490_g251662 , Triplanar490_g251662 , NormalWS490_g251662 , Normal490_g251662 );
					float4 temp_output_407_201_g251639 = localSamplePlanar3D490_g251662;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture498_g251662) = _MainAlbedoTex;
					SamplerState Sampler498_g251662 = staticSwitch36_g251644;
					half2 XZ498_g251662 = temp_output_463_0_g251662;
					float2 temp_output_473_0_g251662 = (Out_MaskE456_g251662).xy;
					half2 XZ_1498_g251662 = temp_output_473_0_g251662;
					float2 temp_output_474_0_g251662 = (Out_MaskE456_g251662).zw;
					half2 XZ_2498_g251662 = temp_output_474_0_g251662;
					float2 temp_output_475_0_g251662 = (Out_MaskF456_g251662).xy;
					half2 XZ_3498_g251662 = temp_output_475_0_g251662;
					float temp_output_510_0_g251662 = exp2( temp_output_504_0_g251662 );
					half Bias498_g251662 = temp_output_510_0_g251662;
					float3 temp_output_480_0_g251662 = (Out_MaskI456_g251662).xyz;
					half3 Weights_2498_g251662 = temp_output_480_0_g251662;
					half3 NormalWS498_g251662 = NormalWS512_g251662;
					half3 Normal498_g251662 = float3( 0,0,0 );
					half4 localSampleStochastic2D498_g251662 = SampleStochastic2D( Texture498_g251662 , Sampler498_g251662 , XZ498_g251662 , XZ_1498_g251662 , XZ_2498_g251662 , XZ_3498_g251662 , Bias498_g251662 , Weights_2498_g251662 , NormalWS498_g251662 , Normal498_g251662 );
					float4 temp_output_407_202_g251639 = localSampleStochastic2D498_g251662;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture500_g251662) = _MainAlbedoTex;
					SamplerState Sampler500_g251662 = staticSwitch36_g251644;
					half2 ZY500_g251662 = temp_output_462_0_g251662;
					half2 ZY_1500_g251662 = (Out_MaskC456_g251662).zw;
					half2 ZY_2500_g251662 = (Out_MaskD456_g251662).xy;
					half2 ZY_3500_g251662 = (Out_MaskD456_g251662).zw;
					half2 XZ500_g251662 = temp_output_463_0_g251662;
					half2 XZ_1500_g251662 = temp_output_473_0_g251662;
					half2 XZ_2500_g251662 = temp_output_474_0_g251662;
					half2 XZ_3500_g251662 = temp_output_475_0_g251662;
					half2 XY500_g251662 = temp_output_464_0_g251662;
					half2 XY_1500_g251662 = (Out_MaskF456_g251662).zw;
					half2 XY_2500_g251662 = (Out_MaskG456_g251662).xy;
					half2 XY_3500_g251662 = (Out_MaskG456_g251662).zw;
					half Bias500_g251662 = temp_output_510_0_g251662;
					half3 Weights_1500_g251662 = (Out_MaskH456_g251662).xyz;
					half3 Weights_2500_g251662 = temp_output_480_0_g251662;
					half3 Weights_3500_g251662 = (Out_MaskJ456_g251662).xyz;
					half3 Triplanar500_g251662 = Triplanar522_g251662;
					half3 NormalWS500_g251662 = NormalWS512_g251662;
					half3 Normal500_g251662 = float3( 0,0,0 );
					half4 localSampleStochastic3D500_g251662 = SampleStochastic3D( Texture500_g251662 , Sampler500_g251662 , ZY500_g251662 , ZY_1500_g251662 , ZY_2500_g251662 , ZY_3500_g251662 , XZ500_g251662 , XZ_1500_g251662 , XZ_2500_g251662 , XZ_3500_g251662 , XY500_g251662 , XY_1500_g251662 , XY_2500_g251662 , XY_3500_g251662 , Bias500_g251662 , Weights_1500_g251662 , Weights_2500_g251662 , Weights_3500_g251662 , Triplanar500_g251662 , NormalWS500_g251662 , Normal500_g251662 );
					float4 temp_output_407_203_g251639 = localSampleStochastic3D500_g251662;
					#if defined( TVE_MAIN_SAMPLE_MAIN_UV )
					float4 staticSwitch184_g251639 = temp_output_407_277_g251639;
					#elif defined( TVE_MAIN_SAMPLE_EXTRA_UV )
					float4 staticSwitch184_g251639 = temp_output_407_278_g251639;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_2D )
					float4 staticSwitch184_g251639 = temp_output_407_0_g251639;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_3D )
					float4 staticSwitch184_g251639 = temp_output_407_201_g251639;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_2D )
					float4 staticSwitch184_g251639 = temp_output_407_202_g251639;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_3D )
					float4 staticSwitch184_g251639 = temp_output_407_203_g251639;
					#else
					float4 staticSwitch184_g251639 = temp_output_407_277_g251639;
					#endif
					half4 Local_AlbedoSample185_g251639 = staticSwitch184_g251639;
					float3 lerpResult53_g251639 = lerp( float3( 1,1,1 ) , (Local_AlbedoSample185_g251639).xyz , _MainAlbedoValue);
					half3 Local_AlbedoRGB107_g251639 = lerpResult53_g251639;
					float temp_output_17_0_g251659 = _MainMultiWriteMode;
					float Option91_g251659 = temp_output_17_0_g251659;
					float4 Model_VertexData418_g251639 = Out_VertexData15_g251640;
					float4 temp_output_84_0_g251659 = Model_VertexData418_g251639;
					float4 ChannelA91_g251659 = temp_output_84_0_g251659;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture276_g251647) = _MainShaderTex;
					#if defined( TVE_FILTER_DEFAULT )
					SamplerState staticSwitch38_g251646 = sampler_Linear_Repeat;
					#elif defined( TVE_FILTER_POINT )
					SamplerState staticSwitch38_g251646 = sampler_Point_Repeat;
					#elif defined( TVE_FILTER_LOW )
					SamplerState staticSwitch38_g251646 = sampler_Linear_Repeat;
					#elif defined( TVE_FILTER_MEDIUM )
					SamplerState staticSwitch38_g251646 = sampler_Linear_Repeat;
					#elif defined( TVE_FILTER_HIGH )
					SamplerState staticSwitch38_g251646 = sampler_Linear_Repeat_Aniso8;
					#else
					SamplerState staticSwitch38_g251646 = sampler_Linear_Repeat;
					#endif
					SamplerState Sampler276_g251647 = staticSwitch38_g251646;
					float localBreakTextureData456_g251647 = ( 0.0 );
					TVEMasksData Data456_g251647 =(TVEMasksData)Data431_g251661;
					float4 Out_MaskA456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskB456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskC456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskD456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskE456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskF456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskG456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskH456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskI456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskJ456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskK456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskL456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskM456_g251647 = float4( 0,0,0,0 );
					float4 Out_MaskN456_g251647 = float4( 0,0,0,0 );
					BreakTextureData( Data456_g251647 , Out_MaskA456_g251647 , Out_MaskB456_g251647 , Out_MaskC456_g251647 , Out_MaskD456_g251647 , Out_MaskE456_g251647 , Out_MaskF456_g251647 , Out_MaskG456_g251647 , Out_MaskH456_g251647 , Out_MaskI456_g251647 , Out_MaskJ456_g251647 , Out_MaskK456_g251647 , Out_MaskL456_g251647 , Out_MaskM456_g251647 , Out_MaskN456_g251647 );
					half2 UV276_g251647 = (Out_MaskA456_g251647).xy;
					float temp_output_504_0_g251647 = 0.0;
					half Bias276_g251647 = temp_output_504_0_g251647;
					half2 Normal276_g251647 = float2( 0,0 );
					half4 localSampleCoord276_g251647 = SampleCoord( Texture276_g251647 , Sampler276_g251647 , UV276_g251647 , Bias276_g251647 , Normal276_g251647 );
					float4 temp_output_405_277_g251639 = localSampleCoord276_g251647;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture502_g251647) = _MainShaderTex;
					SamplerState Sampler502_g251647 = staticSwitch38_g251646;
					half2 UV502_g251647 = (Out_MaskA456_g251647).zw;
					half Bias502_g251647 = temp_output_504_0_g251647;
					half2 Normal502_g251647 = float2( 0,0 );
					half4 localSampleCoord502_g251647 = SampleCoord( Texture502_g251647 , Sampler502_g251647 , UV502_g251647 , Bias502_g251647 , Normal502_g251647 );
					float4 temp_output_405_278_g251639 = localSampleCoord502_g251647;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture496_g251647) = _MainShaderTex;
					SamplerState Sampler496_g251647 = staticSwitch38_g251646;
					float2 temp_output_463_0_g251647 = (Out_MaskB456_g251647).zw;
					half2 XZ496_g251647 = temp_output_463_0_g251647;
					half Bias496_g251647 = temp_output_504_0_g251647;
					half3 NormalWS512_g251647 = (Out_MaskK456_g251647).xyz;
					half3 NormalWS496_g251647 = NormalWS512_g251647;
					half3 Normal496_g251647 = float3( 0,0,0 );
					half4 localSamplePlanar2D496_g251647 = SamplePlanar2D( Texture496_g251647 , Sampler496_g251647 , XZ496_g251647 , Bias496_g251647 , NormalWS496_g251647 , Normal496_g251647 );
					float4 temp_output_405_0_g251639 = localSamplePlanar2D496_g251647;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture490_g251647) = _MainShaderTex;
					SamplerState Sampler490_g251647 = staticSwitch38_g251646;
					float2 temp_output_462_0_g251647 = (Out_MaskB456_g251647).xy;
					half2 ZY490_g251647 = temp_output_462_0_g251647;
					half2 XZ490_g251647 = temp_output_463_0_g251647;
					float2 temp_output_464_0_g251647 = (Out_MaskC456_g251647).xy;
					half2 XY490_g251647 = temp_output_464_0_g251647;
					half Bias490_g251647 = temp_output_504_0_g251647;
					half3 Triplanar522_g251647 = (Out_MaskN456_g251647).xyz;
					half3 Triplanar490_g251647 = Triplanar522_g251647;
					half3 NormalWS490_g251647 = NormalWS512_g251647;
					half3 Normal490_g251647 = float3( 0,0,0 );
					half4 localSamplePlanar3D490_g251647 = SamplePlanar3D( Texture490_g251647 , Sampler490_g251647 , ZY490_g251647 , XZ490_g251647 , XY490_g251647 , Bias490_g251647 , Triplanar490_g251647 , NormalWS490_g251647 , Normal490_g251647 );
					float4 temp_output_405_201_g251639 = localSamplePlanar3D490_g251647;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture498_g251647) = _MainShaderTex;
					SamplerState Sampler498_g251647 = staticSwitch38_g251646;
					half2 XZ498_g251647 = temp_output_463_0_g251647;
					float2 temp_output_473_0_g251647 = (Out_MaskE456_g251647).xy;
					half2 XZ_1498_g251647 = temp_output_473_0_g251647;
					float2 temp_output_474_0_g251647 = (Out_MaskE456_g251647).zw;
					half2 XZ_2498_g251647 = temp_output_474_0_g251647;
					float2 temp_output_475_0_g251647 = (Out_MaskF456_g251647).xy;
					half2 XZ_3498_g251647 = temp_output_475_0_g251647;
					float temp_output_510_0_g251647 = exp2( temp_output_504_0_g251647 );
					half Bias498_g251647 = temp_output_510_0_g251647;
					float3 temp_output_480_0_g251647 = (Out_MaskI456_g251647).xyz;
					half3 Weights_2498_g251647 = temp_output_480_0_g251647;
					half3 NormalWS498_g251647 = NormalWS512_g251647;
					half3 Normal498_g251647 = float3( 0,0,0 );
					half4 localSampleStochastic2D498_g251647 = SampleStochastic2D( Texture498_g251647 , Sampler498_g251647 , XZ498_g251647 , XZ_1498_g251647 , XZ_2498_g251647 , XZ_3498_g251647 , Bias498_g251647 , Weights_2498_g251647 , NormalWS498_g251647 , Normal498_g251647 );
					float4 temp_output_405_202_g251639 = localSampleStochastic2D498_g251647;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture500_g251647) = _MainShaderTex;
					SamplerState Sampler500_g251647 = staticSwitch38_g251646;
					half2 ZY500_g251647 = temp_output_462_0_g251647;
					half2 ZY_1500_g251647 = (Out_MaskC456_g251647).zw;
					half2 ZY_2500_g251647 = (Out_MaskD456_g251647).xy;
					half2 ZY_3500_g251647 = (Out_MaskD456_g251647).zw;
					half2 XZ500_g251647 = temp_output_463_0_g251647;
					half2 XZ_1500_g251647 = temp_output_473_0_g251647;
					half2 XZ_2500_g251647 = temp_output_474_0_g251647;
					half2 XZ_3500_g251647 = temp_output_475_0_g251647;
					half2 XY500_g251647 = temp_output_464_0_g251647;
					half2 XY_1500_g251647 = (Out_MaskF456_g251647).zw;
					half2 XY_2500_g251647 = (Out_MaskG456_g251647).xy;
					half2 XY_3500_g251647 = (Out_MaskG456_g251647).zw;
					half Bias500_g251647 = temp_output_510_0_g251647;
					half3 Weights_1500_g251647 = (Out_MaskH456_g251647).xyz;
					half3 Weights_2500_g251647 = temp_output_480_0_g251647;
					half3 Weights_3500_g251647 = (Out_MaskJ456_g251647).xyz;
					half3 Triplanar500_g251647 = Triplanar522_g251647;
					half3 NormalWS500_g251647 = NormalWS512_g251647;
					half3 Normal500_g251647 = float3( 0,0,0 );
					half4 localSampleStochastic3D500_g251647 = SampleStochastic3D( Texture500_g251647 , Sampler500_g251647 , ZY500_g251647 , ZY_1500_g251647 , ZY_2500_g251647 , ZY_3500_g251647 , XZ500_g251647 , XZ_1500_g251647 , XZ_2500_g251647 , XZ_3500_g251647 , XY500_g251647 , XY_1500_g251647 , XY_2500_g251647 , XY_3500_g251647 , Bias500_g251647 , Weights_1500_g251647 , Weights_2500_g251647 , Weights_3500_g251647 , Triplanar500_g251647 , NormalWS500_g251647 , Normal500_g251647 );
					float4 temp_output_405_203_g251639 = localSampleStochastic3D500_g251647;
					#if defined( TVE_MAIN_SAMPLE_MAIN_UV )
					float4 staticSwitch198_g251639 = temp_output_405_277_g251639;
					#elif defined( TVE_MAIN_SAMPLE_EXTRA_UV )
					float4 staticSwitch198_g251639 = temp_output_405_278_g251639;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_2D )
					float4 staticSwitch198_g251639 = temp_output_405_0_g251639;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_3D )
					float4 staticSwitch198_g251639 = temp_output_405_201_g251639;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_2D )
					float4 staticSwitch198_g251639 = temp_output_405_202_g251639;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_3D )
					float4 staticSwitch198_g251639 = temp_output_405_203_g251639;
					#else
					float4 staticSwitch198_g251639 = temp_output_405_277_g251639;
					#endif
					half4 Local_ShaderSample199_g251639 = staticSwitch198_g251639;
					float2 appendResult428_g251639 = (float2((Local_AlbedoSample185_g251639).w , (Local_ShaderSample199_g251639).z));
					float2 temp_output_85_0_g251659 = appendResult428_g251639;
					float4 ChannelB91_g251659 = float4( temp_output_85_0_g251659, 0.0 , 0.0 );
					float localSwitchChannel691_g251659 = SwitchChannel6( Option91_g251659 , ChannelA91_g251659 , ChannelB91_g251659 );
					float clampResult17_g251657 = clamp( localSwitchChannel691_g251659 , 0.0001 , 0.9999 );
					float temp_output_7_0_g251658 = _MainMultiWriteRemap.x;
					float temp_output_9_0_g251658 = ( clampResult17_g251657 - temp_output_7_0_g251658 );
					half Local_MultiMask78_g251639 = saturate( ( temp_output_9_0_g251658 * _MainMultiWriteRemap.z ) );
					float lerpResult58_g251639 = lerp( 1.0 , Local_MultiMask78_g251639 , _MainColorMode);
					float4 lerpResult62_g251639 = lerp( _MainColorTwo , _MainColor , lerpResult58_g251639);
					half3 Local_ColorRGB93_g251639 = (lerpResult62_g251639).rgb;
					half3 Local_Albedo139_g251639 = ( Local_AlbedoRGB107_g251639 * Local_ColorRGB93_g251639 );
					float3 temp_output_4_0_g251641 = Local_Albedo139_g251639;
					float3 In_Albedo3_g251641 = temp_output_4_0_g251641;
					float3 temp_output_44_0_g251641 = Local_Albedo139_g251639;
					float3 In_AlbedoBase3_g251641 = temp_output_44_0_g251641;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture276_g251668) = _MainNormalTex;
					#if defined( TVE_FILTER_DEFAULT )
					SamplerState staticSwitch37_g251645 = sampler_Linear_Repeat;
					#elif defined( TVE_FILTER_POINT )
					SamplerState staticSwitch37_g251645 = sampler_Point_Repeat;
					#elif defined( TVE_FILTER_LOW )
					SamplerState staticSwitch37_g251645 = sampler_Linear_Repeat;
					#elif defined( TVE_FILTER_MEDIUM )
					SamplerState staticSwitch37_g251645 = sampler_Linear_Repeat_Aniso8;
					#elif defined( TVE_FILTER_HIGH )
					SamplerState staticSwitch37_g251645 = sampler_Linear_Repeat_Aniso8;
					#else
					SamplerState staticSwitch37_g251645 = sampler_Linear_Repeat;
					#endif
					SamplerState Sampler276_g251668 = staticSwitch37_g251645;
					float localBreakTextureData456_g251668 = ( 0.0 );
					TVEMasksData Data456_g251668 =(TVEMasksData)Data431_g251661;
					...
					float2 temp_output_406_394_g251639 = Normal276_g251668;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture502_g251668) = _MainNormalTex;
					SamplerState Sampler502_g251668 = staticSwitch37_g251645;
					...
					float2 temp_output_406_397_g251639 = Normal502_g251668;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture496_g251668) = _MainNormalTex;
					SamplerState Sampler496_g251668 = staticSwitch37_g251645;
					...
					float3 temp_output_35_0_g251671 = Normal496_g251668;
					half3 TangentWS519_g251668 = (Out_MaskL456_g251668).xyz;
					float dotResult84_g251671 = dot( temp_output_35_0_g251671 , TangentWS519_g251668 );
					half3 BitangentWS521_g251668 = (Out_MaskM456_g251668).xyz;
					float dotResult85_g251671 = dot( temp_output_35_0_g251671 , BitangentWS521_g251668 );
					float2 appendResult87_g251671 = (float2(dotResult84_g251671 , dotResult85_g251671));
					float2 temp_output_406_375_g251639 = appendResult87_g251671;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture490_g251668) = _MainNormalTex;
					SamplerState Sampler490_g251668 = staticSwitch37_g251645;
					...
					float3 temp_output_35_0_g251672 = Normal490_g251668;
					float dotResult84_g251672 = dot( temp_output_35_0_g251672 , TangentWS519_g251668 );
					float dotResult85_g251672 = dot( temp_output_35_0_g251672 , BitangentWS521_g251668 );
					float2 appendResult87_g251672 = (float2(dotResult84_g251672 , dotResult85_g251672));
					float2 temp_output_406_353_g251639 = appendResult87_g251672;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture498_g251668) = _MainNormalTex;
					SamplerState Sampler498_g251668 = staticSwitch37_g251645;
					...
					float3 temp_output_35_0_g251673 = Normal498_g251668;
					float dotResult84_g251673 = dot( temp_output_35_0_g251673 , TangentWS519_g251668 );
					float dotResult85_g251673 = dot( temp_output_35_0_g251673 , BitangentWS521_g251668 );
					float2 appendResult87_g251673 = (float2(dotResult84_g251673 , dotResult85_g251673));
					float2 temp_output_406_391_g251639 = appendResult87_g251673;
					UNITY_DECLARE_TEX2D_NOSAMPLER(Texture500_g251668) = _MainNormalTex;
					SamplerState Sampler500_g251668 = staticSwitch37_g251645;
					...
					float3 temp_output_35_0_g251669 = Normal500_g251668;
					float dotResult84_g251669 = dot( temp_output_35_0_g251669 , TangentWS519_g251668 );
					float dotResult85_g251669 = dot( temp_output_35_0_g251669 , BitangentWS521_g251668 );
					float2 appendResult87_g251669 = (float2(dotResult84_g251669 , dotResult85_g251669));
					float2 temp_output_406_390_g251639 = appendResult87_g251669;
					#if defined( TVE_MAIN_SAMPLE_MAIN_UV )
					float2 staticSwitch193_g251639 = temp_output_406_394_g251639;
					#elif defined( TVE_MAIN_SAMPLE_EXTRA_UV )
					float2 staticSwitch193_g251639 = temp_output_406_397_g251639;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_2D )
					float2 staticSwitch193_g251639 = temp_output_406_375_g251639;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_3D )
					float2 staticSwitch193_g251639 = temp_output_406_353_g251639;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_2D )
					float2 staticSwitch193_g251639 = temp_output_406_391_g251639;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_3D )
					float2 staticSwitch193_g251639 = temp_output_406_390_g251639;
					#else
					float2 staticSwitch193_g251639 = temp_output_406_394_g251639;
					#endif
					half2 Local_NormaSample191_g251639 = staticSwitch193_g251639;
					half2 Local_NormalTS108_g251639 = ( Local_NormaSample191_g251639 * _MainNormalValue );
					float2 In_NormalTS3_g251641 = Local_NormalTS108_g251639;
					float2 break80_g251660 = Local_NormalTS108_g251639;
					float3 temp_output_77_0_g251660 = Model_TangentWS366_g251639;
					float3 temp_output_78_0_g251660 = Model_BitangentWS367_g251639;
					float3 temp_output_76_0_g251660 = Model_NormalWS226_g251639;
					half3 Local_NormalWS250_g251639 = ( ( break80_g251660.x * temp_output_77_0_g251660 ) + ( break80_g251660.y * temp_output_78_0_g251660 ) + temp_output_76_0_g251660 );
					float3 In_NormalWS3_g251641 = Local_NormalWS250_g251639;
					float temp_output_209_0_g251639 = (Local_ShaderSample199_g251639).y;
					float temp_output_7_0_g251653 = _MainOcclusionRemap.x;
					float temp_output_9_0_g251653 = ( temp_output_209_0_g251639 - temp_output_7_0_g251653 );
					float lerpResult23_g251639 = lerp( 1.0 , saturate( ( temp_output_9_0_g251653 * _MainOcclusionRemap.z ) ) , _MainOcclusionValue);
					half Local_Occlusion313_g251639 = lerpResult23_g251639;
					float temp_output_213_0_g251639 = (Local_ShaderSample199_g251639).w;
					float temp_output_7_0_g251656 = _MainSmoothnessRemap.x;
					float temp_output_9_0_g251656 = ( temp_output_213_0_g251639 - temp_output_7_0_g251656 );
					half Local_Smoothness317_g251639 = ( saturate( ( temp_output_9_0_g251656 * _MainSmoothnessRemap.z ) ) * _MainSmoothnessValue );
					float4 appendResult73_g251639 = (float4(( (Local_ShaderSample199_g251639).x * _MainMetallicValue ) , Local_Occlusion313_g251639 , (Local_ShaderSample199_g251639).z , Local_Smoothness317_g251639));
					half4 Local_Masks109_g251639 = appendResult73_g251639;
					float4 In_Shader3_g251641 = Local_Masks109_g251639;
					float4 In_Feature3_g251641 = half4( 1, 1, 1, 1 );
					float4 In_Season3_g251641 = half4( 1, 1, 1, 1 );
					float4 In_Emissive3_g251641 = half4( 1, 1, 1, 1 );
					float3 temp_output_3_0_g251674 = Local_Albedo139_g251639;
					float dotResult20_g251674 = dot( temp_output_3_0_g251674 , float3( 0.2126, 0.7152, 0.0722 ) );
					half Local_Grayscale110_g251639 = dotResult20_g251674;
					float temp_output_12_0_g251641 = Local_Grayscale110_g251639;
					float In_Grayscale3_g251641 = temp_output_12_0_g251641;
					float temp_output_3_0_g251675 = Local_Grayscale110_g251639;
					float clampResult27_g251675 = clamp( saturate( ( temp_output_3_0_g251675 * 5.0 ) ) , 0.2 , 1.0 );
					half Local_Luminosity145_g251639 = clampResult27_g251675;
					float temp_output_16_0_g251641 = Local_Luminosity145_g251639;
					float In_Luminosity3_g251641 = temp_output_16_0_g251641;
					float In_MultiMask3_g251641 = Local_MultiMask78_g251639;
					float temp_output_187_0_g251639 = (Local_AlbedoSample185_g251639).w;
					#ifdef TVE_CLIPPING
					float staticSwitch236_g251639 = ( temp_output_187_0_g251639 - _MainAlphaClipValue );
					#else
					float staticSwitch236_g251639 = temp_output_187_0_g251639;
					#endif
					half Local_AlphaClip111_g251639 = staticSwitch236_g251639;
					float In_AlphaClip3_g251641 = Local_AlphaClip111_g251639;
					half Local_AlphaFade246_g251639 = (lerpResult62_g251639).a;
					float In_AlphaFade3_g251641 = Local_AlphaFade246_g251639;
					float3 temp_cast_24 = (1.0).xxx;
					float3 In_Translucency3_g251641 = temp_cast_24;
					float In_Transmission3_g251641 = 1.0;
					float In_Thickness3_g251641 = 0.0;
					float In_Diffusion3_g251641 = 0.0;
					float In_Depth3_g251641 = 0.0;
					BuildVisualData( Data3_g251641 , In_Dummy3_g251641 , In_Albedo3_g251641 , In_AlbedoBase3_g251641 , In_NormalTS3_g251641 , In_NormalWS3_g251641 , In_Shader3_g251641 , In_Feature3_g251641 , In_Season3_g251641 , In_Emissive3_g251641 , In_Grayscale3_g251641 , In_Luminosity3_g251641 , In_MultiMask3_g251641 , In_AlphaClip3_g251641 , In_AlphaFade3_g251641 , In_Translucency3_g251641 , In_Transmission3_g251641 , In_Thickness3_g251641 , In_Diffusion3_g251641 , In_Depth3_g251641 );
					TVEVisualData Data4_g251684 =(TVEVisualData)Data3_g251641;
					float Out_Dummy4_g251684 = 0.0;
					float3 Out_Albedo4_g251684 = float3( 0,0,0 );
					float3 Out_AlbedoBase4_g251684 = float3( 0,0,0 );
					float2 Out_NormalTS4_g251684 = float2( 0,0 );
					float3 Out_NormalWS4_g251684 = float3( 0,0,0 );
					float4 Out_Shader4_g251684 = float4( 0,0,0,0 );
					float4 Out_Feature4_g251684 = float4( 0,0,0,0 );
					float4 Out_Season4_g251684 = float4( 0,0,0,0 );
					float4 Out_Emissive4_g251684 = float4( 0,0,0,0 );
					float Out_MultiMask4_g251684 = 0.0;
					float Out_Grayscale4_g251684 = 0.0;
					float Out_Luminosity4_g251684 = 0.0;
					float Out_AlphaClip4_g251684 = 0.0;
					float Out_AlphaFade4_g251684 = 0.0;
					float3 Out_Translucency4_g251684 = float3( 0,0,0 );
					float Out_Transmission4_g251684 = 0.0;
					float Out_Thickness4_g251684 = 0.0;
					float Out_Diffusion4_g251684 = 0.0;
					float Out_Depth4_g251684 = 0.0;
					BreakVisualData( Data4_g251684 , Out_Dummy4_g251684 , Out_Albedo4_g251684 , Out_AlbedoBase4_g251684 , Out_NormalTS4_g251684 , Out_NormalWS4_g251684 , Out_Shader4_g251684 , Out_Feature4_g251684 , Out_Season4_g251684 , Out_Emissive4_g251684 , Out_MultiMask4_g251684 , Out_Grayscale4_g251684 , Out_Luminosity4_g251684 , Out_AlphaClip4_g251684 , Out_AlphaFade4_g251684 , Out_Translucency4_g251684 , Out_Transmission4_g251684 , Out_Thickness4_g251684 , Out_Diffusion4_g251684 , Out_Depth4_g251684 );
					float Alpha109_g251679 = Out_AlphaClip4_g251684;
					float lerpResult91_g251679 = lerp( 1.0 , Alpha109_g251679 , ( TVE_DEBUG_Clip * _RenderClip ));
					float lerpResult154_g251679 = lerp( 1.0 , lerpResult91_g251679 , Filter152_g251679);
					clip( lerpResult154_g251679 );
					...
					half Metallic = temp_output_2433_114;
					half Smoothness = temp_output_2433_114;
					half Occlusion = 1;
					...
					o.Emission = ( lerpResult72_g251679 * lerpResult84_g251679 );
					o.Alpha = 1;
					half3 BakedGI = 0;
		...
		Pass
		{
			...
			CGPROGRAM
				...
				v2f VertexFunction (appdata v  ) {
					...
					float3 vertexPos57_g251679 = v.vertex.xyz;
					float4 ase_positionCS57_g251679 = UnityObjectToClipPos( vertexPos57_g251679 );
					o.ase_texcoord4 = ase_positionCS57_g251679;
					...
					float4 vertexToFrag1901_g251635 = Out_Interpolator1902_g251635;
					o.ase_texcoord8 = vertexToFrag1901_g251635;
				...
				)
				{
					...
					float temp_output_65_0_g251679 = ( 1.0 - saturate( dotResult61_g251679 ) );
					float Shading_Fresnel59_g251679 = (( 1.0 - ( temp_output_65_0_g251679 * temp_output_65_0_g251679 ) )*0.3 + 0.7);
					float4 ase_positionCS57_g251679 = IN.ase_texcoord4;
					float depthLinearEye57_g251679 = LinearEyeDepth( ase_positionCS57_g251679.z / ase_positionCS57_g251679.w );
					float temp_output_69_0_g251679 = saturate(  (0.0 + ( depthLinearEye57_g251679 - 300.0 ) * ( 1.0 - 0.0 ) / ( 0.0 - 300.0 ) ) );
					float Shading_Distance58_g251679 = (( temp_output_69_0_g251679 * temp_output_69_0_g251679 )*0.5 + 0.5);
					float lerpResult84_g251679 = lerp( 1.0 , Shading_Fresnel59_g251679 , ( Shading_Distance58_g251679 * TVE_DEBUG_Shading ));
					...
					float4 In_CoordsData16_g251638 = Out_CoordsData15_g251637;
					float4 In_VertexData16_g251638 = Out_VertexData15_g251637;
					float4 vertexToFrag1901_g251635 = IN.ase_texcoord8;
					float4 In_Interpolator16_g251638 = vertexToFrag1901_g251635;
					BuildModelFragData( Data16_g251638 , In_Dummy16_g251638 , In_PositionWS16_g251638 , In_PositionWO16_g251638 , In_PivotWS16_g251638 , In_PivotWO16_g251638 , In_NormalWS16_g251638 , In_TangentWS16_g251638 , In_BitangentWS16_g251638 , In_TriplanarWeights16_g251638 , In_ViewDirWS16_g251638 , In_CoordsData16_g251638 , In_VertexData16_g251638 , In_Interpolator16_g251638 );
					TVEModelData Data15_g251640 =(TVEModelData)Data16_g251638;
					float Out_Dummy15_g251640 = 0.0;
...
/*ASEBEGIN
Version=19912
{"type":"AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor","id":2422,"pos":[-6208,-5696],"params":["Half","False","Model Frag","-1","True","1","0","OBJECT","","False","1","OBJECT","0"]}
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2423,"pos":[-5760,-5760],"params":["Inherit","False","2422","Model Frag","1","0","OBJECT","","False","1","OBJECT","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2425,"pos":[-5504,-5760],"params":["Inherit","False","Block Global","47","","240632","212e17d4006dc88449d56ce0340cb5ff","46,385,1,692,1,667,1,276,1,396,1,417,1,282,1,402,1,560,1,285,1,283,1,308,1,650,1,483,0,484,0,486,0,488,0,561,0,487,0,652,0,482,0,485,0,668,0,691,0,315,1,703,1,719,1,716,1,715,1,709,1,710,1,706,1,701,1,704,1,707,1,655,0,311,1,317,1,421,1,321,1,398,1,700,0,694,1,713,1,404,1,675,0","1","206","OBJECT","0,0,0,0","False","1","OBJECT","151"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2421,"pos":[-6528,-5760],"params":["Inherit","False","Block Model","7","","240733","7ad7765e793a6714babedee0033c36e9","19,463,1,289,1,240,1,437,1,291,1,431,1,404,1,290,1,181,0,183,0,185,0,184,0,188,0,190,0,192,0,189,0,300,0,419,0,193,0","11","102","FLOAT3","0,0,0","False","163","FLOAT3","0,0,0","False","186","FLOAT3","0,0,0","False","187","FLOAT3","0,0,0","False","166","FLOAT3","0,0,0","False","164","FLOAT3","0,0,0","False","301","FLOAT3","0,0,0","False","418","FLOAT3","0,0,0","False","167","FLOAT4","0,0,0,0","False","172","FLOAT4","0,0,0,0","False","175","FLOAT4","0,0,0,0","False","2","OBJECT","128","OBJECT","314"]}
{"type":"AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor","id":2426,"pos":[-5184,-5760],"params":["Half","False","Global Data","-1","True","1","0","OBJECT","","False","1","OBJECT","0"]}
{"type":"AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor","id":2424,"pos":[-6208,-5760],"params":["Half","False","Model Vert","-1","True","1","0","OBJECT","","False","1","OBJECT","0"]}
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2442,"pos":[-4736,-5760],"params":["Inherit","False","2424","Model Vert","1","0","OBJECT","","False","1","OBJECT","0"]}
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2443,"pos":[-4736,-5696],"params":["Inherit","False","2426","Global Data","1","0","OBJECT","","False","1","OBJECT","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2441,"pos":[-4480,-5760],"params":["Inherit","False","Block Vertex","-1","","251551","79888a886ac7456468e9ffe3eda11f4f","0","2","1894","OBJECT","0,0,0,0","False","1896","OBJECT","0,0,0,0","False","3","OBJECT","128","OBJECT","1895","OBJECT","1897"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2428,"pos":[-4096,-5760],"params":["Inherit","False","Block Pivots Sub","-1","","251554","186f08b1bbe15894d9c677d50398679b","0","3","224","OBJECT","0,0,0,0","False","146","OBJECT","0,0,0,0","False","231","OBJECT","0,0,0,0","False","3","OBJECT","128","OBJECT","229","OBJECT","232"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2430,"pos":[-3712,-5760],"params":["Inherit","False","Block Blanket Conform","126","","251558","3ce1684c4351aeb42b79a955aa483301","2,389,0,377,1","3","146","OBJECT","0,0,0,0","False","397","OBJECT","0,0,0,0","False","186","OBJECT","0,0,0,0","False","3","OBJECT","128","OBJECT","398","OBJECT","399"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2434,"pos":[-3328,-5760],"params":["Inherit","False","Block Transform","-1","","251569","5ac6202bdddd8b34a85c261af6b8de8b","0","3","146","OBJECT","0,0,0,0","False","1620","OBJECT","0,0,0,0","False","1619","OBJECT","0,0,0,0","False","3","OBJECT","128","OBJECT","1617","OBJECT","1618"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2431,"pos":[-2944,-5760],"params":["Inherit","False","Block Pivots Add","-1","","251580","016babe9e3e643242aa4d123a988150c","0","3","146","OBJECT","0,0,0,0","False","225","OBJECT","0,0,0,0","False","227","OBJECT","0,0,0,0","False","3","OBJECT","128","OBJECT","226","OBJECT","228"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":2401,"pos":[-256,-6016],"params":["Inherit","False","Property","_IsShaderType","_IsShaderType","46","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor","id":2432,"pos":[-2624,-5760],"params":["Half","False","Vertex Data","-1","True","1","0","OBJECT","","False","1","OBJECT","0"]}
{"type":"AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor","id":2402,"pos":[0,-6016],"params":["Half","False","IsShaderType","-1","True","1","0","FLOAT","0","False","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":2395,"pos":[-256,-5760],"params":["Inherit","False","Constant","_Color13","Color 0","10","0","Create","True","0","0","0","False","0","False","Object","-1","","0.9254902,0.7960784,0.4156863,1","0,0,0,0","True","True","0","6","COLOR","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":2398,"pos":[-256,-5504],"params":["Inherit","False","Constant","_Color14","Color 10","10","0","Create","True","0","0","0","False","0","False","Object","-1","","0.6196079,0.7686275,0.1490196,0","0,0,0,0","True","True","0","6","COLOR","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2407,"pos":[0,-5632],"params":["Inherit","False","2402","IsShaderType","1","0","OBJECT","","False","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2409,"pos":[0,-5376],"params":["Inherit","False","2402","IsShaderType","1","0","OBJECT","","False","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2410,"pos":[0,-5120],"params":["Inherit","False","2402","IsShaderType","1","0","OBJECT","","False","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2413,"pos":[0,-4864],"params":["Inherit","False","2402","IsShaderType","1","0","OBJECT","","False","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":2412,"pos":[-256,-4992],"params":["Inherit","False","Constant","_Color21","Color 4","10","0","Create","True","0","0","0","False","0","False","Object","-1","","0.8117647,0.3490196,0.2627451,0","0,0,0,0","True","True","0","6","COLOR","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2444,"pos":[-2176,-5632],"params":["Inherit","False","2426","Global Data","1","0","OBJECT","","False","1","OBJECT","0"]}
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2445,"pos":[-2176,-5696],"params":["Inherit","False","2422","Model Frag","1","0","OBJECT","","False","1","OBJECT","0"]}
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2447,"pos":[-2176,-5760],"params":["Inherit","False","2432","Vertex Data","1","0","OBJECT","","False","1","OBJECT","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2406,"pos":[256,-5760],"params":["Inherit","False","Tool Branch","-1","","251584","d4048633f69bd3f44beb2beef049f6d2","0","3","39","FLOAT3","0,0,0","False","34","FLOAT","0","False","36","FLOAT","1","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2408,"pos":[256,-5504],"params":["Inherit","False","Tool Branch","-1","","251585","d4048633f69bd3f44beb2beef049f6d2","0","3","39","FLOAT3","0,0,0","False","34","FLOAT","0","False","36","FLOAT","2","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2411,"pos":[256,-5248],"params":["Inherit","False","Tool Branch","-1","","251586","d4048633f69bd3f44beb2beef049f6d2","0","3","39","FLOAT3","0,0,0","False","34","FLOAT","0","False","36","FLOAT","3","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2414,"pos":[256,-4992],"params":["Inherit","False","Tool Branch","-1","","251587","d4048633f69bd3f44beb2beef049f6d2","0","3","39","FLOAT3","0,0,0","False","34","FLOAT","0","False","36","FLOAT","4","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2446,"pos":[-1920,-5760],"params":["Inherit","False","Block Visual","-1","","251635","9511980f05dcfdf4d8967cd55c0d1784","1,1910,1","3","1904","OBJECT","0,0,0,0","False","1894","OBJECT","0,0,0,0","False","1896","OBJECT","0,0,0,0","False","3","OBJECT","1900","OBJECT","1895","OBJECT","1897"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2376,"pos":[-1536,-5760],"params":["Inherit","False","Block Main","20","","251639","b04cfed9a7b4c0841afdb49a38c282c5","13,65,1,136,1,41,1,133,1,40,1,344,0,347,0,342,0,346,0,343,0,345,0,329,1,408,1","3","430","OBJECT","0,0,0,0","False","225","OBJECT","0,0,0,0","False","414","OBJECT","0,0,0,0","False","3","OBJECT","106","OBJECT","417","OBJECT","415"]}
...
{"type":"AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor","id":2416,"pos":[-1216,-5760],"params":["Half","False","Visual Data","-1","True","1","0","OBJECT","0","False","1","OBJECT","0"]}
...
{"type":"AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor","id":2417,"pos":[2304,-5632],"params":["Inherit","False","2432","Vertex Data","1","0","OBJECT","","False","1","OBJECT","0"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2383,"pos":[2944,-5888],"params":["Inherit","False","Base Compile","-1","","251678","e67c8238031dbf04ab79a5d4d63d1b4f","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":2433,"pos":[2560,-5760],"params":["Inherit","False","Tool Debug Color","0","","251679","d992d3ed4a7539141ba053d3e0c12277","0","3","80","FLOAT3","0,0,0","False","106","OBJECT","0,0,0","False","107","OBJECT","0,0,0","False","5","FLOAT","114","FLOAT3","0","FLOAT3","113","FLOAT3","148","FLOAT4","149"]}
...
{"wire":[2414,39,2412,5]}
{"wire":[2414,34,2413,0]}
{"wire":[2446,1904,2447,0]}
{"wire":[2446,1894,2445,0]}
{"wire":[2446,1896,2444,0]}
{"wire":[2376,430,2446,1900]}
{"wire":[2376,225,2446,1895]}
{"wire":[2376,414,2446,1897]}
{"wire":[2400,0,2406,0]}
{"wire":[2400,1,2408,0]}
{"wire":[2400,2,2411,0]}
{"wire":[2400,3,2414,0]}
...
{"wire":[1800,0,1843,0]}
{"wire":[2433,80,2380,0]}
{"wire":[2433,106,2381,0]}
{"wire":[2433,107,2417,0]}
{"wire":[2354,0,2433,114]}
{"wire":[2354,4,2433,114]}
{"wire":[2354,5,2433,114]}
{"wire":[2354,2,2433,0]}
{"wire":[2354,15,2433,113]}
{"wire":[2354,16,2433,148]}
{"wire":[2354,17,2433,149]}
ASEEND*/
//CHKSM=53FB9E4B43D19617B9C6973A8E52F201614158EF