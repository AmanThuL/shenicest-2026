...
Shader "BOXOPHOBIC/The Visual Engine/Elements/Coat Layer"
{
	Properties
	{
		[StyledMessage(Info, Use Layer elements to control the Layer feature intensity. Element Texture A and Particle Color A are used as alpha masks., 0, 15)] _ElementMessage( "Element Message", Float ) = 0
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsCoatLayer
			...
			v2f vert ( appdata v )
			{
				...
				half smoothstepResult2286_g24059 = smoothstep( 0.0 , 1.0 , saturate( ( temp_output_9_0_g77044 * _SeasonRemap.z ) ));
				half SeasonLerp54_g24059 = smoothstepResult2286_g24059;
				half lerpResult168_g24059 = lerp( Value_Winter158_g24059 , Value_Spring159_g24059 , SeasonLerp54_g24059);
				half TVE_SeasonOptions_Y51_g24059 = TVE_SeasonOption.y;
				half Value_Summer160_g24059 = _AdditionalValue3;
				half lerpResult167_g24059 = lerp( Value_Spring159_g24059 , Value_Summer160_g24059 , SeasonLerp54_g24059);
				half TVE_SeasonOptions_Z52_g24059 = TVE_SeasonOption.z;
				half Value_Autumn161_g24059 = _AdditionalValue4;
				half lerpResult166_g24059 = lerp( Value_Summer160_g24059 , Value_Autumn161_g24059 , SeasonLerp54_g24059);
				half TVE_SeasonOptions_W53_g24059 = TVE_SeasonOption.w;
				half lerpResult165_g24059 = lerp( Value_Autumn161_g24059 , Value_Winter158_g24059 , SeasonLerp54_g24059);
				half temp_output_175_0_g24059 = ( ( TVE_SeasonOptions_X50_g24059 * lerpResult168_g24059 ) + ( TVE_SeasonOptions_Y51_g24059 * lerpResult167_g24059 ) + ( TVE_SeasonOptions_Z52_g24059 * lerpResult166_g24059 ) + ( TVE_SeasonOptions_W53_g24059 * lerpResult165_g24059 ) );
				half vertexToFrag11_g76972 = temp_output_175_0_g24059;
				...
				half2 vertexToFrag11_g77047 = ( ( lerpResult1899_g24059 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g77047;
				half2 appendResult60_g77068 = (half2(ase_positionWS.x , ase_positionWS.z));
				half2 lerpResult58_g77068 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult60_g77068 , _ElementMaskCoordMode);
				half2 vertexToFrag11_g77071 = ( ( lerpResult58_g77068 * (_ElementMaskCoordValue).xy ) + (_ElementMaskCoordValue).zw );
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half Value_Seasons1721_g24059 = vertexToFrag11_g76972;
				...
				half4 MainTex_RGBA587_g24059 = tex2D( _MainTex, vertexToFrag11_g77047 );
				half3 temp_output_6_0_g77050 = (MainTex_RGBA587_g24059).rgb;
				half SpaceTexture2395_g24059 = _SpaceTexture;
				half temp_output_7_0_g77050 = SpaceTexture2395_g24059;
				#ifdef TVE_DUMMY
				...
				half3 temp_output_1765_0_g24059 = saturate( ( temp_output_9_0_g77048 * _MainTexColorRemap.z ) );
				...
				half temp_output_468_0_g24059 = ( lerpResult181_g24059 * Element_Value1744_g24059 );
				half3 appendResult2402_g24059 = (half3(temp_output_468_0_g24059 , temp_output_468_0_g24059 , temp_output_468_0_g24059));
				half3 FInal_RGB213_g24059 = appendResult2402_g24059;
				half Element_Intensity2580_g24059 = _ElementIntensity;
				half temp_output_6_0_g77051 = (MainTex_RGBA587_g24059).a;
				half temp_output_7_0_g77051 = SpaceTexture2395_g24059;
				#ifdef TVE_DUMMY
				...
				half Element_Remap_A74_g24059 = saturate( ( temp_output_9_0_g77049 * _MainTexAlphaRemap.z ) );
				...
				half temp_output_7_0_g77053 = SpaceTexture2395_g24059;
				#ifdef TVE_DUMMY
				...
				half Element_Falloff1883_g24059 = saturate( ( temp_output_9_0_g77043 * _MainTexFalloffRemap.z ) );
				...
				#endif
				half2 vertexToFrag11_g77071 = i.ase_texcoord2.zw;
				half4 MainTex_RGBA53_g77068 = tex2D( _ElementMaskTex, vertexToFrag11_g77071 );
				half lerpResult148_g77068 = lerp( (MainTex_RGBA53_g77068).r , (MainTex_RGBA53_g77068).a , _ElementMaskMode);
				half clampResult17_g77077 = clamp( lerpResult148_g77068 , 0.0001 , 0.9999 );
				half temp_output_7_0_g77078 = _ElementMaskRemap.x;
				half temp_output_9_0_g77078 = ( clampResult17_g77077 - temp_output_7_0_g77078 );
				half lerpResult73_g77068 = lerp( 1.0 , saturate( ( temp_output_9_0_g77078 * _ElementMaskRemap.z ) ) , _ElementMaskValue);
				half Blend_Mask45_g77068 = lerpResult73_g77068;
				#ifdef TVE_ELEMENT_MASK
				half staticSwitch159_g77068 = Blend_Mask45_g77068;
				#else
				half staticSwitch159_g77068 = 1.0;
				#endif
				half3 ase_normalWS = i.ase_texcoord3.xyz;
				half4 appendResult108_g77068 = (half4(_TerrainPosition.x , _TerrainPosition.z , _TerrainSize.x , _TerrainSize.z));
				half4 Terrain_Coords111_g77068 = appendResult108_g77068;
				half4 temp_output_35_0_g77076 = Terrain_Coords111_g77068;
				...
				half2 temp_output_65_0_g77076 = ( ( (WorldPosition).xz * FinalScale53_g77076 ) + FinalPosition58_g77076 );
				half Terrain_InputMode136_g77068 = _TerrainInputMode;
				half3 lerpResult141_g77068 = lerp( ase_normalWS , tex2D( _TerrainNormalTex, temp_output_65_0_g77076 ).rgb , Terrain_InputMode136_g77068);
				half3 Terrain_Normal107_g77068 = lerpResult141_g77068;
				half dotResult113_g77068 = dot( Terrain_Normal107_g77068 , half3( 0, 1, 0 ) );
				half clampResult17_g77073 = clamp( dotResult113_g77068 , 0.0001 , 0.9999 );
				half temp_output_7_0_g77074 = _ElementProjRemap.x;
				half temp_output_9_0_g77074 = ( clampResult17_g77073 - temp_output_7_0_g77074 );
				half lerpResult123_g77068 = lerp( 1.0 , saturate( ( temp_output_9_0_g77074 * _ElementProjRemap.z ) ) , _ElementProjValue);
				half Blend_Proj117_g77068 = lerpResult123_g77068;
				#ifdef TVE_ELEMENT_PROJ
				half staticSwitch160_g77068 = Blend_Proj117_g77068;
				#else
				half staticSwitch160_g77068 = 1.0;
				#endif
				half4 temp_output_35_0_g77069 = Terrain_Coords111_g77068;
				...
				half2 temp_output_65_0_g77069 = ( ( (WorldPosition).xz * FinalScale53_g77069 ) + FinalPosition58_g77069 );
				half4 temp_output_70_0_g77069 = _TerrainHeightTex_TexelSize;
				...
				half temp_output_90_0_g77068 = ( ( (Terrain_Height_Raw104_g77068).r + ( (Terrain_Height_Raw104_g77068).g * 256.0 ) ) / 257.0 );
				#ifdef SHADER_API_VULKAN
				half staticSwitch91_g77068 = temp_output_90_0_g77068;
				#else
				half staticSwitch91_g77068 = (Terrain_Height_Raw104_g77068).r;
				#endif
				#ifdef SHADER_API_GLES
				half staticSwitch92_g77068 = temp_output_90_0_g77068;
				#else
				half staticSwitch92_g77068 = staticSwitch91_g77068;
				#endif
				#ifdef SHADER_API_GLES3
				half staticSwitch93_g77068 = temp_output_90_0_g77068;
				#else
				half staticSwitch93_g77068 = staticSwitch92_g77068;
				#endif
				float Terrain_Height_Platform105_g77068 = staticSwitch93_g77068;
				half Terrain_SizeY109_g77068 = _TerrainSize.y;
				half Terrain_PosY110_g77068 = _TerrainPosition.y;
				half lerpResult137_g77068 = lerp( WorldPosition.y , ( ( Terrain_Height_Platform105_g77068 * Terrain_SizeY109_g77068 * 2.0 ) + Terrain_PosY110_g77068 ) , Terrain_InputMode136_g77068);
				float Terrain_Height106_g77068 = lerpResult137_g77068;
				half temp_output_7_0_g77075 = _ElementPosMaxValue;
				half temp_output_9_0_g77075 = ( Terrain_Height106_g77068 - temp_output_7_0_g77075 );
				half lerpResult129_g77068 = lerp( 1.0 , saturate( ( temp_output_9_0_g77075 / ( ( _ElementPosMinValue - temp_output_7_0_g77075 ) + 0.0001 ) ) ) , _ElementPosValue);
				half Blend_Pos131_g77068 = lerpResult129_g77068;
				#ifdef TVE_ELEMENT_POS
				half staticSwitch161_g77068 = Blend_Pos131_g77068;
				#else
				half staticSwitch161_g77068 = 1.0;
				#endif
				half temp_output_6_0_g77079 = ( staticSwitch159_g77068 * staticSwitch160_g77068 * staticSwitch161_g77068 );
				half Dummy144_g77068 = ( _MaskingCategory + _MaskingEnd + ( _MaskingTerrainInfo + _MaskingModelInfo ) );
				half temp_output_7_0_g77079 = Dummy144_g77068;
				#ifdef TVE_DUMMY
				half staticSwitch14_g77079 = ( temp_output_6_0_g77079 + temp_output_7_0_g77079 );
				#else
				half staticSwitch14_g77079 = temp_output_6_0_g77079;
				#endif
				half temp_output_145_0_g77068 = staticSwitch14_g77079;
				...
				#endif
				half Element_Alpha56_g24059 = ( Element_Intensity2580_g24059 * Element_Remap_A74_g24059 * Element_Params_A1737_g24059 * i.ase_color.a * Element_Falloff1883_g24059 * staticSwitch14_g76930 * temp_output_145_0_g77068 * staticSwitch14_g76982 );
				half Final_A241_g24059 = Element_Alpha56_g24059;
				half4 appendResult882_g24059 = (half4(FInal_RGB213_g24059 , Final_A241_g24059));
				
				
				finalColor = appendResult882_g24059;
				return finalColor;
			}
			ENDCG
		}
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsCoatLayer
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half Element_Alpha56_g24059 = ( Element_Intensity2580_g24059 * Element_Remap_A74_g24059 * Element_Params_A1737_g24059 * i.ase_color.a * Element_Falloff1883_g24059 * staticSwitch14_g76930 * temp_output_145_0_g77068 * staticSwitch14_g76982 );
				half Final_A241_g24059 = Element_Alpha56_g24059;
				half4 appendResult2468_g24059 = (half4(FInal_RGB213_g24059 , Final_A241_g24059));
				half4 Input_Visual94_g77135 = appendResult2468_g24059;
				half clampResult80_g77135 = clamp( (Input_Visual94_g77135).x , 0.1 , 10000.0 );
				half3 appendResult139_g77135 = (half3(clampResult80_g77135 , clampResult80_g77135 , clampResult80_g77135));
				half3 color172 = IsGammaSpace() ? half3( 0.9803922, 0.3019608, 0.1607843 ) : half3( 0.9559735, 0.07421358, 0.02217388 );
				half3 Input_Tint76_g77135 = color172;
				half3 Element_Color47_g77135 = saturate( ( appendResult139_g77135 * Input_Tint76_g77135 ) );
				half4 appendResult131_g77135 = (half4(Element_Color47_g77135 , (Input_Visual94_g77135).w));
				
				
				finalColor = appendResult131_g77135;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=19912
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":167,"pos":[-640,-1152],"params":["Inherit","False","Element Type Coat","1","","24056","4e3b30f5ed0011b43b960e98331fd8e6","0","0","1","FLOAT","4"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":165,"pos":[-384,-1152],"params":["Inherit","False","Element Shader","11","","24059","0e972c73cae2ee54ea51acc9738801d0","15,1778,1,477,1,478,0,1824,0,1814,0,145,0,1784,0,481,0,2614,0,2618,0,1904,1,1907,1,2377,1,2310,1,2311,1","2","1974","FLOAT","1","False","2378","FLOAT","1","False","2","FLOAT4","0","FLOAT4","1779"]}
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":172,"pos":[-384,-1024],"params":["Inherit","False","Constant","_Color12","Color 1","63","0","Create","True","0","0","0","False","0","False","Object","-1","","0.9803922,0.3019608,0.1607843,1","0,0,0,0","True","False","0","6","FLOAT3","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":171,"pos":[-128,-1024],"params":["Inherit","False","Element Visuals","-1","","77135","78cf0f00cfd72824e84597f2db54a76e","1,64,1","2","59","FLOAT4","0,0,0,0","False","77","FLOAT3","1,1,1","False","1","FLOAT4","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":124,"pos":[64,-1408],"params":["Inherit","False","Element Compile","-1","","77136","5302407fc6d65554791e558e67d59358","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":111,"pos":[-640,-1408],"params":["Half","False","Property","_ElementMessage","Element Message","0","0","Create","True","0","0","0","True","1","StyledMessage(Info, Use Layer elements to control the Layer feature intensity. Element Texture A and Particle Color A are used as alpha masks., 0, 15)","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor","id":168,"pos":[-64,-1152],"params":["Float","False","False","-1","3","AmplifyShaderEditor.MaterialInspector","100","1","New Amplify Shader","f4f273c3bb6262d4396be458405e60f9","True","VolumePass1","0","1","VolumePass1","2","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","True","1","RenderType=Opaque=RenderType","False","False","0","False","True","0","1","False","","0","False","","0","1","False","","0","False","","True","0","False","","0","False","","False","False","False","False","False","False","False","False","False","True","0","False","","False","True","0","False","","False","True","True","True","True","True","0","False","","False","False","False","False","False","False","False","True","False","0","False","","255","False","","255","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","False","True","1","False","","True","3","False","","True","True","0","False","","0","False","","True","1","False","","True","1","LightMode=VolumePass1","True","2","False","0","","0","0","Standard","0","False","0"]}
{"type":"AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor","id":169,"pos":[-64,-1152],"params":["Float","False","False","-1","3","AmplifyShaderEditor.MaterialInspector","100","1","New Amplify Shader","f4f273c3bb6262d4396be458405e60f9","True","VolumePass2","0","2","VolumePass2","2","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","True","1","RenderType=Opaque=RenderType","False","False","0","False","True","0","1","False","","0","False","","0","1","False","","0","False","","True","0","False","","0","False","","False","False","False","False","False","False","False","False","False","True","0","False","","False","True","0","False","","False","True","True","True","True","True","0","False","","False","False","False","False","False","False","False","True","False","0","False","","255","False","","255","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","False","True","1","False","","True","3","False","","True","True","0","False","","0","False","","True","1","False","","True","1","LightMode=VolumePass2","True","2","False","0","","0","0","Standard","0","False","0"]}
{"type":"AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor","id":134,"pos":[64,-1152],"params":["Half","False","True","-1","2","TheVisualEngine.ElementGUI","100","2","BOXOPHOBIC/The Visual Engine/Elements/Coat Layer","f4f273c3bb6262d4396be458405e60f9","True","VolumePass","0","0","VolumePass","2","True","False","False","False","False","False","False","False","False","False","False","False","False","False","False","True","False","False","False","False","False","False","False","False","False","True","False","False","False","False","True","3","RenderType=Transparent=RenderType","Queue=Transparent=Queue=0","DisableBatching=True=DisableBatching","False","False","0","True","True","2","5","False","","10","False","","0","1","False","","0","False","","True","0","False","","0","False","","False","False","False","False","False","False","False","False","False","True","0","False","","False","True","0","False","","True","True","True","False","False","False","0","False","","False","False","False","False","False","False","False","True","False","0","False","","255","False","","255","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","True","True","2","False","","True","0","False","","True","False","0","False","","0","False","","True","1","False","","True","1","LightMode=VolumePass","True","2","False","0","","0","0","Standard","3","VolumePass1","0","0","VolumePass2","0","0","Vertex Position","1","0","0","4","True","False","False","True","False","","False","0"]}
...
{"wire":[165,1974,167,4]}
{"wire":[171,59,165,1779]}
{"wire":[171,77,172,0]}
{"wire":[134,0,165,0]}
{"wire":[135,0,171,0]}
ASEEND*/
//CHKSM=A61710EE63A9F08A0D196E649CE8B68957BF9F47