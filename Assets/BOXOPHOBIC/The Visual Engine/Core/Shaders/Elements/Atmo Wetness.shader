...
Shader "BOXOPHOBIC/The Visual Engine/Elements/Atmo Wetness"
{
	Properties
	{
		[StyledMessage(Info, Use Wetness elements to control the global wetness effect on vegetation and props. Element Texture R and Particle Color R are used as value multipliers. Element Texture A and Particle Color A are used as alpha masks., 0, 15)] _ElementMessage( "Element Message", Float ) = 0
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoWetness
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half Element_Intensity2580_g24346 = _ElementIntensity;
				...
				#endif
				half Element_Alpha56_g24346 = ( Element_Intensity2580_g24346 * Element_Remap_A74_g24346 * Element_Params_A1737_g24346 * i.ase_color.a * Element_Falloff1883_g24346 * staticSwitch14_g76930 * temp_output_145_0_g77068 * staticSwitch14_g76982 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoWetness
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 Input_Visual94_g77135 = appendResult2468_g24346;
				...
				half3 Input_Tint76_g77135 = color176;
...
{"wire":[173,1974,170,4]}
{"wire":[177,59,173,1779]}
{"wire":[177,77,176,0]}
{"wire":[142,0,173,0]}
{"wire":[143,0,177,0]}
ASEEND*/
//CHKSM=B08848207AF591BA48D1871276514B75C53B9DF3