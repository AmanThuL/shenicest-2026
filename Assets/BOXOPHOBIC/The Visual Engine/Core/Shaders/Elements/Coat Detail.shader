...
Shader "BOXOPHOBIC/The Visual Engine/Elements/Coat Detail"
{
	Properties
	{
		[StyledMessage(Info, Use Detail elements to control the Detail feature intensity. Element Texture A and Particle Color A are used as alpha masks., 0, 15)] _ElementMessage( "Element Message", Float ) = 0
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsCoatDetail
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g77067 = _SeasonRemap.x;
				half temp_output_9_0_g77067 = ( TVE_SeasonLerp - temp_output_7_0_g77067 );
				half smoothstepResult2286_g77056 = smoothstep( 0.0 , 1.0 , saturate( ( temp_output_9_0_g77067 * _SeasonRemap.z ) ));
				...
				half vertexToFrag11_g77061 = temp_output_175_0_g77056;
				o.ase_texcoord1.x = vertexToFrag11_g77061;
				...
				half2 vertexToFrag11_g77070 = ( ( lerpResult1899_g77056 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g77070;
				half2 appendResult60_g77077 = (half2(ase_positionWS.x , ase_positionWS.z));
				half2 lerpResult58_g77077 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult60_g77077 , _ElementMaskCoordMode);
				half2 vertexToFrag11_g77080 = ( ( lerpResult58_g77077 * (_ElementMaskCoordValue).xy ) + (_ElementMaskCoordValue).zw );
				o.ase_texcoord2.zw = vertexToFrag11_g77080;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half vertexToFrag11_g77061 = i.ase_texcoord1.x;
				half Value_Seasons1721_g77056 = vertexToFrag11_g77061;
				...
				half2 vertexToFrag11_g77070 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g77056 = tex2D( _MainTex, vertexToFrag11_g77070 );
				half3 temp_output_6_0_g77073 = (MainTex_RGBA587_g77056).rgb;
				half SpaceTexture2395_g77056 = _SpaceTexture;
				half temp_output_7_0_g77073 = SpaceTexture2395_g77056;
				#ifdef TVE_DUMMY
				half3 staticSwitch14_g77073 = ( temp_output_6_0_g77073 + temp_output_7_0_g77073 );
				#else
				half3 staticSwitch14_g77073 = temp_output_6_0_g77073;
				#endif
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g77068 = clamp( staticSwitch14_g77073 , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g77071 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g77071).xxx;
				half3 temp_output_9_0_g77071 = ( clampResult17_g77068 - temp_cast_2 );
				half3 temp_output_1765_0_g77056 = saturate( ( temp_output_9_0_g77071 * _MainTexColorRemap.z ) );
				...
				half Element_Intensity2580_g77056 = _ElementIntensity;
				half temp_output_6_0_g77074 = (MainTex_RGBA587_g77056).a;
				half temp_output_7_0_g77074 = SpaceTexture2395_g77056;
				#ifdef TVE_DUMMY
				half staticSwitch14_g77074 = ( temp_output_6_0_g77074 + temp_output_7_0_g77074 );
				#else
				half staticSwitch14_g77074 = temp_output_6_0_g77074;
				#endif
				half clampResult17_g77069 = clamp( staticSwitch14_g77074 , 0.0001 , 0.9999 );
				half temp_output_7_0_g77072 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g77072 = ( clampResult17_g77069 - temp_output_7_0_g77072 );
				half Element_Remap_A74_g77056 = saturate( ( temp_output_9_0_g77072 * _MainTexAlphaRemap.z ) );
				half Element_Params_A1737_g77056 = _ElementParams_Instance.w;
				half temp_output_6_0_g77076 = saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) );
				half temp_output_7_0_g77076 = SpaceTexture2395_g77056;
				#ifdef TVE_DUMMY
				half staticSwitch14_g77076 = ( temp_output_6_0_g77076 + temp_output_7_0_g77076 );
				#else
				half staticSwitch14_g77076 = temp_output_6_0_g77076;
				#endif
				half clampResult17_g77075 = clamp( staticSwitch14_g77076 , 0.0001 , 0.9999 );
				half temp_output_7_0_g77066 = _MainTexFalloffRemap.x;
				half temp_output_9_0_g77066 = ( clampResult17_g77075 - temp_output_7_0_g77066 );
				half Element_Falloff1883_g77056 = saturate( ( temp_output_9_0_g77066 * _MainTexFalloffRemap.z ) );
				half temp_output_7_0_g77059 = 1.0;
				half temp_output_9_0_g77059 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g77059 );
				half lerpResult18_g77057 = lerp( 1.0 , saturate( ( temp_output_9_0_g77059 / ( ( _ElementVolumeFadeValue - temp_output_7_0_g77059 ) + 0.0001 ) ) ) , _ElementVolumeFadeMode);
				half Blend_Edge69_g77057 = lerpResult18_g77057;
				half temp_output_6_0_g77060 = Blend_Edge69_g77057;
				half Dummy72_g77057 = ( _BoundsCategory + _BoundsEnd );
				half temp_output_7_0_g77060 = Dummy72_g77057;
				#ifdef TVE_DUMMY
				half staticSwitch14_g77060 = ( temp_output_6_0_g77060 + temp_output_7_0_g77060 );
				#else
				half staticSwitch14_g77060 = temp_output_6_0_g77060;
				#endif
				half2 vertexToFrag11_g77080 = i.ase_texcoord2.zw;
				half4 MainTex_RGBA53_g77077 = tex2D( _ElementMaskTex, vertexToFrag11_g77080 );
				half lerpResult148_g77077 = lerp( (MainTex_RGBA53_g77077).r , (MainTex_RGBA53_g77077).a , _ElementMaskMode);
				half clampResult17_g77086 = clamp( lerpResult148_g77077 , 0.0001 , 0.9999 );
				half temp_output_7_0_g77087 = _ElementMaskRemap.x;
				half temp_output_9_0_g77087 = ( clampResult17_g77086 - temp_output_7_0_g77087 );
				half lerpResult73_g77077 = lerp( 1.0 , saturate( ( temp_output_9_0_g77087 * _ElementMaskRemap.z ) ) , _ElementMaskValue);
				half Blend_Mask45_g77077 = lerpResult73_g77077;
				#ifdef TVE_ELEMENT_MASK
				half staticSwitch159_g77077 = Blend_Mask45_g77077;
				#else
				half staticSwitch159_g77077 = 1.0;
				#endif
				half3 ase_normalWS = i.ase_texcoord3.xyz;
				half4 appendResult108_g77077 = (half4(_TerrainPosition.x , _TerrainPosition.z , _TerrainSize.x , _TerrainSize.z));
				half4 Terrain_Coords111_g77077 = appendResult108_g77077;
				half4 temp_output_35_0_g77085 = Terrain_Coords111_g77077;
				float2 InputScale48_g77085 = (temp_output_35_0_g77085).zw;
				half2 FinalScale53_g77085 = ( 1.0 / InputScale48_g77085 );
				float2 InputPosition52_g77085 = (temp_output_35_0_g77085).xy;
				half2 FinalPosition58_g77085 = -( FinalScale53_g77085 * InputPosition52_g77085 );
				half2 temp_output_65_0_g77085 = ( ( (WorldPosition).xz * FinalScale53_g77085 ) + FinalPosition58_g77085 );
				half Terrain_InputMode136_g77077 = _TerrainInputMode;
				half3 lerpResult141_g77077 = lerp( ase_normalWS , tex2D( _TerrainNormalTex, temp_output_65_0_g77085 ).rgb , Terrain_InputMode136_g77077);
				half3 Terrain_Normal107_g77077 = lerpResult141_g77077;
				half dotResult113_g77077 = dot( Terrain_Normal107_g77077 , half3( 0, 1, 0 ) );
				half clampResult17_g77082 = clamp( dotResult113_g77077 , 0.0001 , 0.9999 );
				half temp_output_7_0_g77083 = _ElementProjRemap.x;
				half temp_output_9_0_g77083 = ( clampResult17_g77082 - temp_output_7_0_g77083 );
				half lerpResult123_g77077 = lerp( 1.0 , saturate( ( temp_output_9_0_g77083 * _ElementProjRemap.z ) ) , _ElementProjValue);
				half Blend_Proj117_g77077 = lerpResult123_g77077;
				#ifdef TVE_ELEMENT_PROJ
				half staticSwitch160_g77077 = Blend_Proj117_g77077;
				#else
				half staticSwitch160_g77077 = 1.0;
				#endif
				half4 temp_output_35_0_g77078 = Terrain_Coords111_g77077;
				float2 InputScale48_g77078 = (temp_output_35_0_g77078).zw;
				half2 FinalScale53_g77078 = ( 1.0 / InputScale48_g77078 );
				float2 InputPosition52_g77078 = (temp_output_35_0_g77078).xy;
				half2 FinalPosition58_g77078 = -( FinalScale53_g77078 * InputPosition52_g77078 );
				half2 temp_output_65_0_g77078 = ( ( (WorldPosition).xz * FinalScale53_g77078 ) + FinalPosition58_g77078 );
				half4 temp_output_70_0_g77078 = _TerrainHeightTex_TexelSize;
				float2 InputTexelSize68_g77078 = (temp_output_70_0_g77078).zw;
				half2 temp_cast_3 = (1.0).xx;
				float2 InputTexelRecip69_g77078 = (temp_output_70_0_g77078).xy;
				float4 Terrain_Height_Raw104_g77077 = tex2D( _TerrainHeightTex, ( ( ( temp_output_65_0_g77078 / ( 1.0 / ( InputTexelSize68_g77078 - temp_cast_3 ) ) ) + 0.5 ) * InputTexelRecip69_g77078 ) );
				half temp_output_90_0_g77077 = ( ( (Terrain_Height_Raw104_g77077).r + ( (Terrain_Height_Raw104_g77077).g * 256.0 ) ) / 257.0 );
				#ifdef SHADER_API_VULKAN
				half staticSwitch91_g77077 = temp_output_90_0_g77077;
				#else
				half staticSwitch91_g77077 = (Terrain_Height_Raw104_g77077).r;
				#endif
				#ifdef SHADER_API_GLES
				half staticSwitch92_g77077 = temp_output_90_0_g77077;
				#else
				half staticSwitch92_g77077 = staticSwitch91_g77077;
				#endif
				#ifdef SHADER_API_GLES3
				half staticSwitch93_g77077 = temp_output_90_0_g77077;
				#else
				half staticSwitch93_g77077 = staticSwitch92_g77077;
				#endif
				float Terrain_Height_Platform105_g77077 = staticSwitch93_g77077;
				half Terrain_SizeY109_g77077 = _TerrainSize.y;
				half Terrain_PosY110_g77077 = _TerrainPosition.y;
				half lerpResult137_g77077 = lerp( WorldPosition.y , ( ( Terrain_Height_Platform105_g77077 * Terrain_SizeY109_g77077 * 2.0 ) + Terrain_PosY110_g77077 ) , Terrain_InputMode136_g77077);
				float Terrain_Height106_g77077 = lerpResult137_g77077;
				half temp_output_7_0_g77084 = _ElementPosMaxValue;
				half temp_output_9_0_g77084 = ( Terrain_Height106_g77077 - temp_output_7_0_g77084 );
				half lerpResult129_g77077 = lerp( 1.0 , saturate( ( temp_output_9_0_g77084 / ( ( _ElementPosMinValue - temp_output_7_0_g77084 ) + 0.0001 ) ) ) , _ElementPosValue);
				half Blend_Pos131_g77077 = lerpResult129_g77077;
				#ifdef TVE_ELEMENT_POS
				half staticSwitch161_g77077 = Blend_Pos131_g77077;
				#else
				half staticSwitch161_g77077 = 1.0;
				#endif
				half temp_output_6_0_g77088 = ( staticSwitch159_g77077 * staticSwitch160_g77077 * staticSwitch161_g77077 );
				half Dummy144_g77077 = ( _MaskingCategory + _MaskingEnd + ( _MaskingTerrainInfo + _MaskingModelInfo ) );
				half temp_output_7_0_g77088 = Dummy144_g77077;
				#ifdef TVE_DUMMY
				half staticSwitch14_g77088 = ( temp_output_6_0_g77088 + temp_output_7_0_g77088 );
				#else
				half staticSwitch14_g77088 = temp_output_6_0_g77088;
				#endif
				half temp_output_145_0_g77077 = staticSwitch14_g77088;
				half temp_output_6_0_g77065 = 1.0;
				half temp_output_7_0_g77065 = ( _RaycastCategory + _RaycastEnd + _ElementRaycastMode + _RaycastLayerMask + _RaycastDistanceMinValue + _RaycastDistanceMaxValue + _RaycastDistanceCheckValue );
				#ifdef TVE_DUMMY
				half staticSwitch14_g77065 = ( temp_output_6_0_g77065 + temp_output_7_0_g77065 );
				#else
				half staticSwitch14_g77065 = temp_output_6_0_g77065;
				#endif
				half Element_Alpha56_g77056 = ( Element_Intensity2580_g77056 * Element_Remap_A74_g77056 * Element_Params_A1737_g77056 * i.ase_color.a * Element_Falloff1883_g77056 * staticSwitch14_g77060 * temp_output_145_0_g77077 * staticSwitch14_g77065 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsCoatDetail
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 Input_Visual94_g77136 = appendResult2468_g77056;
				half clampResult80_g77136 = clamp( (Input_Visual94_g77136).x , 0.1 , 10000.0 );
				half3 appendResult139_g77136 = (half3(clampResult80_g77136 , clampResult80_g77136 , clampResult80_g77136));
				half3 color174 = IsGammaSpace() ? half3( 0.4823529, 0.7450981, 0.1215686 ) : half3( 0.1980693, 0.5149179, 0.01370208 );
				half3 Input_Tint76_g77136 = color174;
				half3 Element_Color47_g77136 = saturate( ( appendResult139_g77136 * Input_Tint76_g77136 ) );
				half4 appendResult131_g77136 = (half4(Element_Color47_g77136 , (Input_Visual94_g77136).w));
				
				
				finalColor = appendResult131_g77136;
				return finalColor;
			}
			ENDCG
		}
...
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":174,"pos":[0,-1152],"params":["Inherit","False","Constant","_Color11","Color 1","63","0","Create","True","0","0","0","False","0","False","Object","-1","","0.4823529,0.7450981,0.1215686,1","0,0,0,0","True","False","0","6","FLOAT3","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":177,"pos":[0,-1280],"params":["Inherit","False","Element Shader","11","","77056","0e972c73cae2ee54ea51acc9738801d0","15,1778,1,477,1,478,0,1824,0,1814,0,145,0,1784,0,481,0,2614,0,2618,0,1904,1,1907,1,2377,1,2310,1,2311,1","2","1974","FLOAT","0","False","2378","FLOAT","1","False","2","FLOAT4","0","FLOAT4","1779"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":141,"pos":[448,-1536],"params":["Inherit","False","Element Compile","-1","","77135","5302407fc6d65554791e558e67d59358","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":176,"pos":[256,-1152],"params":["Inherit","False","Element Visuals","-1","","77136","78cf0f00cfd72824e84597f2db54a76e","1,64,1","2","59","FLOAT4","0,0,0,0","False","77","FLOAT3","1,1,1","False","1","FLOAT4","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":120,"pos":[-256,-1536],"params":["Half","False","Property","_ElementMessage","Element Message","0","0","Create","True","0","0","0","True","1","StyledMessage(Info, Use Detail elements to control the Detail feature intensity. Element Texture A and Particle Color A are used as alpha masks., 0, 15)","False","Object","-1","","0","0","1","1","0","1","FLOAT","0"]}
