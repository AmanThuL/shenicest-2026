...
Shader "BOXOPHOBIC/The Visual Engine/Elements/Atmo Rainfall"
{
	Properties
	{
		[StyledMessage(Info, Use Rainfall elements to add rain drops in various areas or to mask out the rain under certain objects. Element Texture R and Particle Color R are used as value multipliers. Element Texture A and Particle Color A are used as alpha masks., 0, 15)] _ElementMessage( "Element Message", Float ) = 0
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoRainfall
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g78135 = _SeasonRemap.x;
				half temp_output_9_0_g78135 = ( TVE_SeasonLerp - temp_output_7_0_g78135 );
				half smoothstepResult2286_g78124 = smoothstep( 0.0 , 1.0 , saturate( ( temp_output_9_0_g78135 * _SeasonRemap.z ) ));
				...
				half vertexToFrag11_g78129 = temp_output_175_0_g78124;
				o.ase_texcoord1.x = vertexToFrag11_g78129;
				...
				half2 vertexToFrag11_g78138 = ( ( lerpResult1899_g78124 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g78138;
				half2 appendResult60_g78145 = (half2(ase_positionWS.x , ase_positionWS.z));
				half2 lerpResult58_g78145 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult60_g78145 , _ElementMaskCoordMode);
				half2 vertexToFrag11_g78148 = ( ( lerpResult58_g78145 * (_ElementMaskCoordValue).xy ) + (_ElementMaskCoordValue).zw );
				o.ase_texcoord2.zw = vertexToFrag11_g78148;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half vertexToFrag11_g78129 = i.ase_texcoord1.x;
				half Value_Seasons1721_g78124 = vertexToFrag11_g78129;
				...
				half2 vertexToFrag11_g78138 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g78124 = tex2D( _MainTex, vertexToFrag11_g78138 );
				half3 temp_output_6_0_g78141 = (MainTex_RGBA587_g78124).rgb;
				half SpaceTexture2395_g78124 = _SpaceTexture;
				half temp_output_7_0_g78141 = SpaceTexture2395_g78124;
				#ifdef TVE_DUMMY
				half3 staticSwitch14_g78141 = ( temp_output_6_0_g78141 + temp_output_7_0_g78141 );
				#else
				half3 staticSwitch14_g78141 = temp_output_6_0_g78141;
				#endif
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g78136 = clamp( staticSwitch14_g78141 , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g78139 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g78139).xxx;
				half3 temp_output_9_0_g78139 = ( clampResult17_g78136 - temp_cast_2 );
				half3 temp_output_1765_0_g78124 = saturate( ( temp_output_9_0_g78139 * _MainTexColorRemap.z ) );
				...
				half Element_Intensity2580_g78124 = _ElementIntensity;
				half temp_output_6_0_g78142 = (MainTex_RGBA587_g78124).a;
				half temp_output_7_0_g78142 = SpaceTexture2395_g78124;
				#ifdef TVE_DUMMY
				half staticSwitch14_g78142 = ( temp_output_6_0_g78142 + temp_output_7_0_g78142 );
				#else
				half staticSwitch14_g78142 = temp_output_6_0_g78142;
				#endif
				half clampResult17_g78137 = clamp( staticSwitch14_g78142 , 0.0001 , 0.9999 );
				half temp_output_7_0_g78140 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g78140 = ( clampResult17_g78137 - temp_output_7_0_g78140 );
				half Element_Remap_A74_g78124 = saturate( ( temp_output_9_0_g78140 * _MainTexAlphaRemap.z ) );
				half Element_Params_A1737_g78124 = _ElementParams_Instance.w;
				half temp_output_6_0_g78144 = saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) );
				half temp_output_7_0_g78144 = SpaceTexture2395_g78124;
				#ifdef TVE_DUMMY
				half staticSwitch14_g78144 = ( temp_output_6_0_g78144 + temp_output_7_0_g78144 );
				#else
				half staticSwitch14_g78144 = temp_output_6_0_g78144;
				#endif
				half clampResult17_g78143 = clamp( staticSwitch14_g78144 , 0.0001 , 0.9999 );
				half temp_output_7_0_g78134 = _MainTexFalloffRemap.x;
				half temp_output_9_0_g78134 = ( clampResult17_g78143 - temp_output_7_0_g78134 );
				half Element_Falloff1883_g78124 = saturate( ( temp_output_9_0_g78134 * _MainTexFalloffRemap.z ) );
				half temp_output_7_0_g78127 = 1.0;
				half temp_output_9_0_g78127 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g78127 );
				half lerpResult18_g78125 = lerp( 1.0 , saturate( ( temp_output_9_0_g78127 / ( ( _ElementVolumeFadeValue - temp_output_7_0_g78127 ) + 0.0001 ) ) ) , _ElementVolumeFadeMode);
				half Blend_Edge69_g78125 = lerpResult18_g78125;
				half temp_output_6_0_g78128 = Blend_Edge69_g78125;
				half Dummy72_g78125 = ( _BoundsCategory + _BoundsEnd );
				half temp_output_7_0_g78128 = Dummy72_g78125;
				#ifdef TVE_DUMMY
				half staticSwitch14_g78128 = ( temp_output_6_0_g78128 + temp_output_7_0_g78128 );
				#else
				half staticSwitch14_g78128 = temp_output_6_0_g78128;
				#endif
				half2 vertexToFrag11_g78148 = i.ase_texcoord2.zw;
				half4 MainTex_RGBA53_g78145 = tex2D( _ElementMaskTex, vertexToFrag11_g78148 );
				half lerpResult148_g78145 = lerp( (MainTex_RGBA53_g78145).r , (MainTex_RGBA53_g78145).a , _ElementMaskMode);
				half clampResult17_g78154 = clamp( lerpResult148_g78145 , 0.0001 , 0.9999 );
				half temp_output_7_0_g78155 = _ElementMaskRemap.x;
				half temp_output_9_0_g78155 = ( clampResult17_g78154 - temp_output_7_0_g78155 );
				half lerpResult73_g78145 = lerp( 1.0 , saturate( ( temp_output_9_0_g78155 * _ElementMaskRemap.z ) ) , _ElementMaskValue);
				half Blend_Mask45_g78145 = lerpResult73_g78145;
				#ifdef TVE_ELEMENT_MASK
				half staticSwitch159_g78145 = Blend_Mask45_g78145;
				#else
				half staticSwitch159_g78145 = 1.0;
				#endif
				half3 ase_normalWS = i.ase_texcoord3.xyz;
				half4 appendResult108_g78145 = (half4(_TerrainPosition.x , _TerrainPosition.z , _TerrainSize.x , _TerrainSize.z));
				half4 Terrain_Coords111_g78145 = appendResult108_g78145;
				half4 temp_output_35_0_g78153 = Terrain_Coords111_g78145;
				float2 InputScale48_g78153 = (temp_output_35_0_g78153).zw;
				half2 FinalScale53_g78153 = ( 1.0 / InputScale48_g78153 );
				float2 InputPosition52_g78153 = (temp_output_35_0_g78153).xy;
				half2 FinalPosition58_g78153 = -( FinalScale53_g78153 * InputPosition52_g78153 );
				half2 temp_output_65_0_g78153 = ( ( (WorldPosition).xz * FinalScale53_g78153 ) + FinalPosition58_g78153 );
				half Terrain_InputMode136_g78145 = _TerrainInputMode;
				half3 lerpResult141_g78145 = lerp( ase_normalWS , tex2D( _TerrainNormalTex, temp_output_65_0_g78153 ).rgb , Terrain_InputMode136_g78145);
				half3 Terrain_Normal107_g78145 = lerpResult141_g78145;
				half dotResult113_g78145 = dot( Terrain_Normal107_g78145 , half3( 0, 1, 0 ) );
				half clampResult17_g78150 = clamp( dotResult113_g78145 , 0.0001 , 0.9999 );
				half temp_output_7_0_g78151 = _ElementProjRemap.x;
				half temp_output_9_0_g78151 = ( clampResult17_g78150 - temp_output_7_0_g78151 );
				half lerpResult123_g78145 = lerp( 1.0 , saturate( ( temp_output_9_0_g78151 * _ElementProjRemap.z ) ) , _ElementProjValue);
				half Blend_Proj117_g78145 = lerpResult123_g78145;
				#ifdef TVE_ELEMENT_PROJ
				half staticSwitch160_g78145 = Blend_Proj117_g78145;
				#else
				half staticSwitch160_g78145 = 1.0;
				#endif
				half4 temp_output_35_0_g78146 = Terrain_Coords111_g78145;
				float2 InputScale48_g78146 = (temp_output_35_0_g78146).zw;
				half2 FinalScale53_g78146 = ( 1.0 / InputScale48_g78146 );
				float2 InputPosition52_g78146 = (temp_output_35_0_g78146).xy;
				half2 FinalPosition58_g78146 = -( FinalScale53_g78146 * InputPosition52_g78146 );
				half2 temp_output_65_0_g78146 = ( ( (WorldPosition).xz * FinalScale53_g78146 ) + FinalPosition58_g78146 );
				half4 temp_output_70_0_g78146 = _TerrainHeightTex_TexelSize;
				float2 InputTexelSize68_g78146 = (temp_output_70_0_g78146).zw;
				half2 temp_cast_3 = (1.0).xx;
				float2 InputTexelRecip69_g78146 = (temp_output_70_0_g78146).xy;
				float4 Terrain_Height_Raw104_g78145 = tex2D( _TerrainHeightTex, ( ( ( temp_output_65_0_g78146 / ( 1.0 / ( InputTexelSize68_g78146 - temp_cast_3 ) ) ) + 0.5 ) * InputTexelRecip69_g78146 ) );
				half temp_output_90_0_g78145 = ( ( (Terrain_Height_Raw104_g78145).r + ( (Terrain_Height_Raw104_g78145).g * 256.0 ) ) / 257.0 );
				#ifdef SHADER_API_VULKAN
				half staticSwitch91_g78145 = temp_output_90_0_g78145;
				#else
				half staticSwitch91_g78145 = (Terrain_Height_Raw104_g78145).r;
				#endif
				#ifdef SHADER_API_GLES
				half staticSwitch92_g78145 = temp_output_90_0_g78145;
				#else
				half staticSwitch92_g78145 = staticSwitch91_g78145;
				#endif
				#ifdef SHADER_API_GLES3
				half staticSwitch93_g78145 = temp_output_90_0_g78145;
				#else
				half staticSwitch93_g78145 = staticSwitch92_g78145;
				#endif
				float Terrain_Height_Platform105_g78145 = staticSwitch93_g78145;
				half Terrain_SizeY109_g78145 = _TerrainSize.y;
				half Terrain_PosY110_g78145 = _TerrainPosition.y;
				half lerpResult137_g78145 = lerp( WorldPosition.y , ( ( Terrain_Height_Platform105_g78145 * Terrain_SizeY109_g78145 * 2.0 ) + Terrain_PosY110_g78145 ) , Terrain_InputMode136_g78145);
				float Terrain_Height106_g78145 = lerpResult137_g78145;
				half temp_output_7_0_g78152 = _ElementPosMaxValue;
				half temp_output_9_0_g78152 = ( Terrain_Height106_g78145 - temp_output_7_0_g78152 );
				half lerpResult129_g78145 = lerp( 1.0 , saturate( ( temp_output_9_0_g78152 / ( ( _ElementPosMinValue - temp_output_7_0_g78152 ) + 0.0001 ) ) ) , _ElementPosValue);
				half Blend_Pos131_g78145 = lerpResult129_g78145;
				#ifdef TVE_ELEMENT_POS
				half staticSwitch161_g78145 = Blend_Pos131_g78145;
				#else
				half staticSwitch161_g78145 = 1.0;
				#endif
				half temp_output_6_0_g78156 = ( staticSwitch159_g78145 * staticSwitch160_g78145 * staticSwitch161_g78145 );
				half Dummy144_g78145 = ( _MaskingCategory + _MaskingEnd + ( _MaskingTerrainInfo + _MaskingModelInfo ) );
				half temp_output_7_0_g78156 = Dummy144_g78145;
				#ifdef TVE_DUMMY
				half staticSwitch14_g78156 = ( temp_output_6_0_g78156 + temp_output_7_0_g78156 );
				#else
				half staticSwitch14_g78156 = temp_output_6_0_g78156;
				#endif
				half temp_output_145_0_g78145 = staticSwitch14_g78156;
				half temp_output_6_0_g78133 = 1.0;
				half temp_output_7_0_g78133 = ( _RaycastCategory + _RaycastEnd + _ElementRaycastMode + _RaycastLayerMask + _RaycastDistanceMinValue + _RaycastDistanceMaxValue + _RaycastDistanceCheckValue );
				#ifdef TVE_DUMMY
				half staticSwitch14_g78133 = ( temp_output_6_0_g78133 + temp_output_7_0_g78133 );
				#else
				half staticSwitch14_g78133 = temp_output_6_0_g78133;
				#endif
				half Element_Alpha56_g78124 = ( Element_Intensity2580_g78124 * Element_Remap_A74_g78124 * Element_Params_A1737_g78124 * i.ase_color.a * Element_Falloff1883_g78124 * staticSwitch14_g78128 * temp_output_145_0_g78145 * staticSwitch14_g78133 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoRainfall
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 Input_Visual94_g78172 = appendResult2468_g78124;
				half clampResult80_g78172 = clamp( (Input_Visual94_g78172).x , 0.1 , 10000.0 );
				half3 appendResult139_g78172 = (half3(clampResult80_g78172 , clampResult80_g78172 , clampResult80_g78172));
				half3 color216 = IsGammaSpace() ? half3( 0.5654593, 0.9150943, 0.7353753 ) : half3( 0.2797088, 0.8176128, 0.5000279 );
				half3 Input_Tint76_g78172 = color216;
				half3 Element_Color47_g78172 = saturate( ( appendResult139_g78172 * Input_Tint76_g78172 ) );
				half4 appendResult131_g78172 = (half4(Element_Color47_g78172 , (Input_Visual94_g78172).w));
				
				
				finalColor = appendResult131_g78172;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=19912
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":189,"pos":[-768,-896],"params":["Inherit","False","Element Type Atmo","1","","76844","825a873635c1c404399c06fe163ce11a","0","0","1","FLOAT","4"]}
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":216,"pos":[-512,-768],"params":["Inherit","False","Constant","_Color11","Color 1","63","0","Create","True","0","0","0","False","0","False","Object","-1","","0.5654593,0.9150943,0.7353753,1","0,0,0,0","True","False","0","6","FLOAT3","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":215,"pos":[-512,-896],"params":["Inherit","False","Element Shader","11","","78124","0e972c73cae2ee54ea51acc9738801d0","15,1778,1,477,1,478,0,1824,0,1814,1,145,1,1784,0,481,0,2614,0,2618,0,1904,1,1907,1,2377,1,2310,1,2311,1","2","1974","FLOAT","0","False","2378","FLOAT","1","False","2","FLOAT4","0","FLOAT4","1779"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":137,"pos":[-64,-1280],"params":["Inherit","False","Element Compile","-1","","78171","5302407fc6d65554791e558e67d59358","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":217,"pos":[-256,-768],"params":["Inherit","False","Element Visuals","-1","","78172","78cf0f00cfd72824e84597f2db54a76e","1,64,1","2","59","FLOAT4","0,0,0,0","False","77","FLOAT3","1,1,1","False","1","FLOAT4","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":112,"pos":[-768,-1280],"params":["Half","False","Property","_ElementMessage","Element Message","0","0","Create","True","0","0","0","True","1","StyledMessage(Info, Use Rainfall elements to add rain drops in various areas or to mask out the rain under certain objects. Element Texture R and Particle Color R are used as value multipliers. Element Texture A and Particle Color A are used as alpha masks., 0, 15)","False","Object","-1","","0","0","1","1","0","1","FLOAT","0"]}
...
{"wire":[215,1974,189,4]}
{"wire":[217,59,215,1779]}
{"wire":[217,77,216,0]}
{"wire":[163,0,215,0]}
{"wire":[179,0,217,0]}
ASEEND*/
//CHKSM=12833820B349CE9C4D1A4F2F53FEFBFCBA45ED7D