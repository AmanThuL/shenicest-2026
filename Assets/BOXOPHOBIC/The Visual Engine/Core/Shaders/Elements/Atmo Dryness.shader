...
Shader "BOXOPHOBIC/The Visual Engine/Elements/Atmo Dryness"
{
	Properties
	{
		[StyledMessage(Info, Use Dryness elements to control the global dryness effect on vegetation and props. Element Texture R and Particle Color R are used as value multipliers. Element Texture A and Particle Color A are used as alpha masks., 0, 15)] _ElementMessage( "Element Message", Float ) = 0
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoDryness
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g77113 = _SeasonRemap.x;
				half temp_output_9_0_g77113 = ( TVE_SeasonLerp - temp_output_7_0_g77113 );
				half smoothstepResult2286_g77102 = smoothstep( 0.0 , 1.0 , saturate( ( temp_output_9_0_g77113 * _SeasonRemap.z ) ));
				...
				half vertexToFrag11_g77107 = temp_output_175_0_g77102;
				o.ase_texcoord1.x = vertexToFrag11_g77107;
				...
				half2 vertexToFrag11_g77116 = ( ( lerpResult1899_g77102 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g77116;
				half2 appendResult60_g77123 = (half2(ase_positionWS.x , ase_positionWS.z));
				half2 lerpResult58_g77123 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult60_g77123 , _ElementMaskCoordMode);
				half2 vertexToFrag11_g77126 = ( ( lerpResult58_g77123 * (_ElementMaskCoordValue).xy ) + (_ElementMaskCoordValue).zw );
				o.ase_texcoord2.zw = vertexToFrag11_g77126;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half vertexToFrag11_g77107 = i.ase_texcoord1.x;
				half Value_Seasons1721_g77102 = vertexToFrag11_g77107;
				...
				half2 vertexToFrag11_g77116 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g77102 = tex2D( _MainTex, vertexToFrag11_g77116 );
				half3 temp_output_6_0_g77119 = (MainTex_RGBA587_g77102).rgb;
				half SpaceTexture2395_g77102 = _SpaceTexture;
				half temp_output_7_0_g77119 = SpaceTexture2395_g77102;
				#ifdef TVE_DUMMY
				half3 staticSwitch14_g77119 = ( temp_output_6_0_g77119 + temp_output_7_0_g77119 );
				#else
				half3 staticSwitch14_g77119 = temp_output_6_0_g77119;
				#endif
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g77114 = clamp( staticSwitch14_g77119 , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g77117 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g77117).xxx;
				half3 temp_output_9_0_g77117 = ( clampResult17_g77114 - temp_cast_2 );
				half3 temp_output_1765_0_g77102 = saturate( ( temp_output_9_0_g77117 * _MainTexColorRemap.z ) );
				...
				half Element_Intensity2580_g77102 = _ElementIntensity;
				half temp_output_6_0_g77120 = (MainTex_RGBA587_g77102).a;
				half temp_output_7_0_g77120 = SpaceTexture2395_g77102;
				#ifdef TVE_DUMMY
				half staticSwitch14_g77120 = ( temp_output_6_0_g77120 + temp_output_7_0_g77120 );
				#else
				half staticSwitch14_g77120 = temp_output_6_0_g77120;
				#endif
				half clampResult17_g77115 = clamp( staticSwitch14_g77120 , 0.0001 , 0.9999 );
				half temp_output_7_0_g77118 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g77118 = ( clampResult17_g77115 - temp_output_7_0_g77118 );
				half Element_Remap_A74_g77102 = saturate( ( temp_output_9_0_g77118 * _MainTexAlphaRemap.z ) );
				half Element_Params_A1737_g77102 = _ElementParams_Instance.w;
				half temp_output_6_0_g77122 = saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) );
				half temp_output_7_0_g77122 = SpaceTexture2395_g77102;
				#ifdef TVE_DUMMY
				half staticSwitch14_g77122 = ( temp_output_6_0_g77122 + temp_output_7_0_g77122 );
				#else
				half staticSwitch14_g77122 = temp_output_6_0_g77122;
				#endif
				half clampResult17_g77121 = clamp( staticSwitch14_g77122 , 0.0001 , 0.9999 );
				half temp_output_7_0_g77112 = _MainTexFalloffRemap.x;
				half temp_output_9_0_g77112 = ( clampResult17_g77121 - temp_output_7_0_g77112 );
				half Element_Falloff1883_g77102 = saturate( ( temp_output_9_0_g77112 * _MainTexFalloffRemap.z ) );
				half temp_output_7_0_g77105 = 1.0;
				half temp_output_9_0_g77105 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g77105 );
				half lerpResult18_g77103 = lerp( 1.0 , saturate( ( temp_output_9_0_g77105 / ( ( _ElementVolumeFadeValue - temp_output_7_0_g77105 ) + 0.0001 ) ) ) , _ElementVolumeFadeMode);
				half Blend_Edge69_g77103 = lerpResult18_g77103;
				half temp_output_6_0_g77106 = Blend_Edge69_g77103;
				half Dummy72_g77103 = ( _BoundsCategory + _BoundsEnd );
				half temp_output_7_0_g77106 = Dummy72_g77103;
				#ifdef TVE_DUMMY
				half staticSwitch14_g77106 = ( temp_output_6_0_g77106 + temp_output_7_0_g77106 );
				#else
				half staticSwitch14_g77106 = temp_output_6_0_g77106;
				#endif
				half2 vertexToFrag11_g77126 = i.ase_texcoord2.zw;
				half4 MainTex_RGBA53_g77123 = tex2D( _ElementMaskTex, vertexToFrag11_g77126 );
				half lerpResult148_g77123 = lerp( (MainTex_RGBA53_g77123).r , (MainTex_RGBA53_g77123).a , _ElementMaskMode);
				half clampResult17_g77132 = clamp( lerpResult148_g77123 , 0.0001 , 0.9999 );
				half temp_output_7_0_g77133 = _ElementMaskRemap.x;
				half temp_output_9_0_g77133 = ( clampResult17_g77132 - temp_output_7_0_g77133 );
				half lerpResult73_g77123 = lerp( 1.0 , saturate( ( temp_output_9_0_g77133 * _ElementMaskRemap.z ) ) , _ElementMaskValue);
				half Blend_Mask45_g77123 = lerpResult73_g77123;
				#ifdef TVE_ELEMENT_MASK
				half staticSwitch159_g77123 = Blend_Mask45_g77123;
				#else
				half staticSwitch159_g77123 = 1.0;
				#endif
				half3 ase_normalWS = i.ase_texcoord3.xyz;
				half4 appendResult108_g77123 = (half4(_TerrainPosition.x , _TerrainPosition.z , _TerrainSize.x , _TerrainSize.z));
				half4 Terrain_Coords111_g77123 = appendResult108_g77123;
				half4 temp_output_35_0_g77131 = Terrain_Coords111_g77123;
				float2 InputScale48_g77131 = (temp_output_35_0_g77131).zw;
				half2 FinalScale53_g77131 = ( 1.0 / InputScale48_g77131 );
				float2 InputPosition52_g77131 = (temp_output_35_0_g77131).xy;
				half2 FinalPosition58_g77131 = -( FinalScale53_g77131 * InputPosition52_g77131 );
				half2 temp_output_65_0_g77131 = ( ( (WorldPosition).xz * FinalScale53_g77131 ) + FinalPosition58_g77131 );
				half Terrain_InputMode136_g77123 = _TerrainInputMode;
				half3 lerpResult141_g77123 = lerp( ase_normalWS , tex2D( _TerrainNormalTex, temp_output_65_0_g77131 ).rgb , Terrain_InputMode136_g77123);
				half3 Terrain_Normal107_g77123 = lerpResult141_g77123;
				half dotResult113_g77123 = dot( Terrain_Normal107_g77123 , half3( 0, 1, 0 ) );
				half clampResult17_g77128 = clamp( dotResult113_g77123 , 0.0001 , 0.9999 );
				half temp_output_7_0_g77129 = _ElementProjRemap.x;
				half temp_output_9_0_g77129 = ( clampResult17_g77128 - temp_output_7_0_g77129 );
				half lerpResult123_g77123 = lerp( 1.0 , saturate( ( temp_output_9_0_g77129 * _ElementProjRemap.z ) ) , _ElementProjValue);
				half Blend_Proj117_g77123 = lerpResult123_g77123;
				#ifdef TVE_ELEMENT_PROJ
				half staticSwitch160_g77123 = Blend_Proj117_g77123;
				#else
				half staticSwitch160_g77123 = 1.0;
				#endif
				half4 temp_output_35_0_g77124 = Terrain_Coords111_g77123;
				float2 InputScale48_g77124 = (temp_output_35_0_g77124).zw;
				half2 FinalScale53_g77124 = ( 1.0 / InputScale48_g77124 );
				float2 InputPosition52_g77124 = (temp_output_35_0_g77124).xy;
				half2 FinalPosition58_g77124 = -( FinalScale53_g77124 * InputPosition52_g77124 );
				half2 temp_output_65_0_g77124 = ( ( (WorldPosition).xz * FinalScale53_g77124 ) + FinalPosition58_g77124 );
				half4 temp_output_70_0_g77124 = _TerrainHeightTex_TexelSize;
				float2 InputTexelSize68_g77124 = (temp_output_70_0_g77124).zw;
				half2 temp_cast_3 = (1.0).xx;
				float2 InputTexelRecip69_g77124 = (temp_output_70_0_g77124).xy;
				float4 Terrain_Height_Raw104_g77123 = tex2D( _TerrainHeightTex, ( ( ( temp_output_65_0_g77124 / ( 1.0 / ( InputTexelSize68_g77124 - temp_cast_3 ) ) ) + 0.5 ) * InputTexelRecip69_g77124 ) );
				half temp_output_90_0_g77123 = ( ( (Terrain_Height_Raw104_g77123).r + ( (Terrain_Height_Raw104_g77123).g * 256.0 ) ) / 257.0 );
				#ifdef SHADER_API_VULKAN
				half staticSwitch91_g77123 = temp_output_90_0_g77123;
				#else
				half staticSwitch91_g77123 = (Terrain_Height_Raw104_g77123).r;
				#endif
				#ifdef SHADER_API_GLES
				half staticSwitch92_g77123 = temp_output_90_0_g77123;
				#else
				half staticSwitch92_g77123 = staticSwitch91_g77123;
				#endif
				#ifdef SHADER_API_GLES3
				half staticSwitch93_g77123 = temp_output_90_0_g77123;
				#else
				half staticSwitch93_g77123 = staticSwitch92_g77123;
				#endif
				float Terrain_Height_Platform105_g77123 = staticSwitch93_g77123;
				half Terrain_SizeY109_g77123 = _TerrainSize.y;
				half Terrain_PosY110_g77123 = _TerrainPosition.y;
				half lerpResult137_g77123 = lerp( WorldPosition.y , ( ( Terrain_Height_Platform105_g77123 * Terrain_SizeY109_g77123 * 2.0 ) + Terrain_PosY110_g77123 ) , Terrain_InputMode136_g77123);
				float Terrain_Height106_g77123 = lerpResult137_g77123;
				half temp_output_7_0_g77130 = _ElementPosMaxValue;
				half temp_output_9_0_g77130 = ( Terrain_Height106_g77123 - temp_output_7_0_g77130 );
				half lerpResult129_g77123 = lerp( 1.0 , saturate( ( temp_output_9_0_g77130 / ( ( _ElementPosMinValue - temp_output_7_0_g77130 ) + 0.0001 ) ) ) , _ElementPosValue);
				half Blend_Pos131_g77123 = lerpResult129_g77123;
				#ifdef TVE_ELEMENT_POS
				half staticSwitch161_g77123 = Blend_Pos131_g77123;
				#else
				half staticSwitch161_g77123 = 1.0;
				#endif
				half temp_output_6_0_g77134 = ( staticSwitch159_g77123 * staticSwitch160_g77123 * staticSwitch161_g77123 );
				half Dummy144_g77123 = ( _MaskingCategory + _MaskingEnd + ( _MaskingTerrainInfo + _MaskingModelInfo ) );
				half temp_output_7_0_g77134 = Dummy144_g77123;
				#ifdef TVE_DUMMY
				half staticSwitch14_g77134 = ( temp_output_6_0_g77134 + temp_output_7_0_g77134 );
				#else
				half staticSwitch14_g77134 = temp_output_6_0_g77134;
				#endif
				half temp_output_145_0_g77123 = staticSwitch14_g77134;
				half temp_output_6_0_g77111 = 1.0;
				half temp_output_7_0_g77111 = ( _RaycastCategory + _RaycastEnd + _ElementRaycastMode + _RaycastLayerMask + _RaycastDistanceMinValue + _RaycastDistanceMaxValue + _RaycastDistanceCheckValue );
				#ifdef TVE_DUMMY
				half staticSwitch14_g77111 = ( temp_output_6_0_g77111 + temp_output_7_0_g77111 );
				#else
				half staticSwitch14_g77111 = temp_output_6_0_g77111;
				#endif
				half Element_Alpha56_g77102 = ( Element_Intensity2580_g77102 * Element_Remap_A74_g77102 * Element_Params_A1737_g77102 * i.ase_color.a * Element_Falloff1883_g77102 * staticSwitch14_g77106 * temp_output_145_0_g77123 * staticSwitch14_g77111 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoDryness
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 Input_Visual94_g77150 = appendResult2468_g77102;
				half clampResult80_g77150 = clamp( (Input_Visual94_g77150).x , 0.1 , 10000.0 );
				half3 appendResult139_g77150 = (half3(clampResult80_g77150 , clampResult80_g77150 , clampResult80_g77150));
				half3 color173 = IsGammaSpace() ? half3( 0.8588235, 0.5568628, 0.254902 ) : half3( 0.7083758, 0.2704979, 0.05286067 );
				half3 Input_Tint76_g77150 = color173;
				half3 Element_Color47_g77150 = saturate( ( appendResult139_g77150 * Input_Tint76_g77150 ) );
				half4 appendResult131_g77150 = (half4(Element_Color47_g77150 , (Input_Visual94_g77150).w));
				
				
				finalColor = appendResult131_g77150;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=19912
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":168,"pos":[-640,-1152],"params":["Inherit","False","Element Type Atmo","1","","23450","825a873635c1c404399c06fe163ce11a","0","0","1","FLOAT","4"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":176,"pos":[-384,-1152],"params":["Inherit","False","Element Shader","11","","77102","0e972c73cae2ee54ea51acc9738801d0","15,1778,1,477,1,478,0,1824,0,1814,0,145,0,1784,0,481,0,2614,0,2618,0,1904,1,1907,1,2377,1,2310,1,2311,1","2","1974","FLOAT","0","False","2378","FLOAT","1","False","2","FLOAT4","0","FLOAT4","1779"]}
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":173,"pos":[-384,-1024],"params":["Inherit","False","Constant","_Color11","Color 1","63","0","Create","True","0","0","0","False","0","False","Object","-1","","0.8588235,0.5568628,0.254902,1","0,0,0,0","True","False","0","6","FLOAT3","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":124,"pos":[64,-1408],"params":["Inherit","False","Element Compile","-1","","77149","5302407fc6d65554791e558e67d59358","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":174,"pos":[-128,-1024],"params":["Inherit","False","Element Visuals","-1","","77150","78cf0f00cfd72824e84597f2db54a76e","1,64,1","2","59","FLOAT4","0,0,0,0","False","77","FLOAT3","1,1,1","False","1","FLOAT4","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":111,"pos":[-640,-1408],"params":["Half","False","Property","_ElementMessage","Element Message","0","0","Create","True","0","0","0","True","1","StyledMessage(Info, Use Dryness elements to control the global dryness effect on vegetation and props. Element Texture R and Particle Color R are used as value multipliers. Element Texture A and Particle Color A are used as alpha masks., 0, 15)","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor","id":170,"pos":[-64,-1152],"params":["Float","False","False","-1","3","AmplifyShaderEditor.MaterialInspector","100","1","New Amplify Shader","f4f273c3bb6262d4396be458405e60f9","True","VolumePass1","0","1","VolumePass1","2","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","True","1","RenderType=Opaque=RenderType","False","False","0","False","True","0","1","False","","0","False","","0","1","False","","0","False","","True","0","False","","0","False","","False","False","False","False","False","False","False","False","False","True","0","False","","False","True","0","False","","False","True","True","True","True","True","0","False","","False","False","False","False","False","False","False","True","False","0","False","","255","False","","255","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","False","True","1","False","","True","3","False","","True","True","0","False","","0","False","","True","1","False","","True","1","LightMode=VolumePass1","True","2","False","0","","0","0","Standard","0","False","0"]}
{"type":"AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor","id":171,"pos":[-64,-1152],"params":["Float","False","False","-1","3","AmplifyShaderEditor.MaterialInspector","100","1","New Amplify Shader","f4f273c3bb6262d4396be458405e60f9","True","VolumePass2","0","2","VolumePass2","2","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","True","1","RenderType=Opaque=RenderType","False","False","0","False","True","0","1","False","","0","False","","0","1","False","","0","False","","True","0","False","","0","False","","False","False","False","False","False","False","False","False","False","True","0","False","","False","True","0","False","","False","True","True","True","True","True","0","False","","False","False","False","False","False","False","False","True","False","0","False","","255","False","","255","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","False","True","1","False","","True","3","False","","True","True","0","False","","0","False","","True","1","False","","True","1","LightMode=VolumePass2","True","2","False","0","","0","0","Standard","0","False","0"]}
...
{"wire":[176,1974,168,4]}
{"wire":[174,59,176,1779]}
{"wire":[174,77,173,0]}
{"wire":[134,0,176,0]}
{"wire":[135,0,174,0]}
ASEEND*/
//CHKSM=8C55BB57F488866B56633A932F070440CC5C5197