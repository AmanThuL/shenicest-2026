// Upgrade NOTE: upgraded instancing buffer 'BOXOPHOBICTheVisualEngineElementsUserA' to new syntax.

// Made with Amplify Shader Editor v1.9.9.12
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "BOXOPHOBIC/The Visual Engine/Elements/User A"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(BOXOPHOBICTheVisualEngineElementsUserA)
				UNITY_DEFINE_INSTANCED_PROP(half4, _ElementParams)
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsUserA
			UNITY_INSTANCING_BUFFER_END(BOXOPHOBICTheVisualEngineElementsUserA)
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half Extras_RGB2401_g76908 = temp_output_468_0_g76908;
				...
				float lerpResult1634_g76908 = lerp( 1.0 , Extras_RGB2401_g76908 , Element_Alpha56_g76908);
				half Element_BlendA918_g76908 = _ElementBlendA;
				float lerpResult933_g76908 = lerp( lerpResult1634_g76908 , ( Extras_RGB2401_g76908 * Element_Alpha56_g76908 ) , Element_BlendA918_g76908);
				half Final_Blend_AOnly211_g76908 = lerpResult933_g76908;
				float4 appendResult475_g76908 = (float4(0.0 , 0.0 , 0.0 , Final_Blend_AOnly211_g76908));
				
				
				finalColor = appendResult475_g76908;
				return finalColor;
			}
			ENDCG
		}
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsUserA
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 color234 = IsGammaSpace() ? float3( 0.5, 0.5, 0.5 ) : float3( 0.2140411, 0.2140411, 0.2140411 );
...
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":234,"pos":[-1664,-1280],"params":["Inherit","False","Constant","_Color11","Color 1","63","0","Create","True","0","0","0","False","0","False","Object","-1","","0.5,0.5,0.5,1","0,0,0,0","True","False","0","6","FLOAT3","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":235,"pos":[-1664,-1408],"params":["Inherit","False","Element Shader","11","","76908","0e972c73cae2ee54ea51acc9738801d0","14,477,1,1778,1,478,2,1824,2,1814,1,145,1,481,0,1784,0,2346,1,1904,1,1907,1,2377,1,2310,1,2311,1","2","1974","FLOAT","0","False","2378","FLOAT","1","False","2","FLOAT4","0","FLOAT4","1779"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":167,"pos":[-704,-1664],"params":["Inherit","False","Element Compile","-1","","22423","5302407fc6d65554791e558e67d59358","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":112,"pos":[-1920,-1664],"params":["Half","False","Property","_ElementMessage","Element Message","0","0","Create","True","0","0","0","False","1","StyledMessage(Info, User element writing to A channel., 0, 15)","False","Object","-1","","0","0","1","1","0","1","FLOAT","0"]}
...
{"wire":[178,0,238,0]}
ASEEND*/
//CHKSM=9376A3F71E63CDE3A0FAF6445197B3DBEF6D8D7D