	...
	SubShader
	{
        ...
        Pass
        {
            ...
            float4 frag( ase_v2f_customrendertexture IN  ) : COLOR
            {
				...
				float2 Input_Coords80_g77197 = Noise_Coord418_g77191;
				half2 Input_Direction82_g77197 = (Global_WindDirection141_g77191*2.0 + -1.0);
				...
				float Input_Time88_g77197 = Noise_SpeedA144_g77191;
				float temp_output_23_0_g77197 = frac( Input_Time88_g77197 );
				float4 lerpResult39_g77197 = lerp( SAMPLE_TEXTURE2D( _MotionNoiseTex, sampler_Linear_Repeat, ( Input_Coords80_g77197 + ( Input_Direction82_g77197 * temp_output_23_0_g77197 ) ) ) , SAMPLE_TEXTURE2D( _MotionNoiseTex, sampler_Linear_Repeat, ( Input_Coords80_g77197 + ( Input_Direction82_g77197 * ( temp_output_23_0_g77197 - 1.0 ) ) ) ) , temp_output_23_0_g77197);
				half4 Noise_TexA152_g77191 = lerpResult39_g77197;
				float2 Input_Coords80_g77201 = Noise_Coord418_g77191;
				half2 Input_Direction82_g77201 = (Global_WindDirection141_g77191*2.0 + -1.0);
				...
				float Input_Time88_g77201 = Noise_SpeedB244_g77191;
				float temp_output_23_0_g77201 = frac( Input_Time88_g77201 );
				float4 lerpResult39_g77201 = lerp( SAMPLE_TEXTURE2D( _MotionNoiseTex, sampler_Linear_Repeat, ( Input_Coords80_g77201 + ( Input_Direction82_g77201 * temp_output_23_0_g77201 ) ) ) , SAMPLE_TEXTURE2D( _MotionNoiseTex, sampler_Linear_Repeat, ( Input_Coords80_g77201 + ( Input_Direction82_g77201 * ( temp_output_23_0_g77201 - 1.0 ) ) ) ) , temp_output_23_0_g77201);
				half4 Noise_TexB245_g77191 = lerpResult39_g77201;
