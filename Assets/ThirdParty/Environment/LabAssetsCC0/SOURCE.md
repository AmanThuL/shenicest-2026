...
- **Copied files** (31 of the pack's 140 `FBX/All/*.fbx`, vendor file names kept, flat in `Models/`):
  ...
  - `Models/machine_microscope.fbx`
  - `Models/bottle_glassware_beaker_large.fbx`
  - `Models/bottle_glassware_filtering_flask_large.fbx`
  - `Models/funnel_seperatory_funnel.fbx`
  - `Models/heating_equipment_bunsen_burner.fbx`
  - `Models/heating_equipment_iron_stand.fbx`
  - `Models/heating_equipment_ring_stand.fbx`
  - `Models/heating_equipment_crucible.fbx`
  - `Models/syringe_syringe.fbx`
