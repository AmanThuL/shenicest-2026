...
namespace RootsDance.Scanner
{
    ...
    public class ScannerScreenSurface : MonoBehaviour
    {
        ...
        [Tooltip("Physical size of the lit screen area in metres. Measured off Scanner.blend; "
            + "change it only if the art changes.")]
        ...
        public Vector2 ActiveAreaMeters => m_activeAreaMeters;
        ...
        public void Apply()
        {
            ...
            float scale = m_activeAreaMeters.x / m_referenceResolution.x / metresPerLocalUnit;
