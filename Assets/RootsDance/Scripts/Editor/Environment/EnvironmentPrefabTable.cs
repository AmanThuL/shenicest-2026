...
namespace RootsDance.Editor.Environment
{
    ...
    public struct PrefabEntry
    {
        ...
        /// The final value is also the authored minimum culling threshold.
        /// </summary>
        ...
        public PrefabEntry(string key, string modelPath, string category, ColliderKind collider,
            ...
            string subObject = null, string[] lodModelPaths = null, float[] lodTransitionHeights = null)
        {
            Key = key;
            ModelPath = modelPath;
            Category = category;
    ...
    public static class EnvironmentPrefabTable
    {
        ...
        private static PrefabEntry LodScan(string key, string derivedName, MaterialRule[] rules, string material)
        {
            ...
            return new PrefabEntry(key, $"{k_PolyHaven}{key}/{key}_1k.fbx", k_Rocks,
                ColliderKind.MeshConvex, rules, material, 1f, EnvironmentRenderClass.RootRock, null,
                lodPaths, transitionHeights);
        }
