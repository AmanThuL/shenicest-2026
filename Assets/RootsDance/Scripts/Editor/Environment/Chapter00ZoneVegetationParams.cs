...
namespace RootsDance.Editor.Environment
{
    ...
    public sealed class Chapter00VegetationLayerSpec
    {
        ...
        /// <summary>
        /// Ground cover derives pitch from the smallest scaled Renderer XZ footprint. A value of .38 means
        /// neighbouring footprints overlap by 38 percent. Mid/blocker layers use <see cref="Spacing"/>.
        /// </summary>
    ...
    public sealed class Chapter00ZoneVegetationParams
    {
        ...
        private static Chapter00VegetationLayerSpec[] CreateLayers()
        {
            ...
            return new[]
            {
                ...
                // C ground cover has no route clearance by design. At least 30-45% of the smallest scaled
                // footprint overlaps, so a different source mesh cannot silently open holes in the carpet.
                Layer(Chapter00VegetationZone.C, Chapter00VegetationRole.WalkThroughGroundCover,
                    anomalousPatchGrass, .25f, .55f, .38f, 0f, 0f, 0f, .7f, 5301),
                Layer(Chapter00VegetationZone.C, Chapter00VegetationRole.MidLayer,
                    Combine(grassVariety, fern, liveBush), .55f, .85f, 0f, 1.45f, 1.4f, 2.2f, .5f, 5302),
